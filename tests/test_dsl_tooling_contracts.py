...
GENERATED_MODULE_IDE_SCHEMA_FORMATS = (
    ...
    "appgen.visual-runtime-pipeline-module-contract.v1",
    "appgen.visual-runtime-pipeline-module-smoke-test.v1",
)
...
GENERATED_MODULE_RUNTIME_SCHEMA_FORMATS = (
    ...
    "appgen.view-composition-module-smoke-test.v1",
    "appgen.view-composition-module-generated-test-smoke.v1",
)
...
APPLICATION_COMPONENT_RUNTIME_SCHEMA_FORMATS = (
    ...
    "appgen.component-runtime-contract.v1",
    "appgen.component-serialization-contract.v1",
)
...
DESIGN_DATA_RUNTIME_SCHEMA_FORMATS = (
    ...
    "appgen.form-interaction-family-operation.v1",
    "appgen.frontend-environment.v1",
)
...
GENERATED_FRONTEND_COMPONENT_RUNTIME_SCHEMA_FORMATS = (
    ...
    "appgen.generated-component-target-adapter-contract.v1",
...
GENERATED_VISUAL_DATA_MOBILE_RUNTIME_SCHEMA_FORMATS = (
    ...
    "appgen.generated-mobile-component-adapter-contract.v1",
    "appgen.generated-mobile-deep-link-routing-contract.v1",
)
...
MOBILE_NATIVE_IDE_RUNTIME_SCHEMA_FORMATS = (
    ...
    "appgen.mobile-app-lifecycle-delivery-contract.v1",
    "appgen.mobile-background-delivery-contract.v1",
)


REMAINING_RUNTIME_SCHEMA_FORMATS = (
    "appgen.mobile-background-resume-operation.v1",
    "appgen.mobile-background-resume-workflow.v1",
    "appgen.mobile-component-adapter-contract.v1",
    "appgen.mobile-deep-link-routing-contract.v1",
    "appgen.mobile-device-capability-lifecycle-replay.v1",
    "appgen.mobile-device-component-spec-contract.v1",
    "appgen.mobile-device-designer-transaction-replay-contract.v1",
    "appgen.mobile-device-event-trace-contract.v1",
    "appgen.mobile-device-scenario-matrix-contract.v1",
    "appgen.mobile-device-simulator-contract.v1",
    "appgen.mobile-device-target-scenario-matrix-contract.v1",
    "appgen.mobile-dispatch-adapter-operation.v1",
    "appgen.mobile-media-file-pipeline-contract.v1",
    "appgen.mobile-native-api-actionable-operations.v1",
    "appgen.mobile-native-api-contract.v1",
    "appgen.mobile-native-api-readiness-contract.v1",
    "appgen.mobile-native-api-runtime-replay-contract.v1",
    "appgen.mobile-native-api-workbench.v1",
    "appgen.mobile-native-bridge-error-contract.v1",
    "appgen.mobile-native-bridge-matrix-contract.v1",
    "appgen.mobile-native-call-transaction-replay.v1",
    "appgen.mobile-offline-device-event-queue-contract.v1",
    "appgen.mobile-offline-replay.v1",
    "appgen.mobile-offline-sync-batch.v1",
    "appgen.mobile-permission-manifest-contract.v1",
    "appgen.mobile-permission-prompt-workflow.v1",
    "appgen.mobile-permission-revocation-contract.v1",
    "appgen.mobile-permission-revocation-transaction-replay.v1",
    "appgen.mobile-permission-state-machine-contract.v1",
    "appgen.mobile-platform-fallback-operation.v1",
    "appgen.mobile-platform-fallback-workflow.v1",
    "appgen.mobile-privacy-review-operation.v1",
    "appgen.mobile-privacy-review-workflow.v1",
    "appgen.mobile-replay-simulator-operation.v1",
    "appgen.mobile-request-permission-operation.v1",
    "appgen.mobile-run-device-scenario-operation.v1",
    "appgen.mobile-simulator-fixture-integrity-contract.v1",
    "appgen.mobile-simulator-replay-workflow.v1",
    "appgen.mobile-store-privacy-manifest-contract.v1",
    "appgen.mobile-sync-conflict.v1",
    "appgen.mobile-validate-device-component-operation.v1",
    "appgen.monitoring-release-gate.v1",
    "appgen.monitoring-workbench.v1",
    "appgen.native-package-artifact-gate.v1",
    "appgen.native-packager-execution-plan.v1",
    "appgen.native-packaging-release-gate.v1",
    "appgen.native-release-gate.v1",
    "appgen.nl-changeset.v1",
    "appgen.nl-destructive-intent.v1",
    "appgen.nl-evolution-capabilities.v1",
    "appgen.nl-evolution-changeset.v1",
    "appgen.nl-evolution-module-contract.v1",
    "appgen.nl-evolution-module-file-manifest.v1",
    "appgen.nl-evolution-module-generated-test-smoke.v1",
    "appgen.nl-evolution-module-manifest.v1",
    "appgen.nl-evolution-module-operation.v1",
    "appgen.nl-evolution-module-release-context.v1",
    "appgen.nl-evolution-module-smoke-test.v1",
    "appgen.nl-evolution-module-test-file-manifest.v1",
    "appgen.nl-evolution-plan.v1",
    "appgen.nl-evolution-release-gate.v1",
    "appgen.nl-evolution-workbench.v1",
    "appgen.nl-generation-smoke-audit.v1",
    "appgen.nl-migration-impact.v1",
    "appgen.nl-rollback-plan.v1",
    "appgen.nl-test-plan.v1",
    "appgen.node-red-release-gate.v1",
    "appgen.node-red-workbench.v1",
    "appgen.notification-check.v1",
    "appgen.notification-release-gate.v1",
    "appgen.notification-workbench.v1",
    "appgen.object-inspector-contract.v1",
    "appgen.object-inspector-readiness-contract.v1",
    "appgen.object-inspector-workbench.v1",
    "appgen.offline-conflict-review-contract.v1",
    "appgen.onprem-readiness.v1",
    "appgen.openapi-release-gate.v1",
    "appgen.openapi-workbench.v1",
    "appgen.ops-generation-smoke-audit.v1",
    "appgen.package-application-management.v1",
    "appgen.package-authorization-decision.v1",
    "appgen.package-compliance-contract.v1",
    "appgen.package-database-design-workspace.v1",
    "appgen.package-database-ops-contract.v1",
    "appgen.package-deployment-contract.v1",
    "appgen.package-dsl-editor-state.v1",
    "appgen.package-form-canvas.v1",
    "appgen.package-form-design-validation.v1",
    "appgen.package-form-design.v1",
    "appgen.package-form-drop-proposal.v1",
    "appgen.package-form-property-inspector.v1",
    "appgen.package-generation-job.v1",
    "appgen.package-generation-queue.v1",
    "appgen.package-manager-module-replay-matrix.v1",
    "appgen.package-node-red-contract.v1",
    "appgen.package-report-delivery.v1",
    "appgen.package-search-contract.v1",
    "appgen.package-secret-exposure-scan.v1",
    "appgen.package-security-audit-event.v1",
    "appgen.package-session-hardening-policy.v1",
    "appgen.package-source-artifact-contract.v1",
    "appgen.package-source-generation-plan.v1",
    "appgen.package-source-generation-smoke-audit.v1",
    "appgen.package-source-intake-matrix.v1",
    "appgen.package-source-intake.v1",
    "appgen.package-studio-workspace.v1",
    "appgen.package-tenant-rls-contract.v1",
    "appgen.packaging-release-gate.v1",
    "appgen.packaging-workbench.v1",
    "appgen.palette-balance.v1",
    "appgen.patroni-cluster-plan.v1",
    "appgen.performance-release-gate.v1",
    "appgen.performance-workbench.v1",
    "appgen.platform-module-file-manifest.v1",
    "appgen.platform-module-test-file-manifest.v1",
    "appgen.platform-parity-lifecycle-replay.v1",
    "appgen.platform-parity-requirement-audit.v1",
    "appgen.platform-release-gate.v1",
    "appgen.platform-target-experience-gate.v1",
    "appgen.postgraphile-schema-plan.v1",
    "appgen.privacy-request.v1",
    "appgen.productivity-release-gate.v1",
    "appgen.productivity-workbench.v1",
    "appgen.project-management-module-file-manifest.v1",
    "appgen.project-management-module-test-file-manifest.v1",
    "appgen.project-management-release-gate.v1",
    "appgen.project-management-workbench.v1",
    "appgen.property-editor-family-contract.v1",
    "appgen.prototyping-module-contract.v1",
    "appgen.prototyping-module-file-manifest.v1",
    "appgen.prototyping-module-generated-test-smoke.v1",
    "appgen.prototyping-module-manifest.v1",
    "appgen.prototyping-module-operation.v1",
    "appgen.prototyping-module-release-context.v1",
    "appgen.prototyping-module-smoke-test.v1",
    "appgen.prototyping-module-test-file-manifest.v1",
    "appgen.prototyping-release-gate.v1",
    "appgen.prototyping-workbench.v1",
    "appgen.pwa-installability-matrix.v1",
    "appgen.pwa-module-file-manifest.v1",
    "appgen.pwa-module-test-file-manifest.v1",
    "appgen.pwa-release-gate.v1",
    "appgen.rad-data-tooling-contract.v1",
    "appgen.rad-data-tooling-workbench.v1",
    "appgen.rad-parity-workbench.v1",
    "appgen.rad-query-designer-contract.v1",
    "appgen.realtime-module-file-manifest.v1",
    "appgen.realtime-module-test-file-manifest.v1",
    "appgen.realtime-release-gate.v1",
    "appgen.realtime-workbench.v1",
    "appgen.release-promotion-plan.v1",
    "appgen.report-delivery-release-gate.v1",
    "appgen.reporting-generation-smoke-audit.v1",
    "appgen.reports-release-gate.v1",
    "appgen.reports-workbench.v1",
    "appgen.resilience-release-gate.v1",
    "appgen.resilience-workbench.v1",
    "appgen.responsive-workbench.v1",
    "appgen.retention-disposition-review.v1",
    "appgen.rls-release-gate.v1",
    "appgen.rls-workbench.v1",
    "appgen.roadmap-source-report.v1",
    "appgen.rpa-module-file-manifest.v1",
    "appgen.rpa-module-test-file-manifest.v1",
    "appgen.rpa-release-gate.v1",
    "appgen.rpa-workbench.v1",
    "appgen.rules-release-gate.v1",
    "appgen.rules-workbench.v1",
    "appgen.runtime-assurance-workbench.v1",
    "appgen.runtime-assurance.v1",
    "appgen.runtime-security-release-gate.v1",
    "appgen.runtime-security-workbench.v1",
    "appgen.schema-diagram-release-gate.v1",
    "appgen.schema-diff.v1",
    "appgen.schema-import-apply-plan.v1",
    "appgen.schema-import-release-gate.v1",
    "appgen.schema-normalization.v1",
    "appgen.schema-refactor-plan.v1",
    "appgen.schema-roundtrip-diff.v1",
    "appgen.schema-source-contract.v1",
    "appgen.schema-source-example-audit.v1",
    "appgen.schema-source-fidelity.v1",
    "appgen.schema-source-generation-proof.v1",
    "appgen.schema-source-profile.v1",
    "appgen.schema-source-validation.v1",
    "appgen.sdk-release-gate.v1",
    "appgen.sdk-workbench.v1",
    "appgen.search-release-gate.v1",
    "appgen.search-workbench.v1",
    "appgen.security-generation-smoke-audit.v1",
    "appgen.seed-plan.v1",
    "appgen.seed-release-gate.v1",
    "appgen.seed-workbench.v1",
    "appgen.seed.v1",
    "appgen.semantic-model-wrapper.v1",
    "appgen.service-mesh-policy.v1",
    "appgen.service-traffic-shift.v1",
    "appgen.source-intake-workspace.v1",
    "appgen.splash-screen.v1",
    "appgen.sql-explain-plan.v1",
    "appgen.sql-filter-plan.v1",
    "appgen.sql-select-builder.v1",
    "appgen.sql-workbench.v1",
    "appgen.studio-browser-smoke.v1",
    "appgen.studio-generation-smoke-audit.v1",
    "appgen.studio-module-contract.v1",
    "appgen.studio-module-file-manifest.v1",
    "appgen.studio-module-generated-test-smoke.v1",
    "appgen.studio-module-manifest.v1",
    "appgen.studio-module-operation.v1",
    "appgen.studio-module-release-context.v1",
    "appgen.studio-module-smoke-test.v1",
    "appgen.studio-module-test-file-manifest.v1",
    "appgen.studio-release-gate.v1",
    "appgen.subject-export.v1",
    "appgen.support-bundle.v1",
    "appgen.support-center-module-contract.v1",
    "appgen.support-center-module-file-manifest.v1",
    "appgen.support-center-module-generated-test-smoke.v1",
    "appgen.support-center-module-manifest.v1",
    "appgen.support-center-module-operation.v1",
    "appgen.support-center-module-release-context.v1",
    "appgen.support-center-module-smoke-test.v1",
    "appgen.support-center-module-test-file-manifest.v1",
    "appgen.support-center-release-gate.v1",
    "appgen.support-center-workbench.v1",
    "appgen.tabbed-view-module-contract.v1",
    "appgen.tabbed-view-module-file-manifest.v1",
    "appgen.tabbed-view-module-generated-test-smoke.v1",
    "appgen.tabbed-view-module-manifest.v1",
    "appgen.tabbed-view-module-operation.v1",
    "appgen.tabbed-view-module-release-context.v1",
    "appgen.tabbed-view-module-smoke-test.v1",
    "appgen.tabbed-view-module-test-file-manifest.v1",
    "appgen.tabbed-views-release-gate.v1",
    "appgen.tabbed-views-workbench.v1",
    "appgen.target-experience-matrix.v1",
    "appgen.target-package-matrix.v1",
    "appgen.tenancy-release-gate.v1",
    "appgen.tenancy-workbench.v1",
    "appgen.text-quality-check.v1",
    "appgen.text-quality-release-gate.v1",
    "appgen.text-quality-workbench.v1",
    "appgen.theme-quality.v1",
    "appgen.third-party-component-import-contract.v1",
    "appgen.third-party-component-install-plan.v1",
    "appgen.trusted-header-plan.v1",
    "appgen.ui-chrome-readiness-contract.v1",
    "appgen.ui-customization-workbench.v1",
    "appgen.ui-experience-excellence-gate.v1",
    "appgen.ui-experience-release-gate.v1",
    "appgen.ui-validation.v1",
    "appgen.unknown-diagnostic-fixture.v1",
    "appgen.usage-analytics-release-gate.v1",
    "appgen.usage-analytics-workbench.v1",
    "appgen.validation-release-gate.v1",
    "appgen.validation-result.v1",
    "appgen.version-control-module-file-manifest.v1",
    "appgen.version-control-module-replay-matrix.v1",
    "appgen.version-control-module-test-file-manifest.v1",
    "appgen.version-control-release-gate.v1",
    "appgen.version-control-workbench.v1",
    "appgen.view-composition-module-file-manifest.v1",
    "appgen.view-composition-module-replay-matrix.v1",
    "appgen.view-composition-module-test-file-manifest.v1",
    "appgen.view-composition-release-gate.v1",
    "appgen.view-composition-workbench.v1",
    "appgen.view-empty-state.v1",
    "appgen.view-error-state.v1",
    "appgen.view-experience-module-contract.v1",
    "appgen.view-experience-module-file-manifest.v1",
    "appgen.view-experience-module-generated-test-smoke.v1",
    "appgen.view-experience-module-manifest.v1",
    "appgen.view-experience-module-operation.v1",
    "appgen.view-experience-module-release-context.v1",
    "appgen.view-experience-module-smoke-test.v1",
    "appgen.view-experience-module-test-file-manifest.v1",
    "appgen.view-experience-release-gate.v1",
    "appgen.view-experience-workbench.v1",
    "appgen.view-loading-state.v1",
    "appgen.view-shell.v1",
    "appgen.view-state-matrix.v1",
    "appgen.visual-component-design-tools.v1",
    "appgen.visual-component-generated-test-smoke.v1",
    "appgen.visual-component-operation-steps.v1",
    "appgen.visual-component-prop-validation.v1",
    "appgen.visual-component-render-node.v1",
    "appgen.visual-component-scenario.v1",
    "appgen.visual-component-smoke-test.v1",
    "appgen.visual-component-spec.v1",
    "appgen.visual-component-validation-steps.v1",
    "appgen.visual-design-ide-operation-steps.v1",
    "appgen.visual-design-ide-operation.v1",
    "appgen.visual-design-ide-replay-matrix.v1",
    "appgen.visual-design-ide-runtime-context.v1",
    "appgen.visual-design-ide-surface-manifest.v1",
    "appgen.visual-design-ide-validation-steps.v1",
    "appgen.visual-experience-quality.v1",
    "appgen.visual-modeling-release-gate.v1",
    "appgen.visual-modeling-workbench.v1",
    "appgen.visual-regression.v1",
    "appgen.visual-runtime-pipeline-manifest.v1",
    "appgen.visual-runtime-pipeline-operation-steps.v1",
    "appgen.visual-runtime-pipeline-operation.v1",
    "appgen.visual-runtime-pipeline-replay-matrix.v1",
    "appgen.visual-runtime-pipeline-validation-steps.v1",
    "appgen.visual-test-matrix.v1",
    "appgen.visualization-workbench.v1",
    "appgen.voice-release-gate.v1",
    "appgen.voice-workbench.v1",
    "appgen.wizard-release-gate.v1",
    "appgen.wizard-session.v1",
    "appgen.wizard-submission-plan.v1",
    "appgen.wizard-workbench.v1",
    "appgen.zombodb-index-plan.v1",
)
...
def test_top_level_help_exposes_tooling_subcommands_and_apg_alias() -> None:
    ...
    assert audit["entrypoint_case_count"] == 10
    ...
    assert audit["entrypoint_case_payload_formats_by_id"]["python_module:agent_handoff"] == "appgen.agent-handoff-report.v1"
    assert audit["entrypoint_case_payload_formats_by_id"]["repo_alias:agent_handoff"] == "appgen.agent-handoff-report.v1"
...
def test_semantic_cli_audit_proves_directory_json_and_text_contracts(tmp_path: Path) -> None:
    ...
    assert audit["symbol_files_by_id"]["table.Invoice.total"].endswith("data/invoice.appgen")
    assert audit["symbol_files_by_id"]["view.InvoiceForm.Main"].endswith("ui/invoice-form.appgen")
    ...
    assert audit["symbol_files_by_id"]["agent.InvoiceAssistant.Explain"].endswith("agents/invoice-assistant.appgen")
...
def test_contract_schema_catalog_exposes_core_json_schemas() -> None:
    ...
    assert GENERATED_MODULE_SCHEMA_FORMATS == appgen_dsl.GENERATED_MODULE_SCHEMA_FORMATS
    assert GENERATED_MODULE_IDE_SCHEMA_FORMATS == appgen_dsl.GENERATED_MODULE_IDE_SCHEMA_FORMATS
    assert GENERATED_MODULE_RUNTIME_SCHEMA_FORMATS == appgen_dsl.GENERATED_MODULE_RUNTIME_SCHEMA_FORMATS
    assert APPLICATION_COMPONENT_RUNTIME_SCHEMA_FORMATS == appgen_dsl.APPLICATION_COMPONENT_RUNTIME_SCHEMA_FORMATS
    assert DESIGN_DATA_RUNTIME_SCHEMA_FORMATS == appgen_dsl.DESIGN_DATA_RUNTIME_SCHEMA_FORMATS
    assert (
        GENERATED_FRONTEND_COMPONENT_RUNTIME_SCHEMA_FORMATS
        == appgen_dsl.GENERATED_FRONTEND_COMPONENT_RUNTIME_SCHEMA_FORMATS
    )
    assert (
        GENERATED_VISUAL_DATA_MOBILE_RUNTIME_SCHEMA_FORMATS
        == appgen_dsl.GENERATED_VISUAL_DATA_MOBILE_RUNTIME_SCHEMA_FORMATS
    )
    assert MOBILE_NATIVE_IDE_RUNTIME_SCHEMA_FORMATS == appgen_dsl.MOBILE_NATIVE_IDE_RUNTIME_SCHEMA_FORMATS
    assert REMAINING_RUNTIME_SCHEMA_FORMATS == appgen_dsl.REMAINING_RUNTIME_SCHEMA_FORMATS
    assert PBC_RUNTIME_SCHEMA_FORMATS == appgen_dsl.PBC_RUNTIME_SCHEMA_FORMATS
    ...
    generated_module_schema = catalog["schemas"]["appgen.native-form-module-contract.v1"]
    assert generated_module_schema["required"] == ("format",)
    assert {"module", "kind", "checks", "generated_files"} <= set(generated_module_schema["properties"])
