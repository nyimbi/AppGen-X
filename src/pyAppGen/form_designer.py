    ...
    gates = (
        {
            ...
            and set(required_palette_components) <= set(passing_palette_components),
            "required_categories": required_palette_categories,
            "passing_categories": passing_palette_categories,
            "required_components": required_palette_components,
            "passing_components": passing_palette_components,
            "required_component_count": len(required_palette_components),
            "passing_component_count": len(passing_palette_components),
        },
        {
            "id": "canvas_contract",
