...
PBC_CATALOG.update(
    {
        ...
        "checkout_processing": {
            ...
            "apis": ("POST /carts", "POST /checkout", "POST /coupons", "GET /checkout-processing-workbench"),
        ...
        "enterprise_search_vector": {
            ...
            "apis": ("POST /indexes", "POST /embeddings", "POST /search", "GET /enterprise-search-vector-workbench"),
