from pyAppGen.pbcs.contract_lifecycle import implementation_contract, package_discovery_plan, package_metadata_manifest, validate_package_metadata
...
from pyAppGen.pbcs.contract_lifecycle.release_evidence import build_release_evidence, release_readiness_manifest, validate_release_evidence
...
from pyAppGen.pbcs.contract_lifecycle.routes import api_route_contracts, validate_api_route_contracts
from pyAppGen.pbcs.contract_lifecycle.config import governance_smoke_test
from pyAppGen.pbcs.contract_lifecycle.agent import agent_skill_manifest, chatbot_interface_contract, document_instruction_plan, datastore_crud_plan
...
def test_event_handlers_are_idempotent_and_retryable():
    ...
    assert dispatch_event({'event_type': ('CustomerUpdated', 'SupplierQualified', 'PolicyChanged')[0], 'idempotency_key': 'idem'})['ok'] is True
