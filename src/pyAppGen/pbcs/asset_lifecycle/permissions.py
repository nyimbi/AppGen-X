"""Executable permission contract for the asset_lifecycle PBC."""

PBC_KEY = 'asset_lifecycle'
PERMISSIONS = ('asset_lifecycle.read', 'asset_lifecycle.create', 'asset_lifecycle.update', 'asset_lifecycle.approve', 'asset_lifecycle.admin')
ACTION_PERMISSIONS = {
