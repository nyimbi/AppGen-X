...
from .runtime import *
from .ui import port_terminal_operations_ui_contract, port_terminal_operations_render_workbench
...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'ui_contract': port_terminal_operations_ui_contract(), 'api_contract': port_terminal_operations_build_api_contract(), 'schema_contract': port_terminal_operations_build_schema_contract(), 'service_contract': port_terminal_operations_build_service_contract(), 'release_evidence_contract': port_terminal_operations_build_release_evidence(), 'permissions_contract': port_terminal_operations_permissions_contract(), 'owned_tables': PORT_TERMINAL_OPERATIONS_OWNED_TABLES, 'runtime_tables': PORT_TERMINAL_OPERATIONS_RUNTIME_TABLES, 'allowed_database_backends': PORT_TERMINAL_OPERATIONS_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': PORT_TERMINAL_OPERATIONS_REQUIRED_EVENT_TOPIC, 'emits': PORT_TERMINAL_OPERATIONS_EMITTED_EVENT_TYPES, 'consumes': PORT_TERMINAL_OPERATIONS_CONSUMED_EVENT_TYPES, 'boundary_contract': port_terminal_operations_verify_owned_table_boundary(PORT_TERMINAL_OPERATIONS_OWNED_TABLES + ('api_dependency',))}
