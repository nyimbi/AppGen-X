...
def port_terminal_operations_ui_contract():
    surface = domain_capability_surface_contract()
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('PortTerminalOperationsWorkbench',
 'PortTerminalOperationsDetail',
 'PortTerminalOperationsAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('port_terminal_operations.read',
...
def port_terminal_operations_render_workbench():
    ui = port_terminal_operations_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': port_terminal_operations_ui_contract()['ok'] and port_terminal_operations_render_workbench()['ok'], 'side_effects': ()}
