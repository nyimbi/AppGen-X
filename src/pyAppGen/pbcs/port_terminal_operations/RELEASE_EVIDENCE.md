# Release Evidence - Port Terminal Operations

Package directory: `pbcs/port_terminal_operations`.
...
- Owned datastore boundary: every owned table starts with `port_terminal_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
