...
# Improve1 utility outage restoration control release extension.
...
_OUTAGE_CONTROL_BASE_BUILD_RELEASE_EVIDENCE = build_release_evidence
_OUTAGE_CONTROL_BASE_VALIDATE_RELEASE_EVIDENCE = validate_release_evidence
...
def validate_release_evidence() -> dict:
    validation = dict(_OUTAGE_CONTROL_BASE_VALIDATE_RELEASE_EVIDENCE())
    control = _improve1_utility_outage_restoration_control_contract()
    validation["ok"] = validation.get("ok") is True and control["ok"]
    validation["utility_outage_restoration_control"] = control
