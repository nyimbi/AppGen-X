from pyAppGen.pbcs.utility_outage_restoration import implementation_contract, package_discovery_plan, package_metadata_manifest, validate_package_metadata
from pyAppGen.pbcs.utility_outage_restoration.schema_contract import build_schema_contract
from pyAppGen.pbcs.utility_outage_restoration.service_contract import build_service_contract
from pyAppGen.pbcs.utility_outage_restoration.release_evidence import build_release_evidence, release_readiness_manifest, validate_release_evidence
from pyAppGen.pbcs.utility_outage_restoration.events import event_contract_manifest, validate_event_contract
from pyAppGen.pbcs.utility_outage_restoration.handlers import dispatch_event, handler_manifest
from pyAppGen.pbcs.utility_outage_restoration.services import service_operation_contracts
...
def test_manifest_and_event_contract():
    assert implementation_contract()['pbc'] == 'utility_outage_restoration'
...
def test_registration_plan_is_side_effect_free():
    assert package_metadata_manifest()['pbc'] == 'utility_outage_restoration'
