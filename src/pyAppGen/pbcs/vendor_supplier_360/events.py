"""AppGen-X event contracts for the vendor_supplier_360 PBC."""
PBC_KEY = 'vendor_supplier_360'
EMITTED = ('SupplierQualified', 'SupplierRiskChanged', 'SupplierBankValidated', 'SupplierOnboarded')
CONSUMED = ('PurchaseOrderCreated', 'PaymentRejected', 'CompliancePolicyChanged')
