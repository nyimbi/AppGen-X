...
from .domain_depth import domain_depth_contract as vendor_supplier_360_domain_depth_contract
from .domain_depth import domain_depth_smoke_test as vendor_supplier_360_domain_depth_smoke_test
from .domain_depth import execute_domain_operation as vendor_supplier_360_execute_domain_operation

_VENDOR_SUPPLIER_360_BASE_BUILD_RELEASE_EVIDENCE = vendor_supplier_360_build_release_evidence
_VENDOR_SUPPLIER_360_BASE_RUNTIME_CAPABILITIES = vendor_supplier_360_runtime_capabilities


def vendor_supplier_360_build_release_evidence():
    evidence = dict(_VENDOR_SUPPLIER_360_BASE_BUILD_RELEASE_EVIDENCE())
    domain = vendor_supplier_360_domain_depth_contract()
...
def vendor_supplier_360_runtime_capabilities():
    runtime = dict(_VENDOR_SUPPLIER_360_BASE_RUNTIME_CAPABILITIES())
    domain = vendor_supplier_360_domain_depth_contract()
    smoke = vendor_supplier_360_domain_depth_smoke_test()
    return {
        **runtime,
...
# Improve1 vendor supplier 360 control extension.
from .vendor_supplier_360_control import evaluate_vendor_supplier_360_control, improve1_vendor_supplier_360_control_contract

_VENDOR_CONTROL_BASE_RUNTIME_CAPABILITIES = vendor_supplier_360_runtime_capabilities
_VENDOR_CONTROL_BASE_BUILD_RELEASE_EVIDENCE = vendor_supplier_360_build_release_evidence


def vendor_supplier_360_runtime_capabilities():
    runtime = dict(_VENDOR_CONTROL_BASE_RUNTIME_CAPABILITIES())
    control = improve1_vendor_supplier_360_control_contract()
    runtime["ok"] = bool(runtime.get("ok")) and control["ok"]
    runtime["vendor_supplier_360_control"] = control
    runtime["operations"] = tuple(dict.fromkeys(tuple(runtime.get("operations", ())) + ("evaluate_vendor_supplier_360_control", "improve1_vendor_supplier_360_control_contract")))
...
def vendor_supplier_360_build_release_evidence():
    ...
    artifacts["vendor_supplier_360_control"] = {
