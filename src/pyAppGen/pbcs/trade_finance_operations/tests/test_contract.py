from pyAppGen.pbcs.trade_finance_operations import implementation_contract, package_discovery_plan, package_metadata_manifest, validate_package_metadata
...
from pyAppGen.pbcs.trade_finance_operations.release_evidence import build_release_evidence, release_readiness_manifest, validate_release_evidence
from pyAppGen.pbcs.trade_finance_operations.events import event_contract_manifest, validate_event_contract
from pyAppGen.pbcs.trade_finance_operations.handlers import dispatch_event, handler_manifest
from pyAppGen.pbcs.trade_finance_operations.services import service_operation_contracts
from pyAppGen.pbcs.trade_finance_operations.routes import api_route_contracts, validate_api_route_contracts
from pyAppGen.pbcs.trade_finance_operations.config import governance_smoke_test
from pyAppGen.pbcs.trade_finance_operations.agent import agent_skill_manifest, chatbot_interface_contract, document_instruction_plan, datastore_crud_plan
...
def test_manifest_and_event_contract():
    assert implementation_contract()['pbc'] == 'trade_finance_operations'
...
def test_registration_plan_is_side_effect_free():
    assert package_metadata_manifest()['pbc'] == 'trade_finance_operations'
