...
DOMAIN_ENTITY = 'letter_of_credit'
DOMAIN_PURPOSE = 'Letters of credit, guarantees, documentary collections, sanctions checks, shipment documents, and trade settlement'
DOMAIN_OWNED_TABLES = ('trade_finance_operations_letter_of_credit',
...
DOMAIN_OPERATIONS = ('create_letter_of_credit',
 'record_bank_guarantee',
 'review_documentary_collection',
 'approve_trade_document',
 'simulate_sanctions_check',
 'create_shipment_evidence',
 'record_trade_settlement',
 'review_trade_finance_operations_policy_rule',
 'approve_trade_finance_operations_runtime_parameter',
 'simulate_trade_finance_operations_schema_extension',
 'create_trade_finance_operations_control_assertion',
 'record_trade_finance_operations_governed_model',
 'operate_trade_finance_operations_13',
 'operate_trade_finance_operations_14',
 'operate_trade_finance_operations_15',
 'operate_trade_finance_operations_16',
 'operate_trade_finance_operations_17',
 'operate_trade_finance_operations_18')
DOMAIN_RULES = ('letter_of_credit_policy',
 'bank_guarantee_policy',
 'documentary_collection_policy',
 'trade_document_policy',
 'sanctions_check_policy',
 'shipment_evidence_policy')
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('TradeFinanceOperationsCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('trade finance operations event sourced operational history',
...
DOMAIN_WORKBENCH_VIEWS = ('letter of credit board',
 'bank guarantee board',
 'documentary collection board',
 'trade document board',
 'sanctions check board',
 'shipment evidence board',
 'trade settlement board')
