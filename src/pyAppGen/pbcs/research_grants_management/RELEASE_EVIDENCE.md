# Release Evidence - Research Grants Management

Package directory: `pbcs/research_grants_management`.
...
- Owned datastore boundary: every owned table starts with `research_grants_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
