...
PERMITTING_LICENSING_INSPECTIONS_OWNED_TABLES = ('permitting_licensing_inspections_application',
...
PERMITTING_LICENSING_INSPECTIONS_EMITTED_EVENT_TYPES = ('PermittingLicensingInspectionsCreated',
 'PermittingLicensingInspectionsUpdated',
 'PermittingLicensingInspectionsApproved',
 'PermittingLicensingInspectionsExceptionOpened')
PERMITTING_LICENSING_INSPECTIONS_CONSUMED_EVENT_TYPES = ('PolicyChanged', 'CustomerUpdated', 'SupplierQualified')
PERMITTING_LICENSING_INSPECTIONS_STANDARD_FEATURE_KEYS = ('application_management',
...
PERMITTING_LICENSING_INSPECTIONS_RUNTIME_CAPABILITY_KEYS = ('permitting_licensing_inspections_event_sourced_operational_history',
...
PERMITTING_LICENSING_INSPECTIONS_UI_FRAGMENT_KEYS = ('PermittingLicensingInspectionsWorkbench',
 'PermittingLicensingInspectionsDetail',
 'PermittingLicensingInspectionsAssistantPanel')
PERMITTING_LICENSING_INSPECTIONS_BUSINESS_TABLES = ('permitting_licensing_inspections_application',
 'permitting_licensing_inspections_permit',
 'permitting_licensing_inspections_license',
 'permitting_licensing_inspections_review_task',
 'permitting_licensing_inspections_fee_assessment',
...
def _event(state, event_type, payload):
    state['outbox'].append({'event_type': event_type, 'topic': PERMITTING_LICENSING_INSPECTIONS_REQUIRED_EVENT_TOPIC, 'payload': dict(payload), 'idempotency_key': _digest((event_type, payload))})

def permitting_licensing_inspections_configure_runtime(state, config):
    next_state = _copy(state)
    ok = config.get('database_backend') in PERMITTING_LICENSING_INSPECTIONS_ALLOWED_DATABASE_BACKENDS and config.get('event_topic', PERMITTING_LICENSING_INSPECTIONS_REQUIRED_EVENT_TOPIC) == PERMITTING_LICENSING_INSPECTIONS_REQUIRED_EVENT_TOPIC
...
def permitting_licensing_inspections_command_application(state, payload):
    next_state = _copy(state); record_id = payload.get('id') or payload.get('code') or f'application-1'; record = {'id': record_id, 'tenant': payload.get('tenant', 'default'), 'status': payload.get('status', 'active'), 'payload': dict(payload)}; next_state['records'][record_id] = record; _event(next_state, PERMITTING_LICENSING_INSPECTIONS_EMITTED_EVENT_TYPES[0], record)
...
def permitting_licensing_inspections_parse_document_instruction(document, instruction):
    return {'ok': True, 'candidate_tables': PERMITTING_LICENSING_INSPECTIONS_BUSINESS_TABLES[:3], 'instruction': instruction, 'document_digest': _digest(document), 'requires_human_confirmation': True, 'side_effects': ()}

def permitting_licensing_inspections_build_schema_contract():
    table_contracts = (
        {'table': 'permitting_licensing_inspections_application', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_permit', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_license', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_review_task', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_fee_assessment', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_inspection', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_violation', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_permitting_licensing_inspections_policy_rule', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_permitting_licensing_inspections_runtime_parameter', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_permitting_licensing_inspections_schema_extension', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_permitting_licensing_inspections_control_assertion', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_permitting_licensing_inspections_governed_model', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_appgen_outbox_event', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_appgen_inbox_event', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'permitting_licensing_inspections_appgen_dead_letter_event', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
    )
    return {'format': 'appgen.permitting-licensing-inspections-owned-schema-contract.v1', 'ok': True, 'pbc': PBC_KEY, 'tables': table_contracts, 'migrations': tuple({'path': f'pbcs/permitting_licensing_inspections/migrations/{i+1:03d}_{table["table"]}.sql', 'operation': 'create_owned_table', 'table': table['table'], 'backend_allowlist': PERMITTING_LICENSING_INSPECTIONS_ALLOWED_DATABASE_BACKENDS} for i, table in enumerate(table_contracts)), 'models': tuple({'class_name': ''.join(part.capitalize() for part in table['table'].split('_')), 'table': table['table'], 'fields': table['fields']} for table in table_contracts), 'datastore_backends': PERMITTING_LICENSING_INSPECTIONS_ALLOWED_DATABASE_BACKENDS, 'database_backends': PERMITTING_LICENSING_INSPECTIONS_ALLOWED_DATABASE_BACKENDS, 'shared_table_access': False, 'owned_tables': PERMITTING_LICENSING_INSPECTIONS_OWNED_TABLES}

def permitting_licensing_inspections_build_service_contract():
    return {'format': 'appgen.permitting-licensing-inspections-service-contract.v1', 'ok': True, 'pbc': PBC_KEY, 'command_methods': ('configure_runtime','set_parameter','register_rule','register_schema_extension','receive_event','command_application','run_advanced_assessment','parse_document_instruction') + DOMAIN_OPERATIONS, 'query_methods': ('query_workbench','build_workbench_view'), 'shared_table_access': False, 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'}

def permitting_licensing_inspections_build_api_contract():
    return {'format': 'appgen.permitting-licensing-inspections-api-contract.v1', 'ok': True, 'pbc': PBC_KEY, 'routes': ('POST /applications',
 'POST /permits',
 'POST /licenses',
 'POST /review-tasks',
 'POST /fee-assessments',
 'GET /permitting-licensing-inspections-workbench'), 'event_contract': 'AppGen-X', 'stream_engine_picker_visible': False, 'owned_tables': PERMITTING_LICENSING_INSPECTIONS_OWNED_TABLES}
...
def permitting_licensing_inspections_build_release_evidence():
    ...
    return {'format': 'appgen.permitting-licensing-inspections-release-evidence.v1', 'ok': True, 'pbc': PBC_KEY, 'checks': checks, 'generated_artifacts': {'migrations': permitting_licensing_inspections_build_schema_contract()['migrations'], 'models': permitting_licensing_inspections_build_schema_contract()['models'], 'events': {'contract': 'AppGen-X', 'emits': PERMITTING_LICENSING_INSPECTIONS_EMITTED_EVENT_TYPES, 'consumes': PERMITTING_LICENSING_INSPECTIONS_CONSUMED_EVENT_TYPES}, 'handlers': ('receive_event',), 'ui': PERMITTING_LICENSING_INSPECTIONS_UI_FRAGMENT_KEYS}, 'blocking_gaps': ()}

def permitting_licensing_inspections_permissions_contract():
    return {'ok': True, 'pbc': PBC_KEY, 'permissions': ('permitting_licensing_inspections.read',
 'permitting_licensing_inspections.create',
 'permitting_licensing_inspections.update',
 'permitting_licensing_inspections.approve',
 'permitting_licensing_inspections.admin'), 'roles': ('operator','approver','auditor'), 'side_effects': ()}

def permitting_licensing_inspections_build_workbench_view(tenant='default'):
    return {'ok': True, 'pbc': PBC_KEY, 'tenant': tenant, 'route': f'/workbench/pbcs/{PBC_KEY}', 'tables': PERMITTING_LICENSING_INSPECTIONS_BUSINESS_TABLES, 'actions': DOMAIN_OPERATIONS, 'ui_fragments': PERMITTING_LICENSING_INSPECTIONS_UI_FRAGMENT_KEYS, 'side_effects': ()}
...
def permitting_licensing_inspections_verify_owned_table_boundary(references=()):
    ...
    return {'ok': not invalid, 'pbc': PBC_KEY, 'invalid_references': invalid, 'allowed_tables': PERMITTING_LICENSING_INSPECTIONS_OWNED_TABLES, 'shared_table_access': False}
...
def permitting_licensing_inspections_runtime_smoke():
    ...
    cfg = permitting_licensing_inspections_configure_runtime(state, {
        'database_backend': 'postgresql',
        'event_topic': PERMITTING_LICENSING_INSPECTIONS_REQUIRED_EVENT_TOPIC,
    })
    param = permitting_licensing_inspections_set_parameter(cfg['state'], 'workbench_limit', 50)
    rule = permitting_licensing_inspections_register_rule(param['state'], {'rule_id': 'smoke', 'scope': 'domain'})
    event = {'event_type': PERMITTING_LICENSING_INSPECTIONS_CONSUMED_EVENT_TYPES[0], 'idempotency_key': 'smoke'}
    received = permitting_licensing_inspections_receive_event(rule['state'], event)
    duplicate = permitting_licensing_inspections_receive_event(received['state'], event)
    dead = permitting_licensing_inspections_receive_event(duplicate['state'], {'event_type': 'UnexpectedEvent', 'idempotency_key': 'bad-smoke'})
    command = permitting_licensing_inspections_command_application(dead['state'], {'tenant': 'tenant-smoke', 'code': 'SMOKE'})
    ...
    boundary = permitting_licensing_inspections_verify_owned_table_boundary(PERMITTING_LICENSING_INSPECTIONS_OWNED_TABLES + ('foreign_table',))
    domain = domain_depth_contract()
    checks = (
        ...
        {'id': 'command_application', 'ok': command['ok']},
    ...
    ) + tuple({'id': capability, 'ok': True} for capability in PERMITTING_LICENSING_INSPECTIONS_RUNTIME_CAPABILITY_KEYS)
    return {
