...
ROUTES = ROUTES + (
    {'method': 'POST', 'path': '/api/pbc/enterprise_pim/attribute-groups', 'handler': 'command_attribute_groups', 'permission': 'enterprise_pim.attribute'},
    {'method': 'POST', 'path': '/api/pbc/enterprise_pim/attribute-options', 'handler': 'command_attribute_options', 'permission': 'enterprise_pim.attribute'},
    {'method': 'POST', 'path': '/api/pbc/enterprise_pim/attribute-validation-rules', 'handler': 'command_attribute_validation_rules', 'permission': 'enterprise_pim.attribute'},
    {'method': 'POST', 'path': '/api/pbc/enterprise_pim/translation-memory', 'handler': 'command_translation_memory', 'permission': 'enterprise_pim.localization'},
    {'method': 'POST', 'path': '/api/pbc/enterprise_pim/locale-fallback-rules', 'handler': 'command_locale_fallbacks', 'permission': 'enterprise_pim.localization'},
    {'method': 'POST', 'path': '/api/pbc/enterprise_pim/product-relationships', 'handler': 'command_product_relationships', 'permission': 'enterprise_pim.taxonomy'},
    {'method': 'POST', 'path': '/api/pbc/enterprise_pim/product-bundles', 'handler': 'command_product_bundles', 'permission': 'enterprise_pim.attribute'},
    {'method': 'POST', 'path': '/api/pbc/enterprise_pim/variant-families', 'handler': 'command_variant_families', 'permission': 'enterprise_pim.attribute'},
    {'method': 'POST', 'path': '/api/pbc/enterprise_pim/variant-members', 'handler': 'command_variant_members', 'permission': 'enterprise_pim.attribute'},
...
API_ROUTE_CONTRACTS = API_ROUTE_CONTRACTS + tuple(
    {
        **contract,
        ...
        'idempotency_key': f"enterprise_pim:{contract['operation']}:idempotency_key",
