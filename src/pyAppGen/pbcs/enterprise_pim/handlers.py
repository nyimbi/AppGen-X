...
HANDLER_CONTRACTS = ({'event_type': 'InventoryPositionUpdated', 'function': 'handle_inventory_position_updated', 'idempotency_key': 'enterprise_pim:InventoryPositionUpdated:{event_id}', 'retry_policy': {'name': 'enterprise_pim_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'enterprise_pim_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'MediaAssetApproved', 'function': 'handle_media_asset_approved', 'idempotency_key': 'enterprise_pim:MediaAssetApproved:{event_id}', 'retry_policy': {'name': 'enterprise_pim_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'enterprise_pim_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'PricePromotionApproved', 'function': 'handle_price_promotion_approved', 'idempotency_key': 'enterprise_pim:PricePromotionApproved:{event_id}', 'retry_policy': {'name': 'enterprise_pim_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'enterprise_pim_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'TaxCalculated', 'function': 'handle_tax_calculated', 'idempotency_key': 'enterprise_pim:TaxCalculated:{event_id}', 'retry_policy': {'name': 'enterprise_pim_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'enterprise_pim_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
