...
from .runtime import *
from .ui import smart_city_mobility_operations_ui_contract, smart_city_mobility_operations_render_workbench
...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'ui_contract': smart_city_mobility_operations_ui_contract(), 'api_contract': smart_city_mobility_operations_build_api_contract(), 'schema_contract': smart_city_mobility_operations_build_schema_contract(), 'service_contract': smart_city_mobility_operations_build_service_contract(), 'release_evidence_contract': smart_city_mobility_operations_build_release_evidence(), 'permissions_contract': smart_city_mobility_operations_permissions_contract(), 'owned_tables': SMART_CITY_MOBILITY_OPERATIONS_OWNED_TABLES, 'runtime_tables': SMART_CITY_MOBILITY_OPERATIONS_RUNTIME_TABLES, 'allowed_database_backends': SMART_CITY_MOBILITY_OPERATIONS_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': SMART_CITY_MOBILITY_OPERATIONS_REQUIRED_EVENT_TOPIC, 'emits': SMART_CITY_MOBILITY_OPERATIONS_EMITTED_EVENT_TYPES, 'consumes': SMART_CITY_MOBILITY_OPERATIONS_CONSUMED_EVENT_TYPES, 'boundary_contract': smart_city_mobility_operations_verify_owned_table_boundary(SMART_CITY_MOBILITY_OPERATIONS_OWNED_TABLES + ('api_dependency',))}
