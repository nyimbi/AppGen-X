...
DOMAIN_ENTITY = 'transit_service'
DOMAIN_PURPOSE = 'Transit, parking, traffic signals, incidents, curb management, multimodal services, and city mobility analytics'
DOMAIN_OWNED_TABLES = ('smart_city_mobility_operations_transit_service',
...
DOMAIN_OPERATIONS = ('create_transit_service',
 'record_parking_asset',
 'review_signal_plan',
 'approve_traffic_incident',
 'simulate_curb_allocation',
 'create_mobility_sensor',
 'record_service_disruption',
 'review_smart_city_mobility_operations_policy_rule',
 'approve_smart_city_mobility_operations_runtime_parameter',
 'simulate_smart_city_mobility_operations_schema_extension',
 'create_smart_city_mobility_operations_control_assertion',
 'record_smart_city_mobility_operations_governed_model',
 'operate_smart_city_mobility_operations_13',
 'operate_smart_city_mobility_operations_14',
 'operate_smart_city_mobility_operations_15',
 'operate_smart_city_mobility_operations_16',
 'operate_smart_city_mobility_operations_17',
 'operate_smart_city_mobility_operations_18')
DOMAIN_RULES = ('transit_service_policy',
 'parking_asset_policy',
 'signal_plan_policy',
 'traffic_incident_policy',
 'curb_allocation_policy',
 'mobility_sensor_policy')
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('SmartCityMobilityOperationsCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('smart city mobility operations event sourced operational history',
 'smart city mobility operations multi tenant policy isolation',
 'smart city mobility operations schema evolution resilience',
 'smart city mobility operations autonomous anomaly detection',
 'smart city mobility operations semantic document instruction understanding',
 'smart city mobility operations predictive risk scoring')
DOMAIN_WORKBENCH_VIEWS = ('transit service board',
 'parking asset board',
 'signal plan board',
 'traffic incident board',
 'curb allocation board',
 'mobility sensor board',
