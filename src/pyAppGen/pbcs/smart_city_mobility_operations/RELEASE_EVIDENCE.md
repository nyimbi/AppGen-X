# Release Evidence - Smart City Mobility Operations

Package directory: `pbcs/smart_city_mobility_operations`.
...
- Owned datastore boundary: every owned table starts with `smart_city_mobility_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
