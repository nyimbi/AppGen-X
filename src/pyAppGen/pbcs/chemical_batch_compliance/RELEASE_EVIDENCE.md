...
Package directory: `pbcs/chemical_batch_compliance`.
...
- Owned datastore boundary: every owned table starts with `chemical_batch_compliance_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
