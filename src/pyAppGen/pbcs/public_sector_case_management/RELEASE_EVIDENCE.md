# Release Evidence - Public Sector Case Management

Package directory: `pbcs/public_sector_case_management`.
...
- Owned datastore boundary: every owned table starts with `public_sector_case_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
