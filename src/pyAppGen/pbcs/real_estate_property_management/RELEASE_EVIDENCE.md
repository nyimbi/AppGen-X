...
- Owned datastore boundary: every owned table starts with `real_estate_property_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
