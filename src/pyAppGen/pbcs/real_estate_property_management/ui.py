...
def real_estate_property_management_ui_contract():
    ...
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('RealEstatePropertyManagementWorkbench',
 'RealEstatePropertyManagementDetail',
 'RealEstatePropertyManagementAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('real_estate_property_management.read',
...
def real_estate_property_management_render_workbench():
    ui = real_estate_property_management_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': real_estate_property_management_ui_contract()['ok'] and real_estate_property_management_render_workbench()['ok'], 'side_effects': ()}
