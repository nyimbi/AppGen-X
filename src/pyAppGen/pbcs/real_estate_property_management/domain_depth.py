...
DOMAIN_ENTITY = 'property'
DOMAIN_PURPOSE = 'Properties, leases, tenants, rent, maintenance, inspections, deposits, and property compliance'
DOMAIN_OWNED_TABLES = ('real_estate_property_management_property',
...
DOMAIN_OPERATIONS = ('create_property',
 'record_tenant',
 'review_lease',
 'approve_rent_charge',
 'simulate_maintenance_request',
 'create_inspection',
 'record_security_deposit',
 'review_real_estate_property_management_policy_rule',
 'approve_real_estate_property_management_runtime_parameter',
 'simulate_real_estate_property_management_schema_extension',
 'create_real_estate_property_management_control_assertion',
 'record_real_estate_property_management_governed_model',
 'operate_real_estate_property_management_13',
 'operate_real_estate_property_management_14',
 'operate_real_estate_property_management_15',
 'operate_real_estate_property_management_16',
 'operate_real_estate_property_management_17',
 'operate_real_estate_property_management_18')
DOMAIN_RULES = ('property_policy',
 'tenant_policy',
 'lease_policy',
 'rent_charge_policy',
...
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('RealEstatePropertyManagementCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('real estate property management event sourced operational history',
 'real estate property management multi tenant policy isolation',
 'real estate property management schema evolution resilience',
 'real estate property management autonomous anomaly detection',
 'real estate property management semantic document instruction understanding',
 'real estate property management predictive risk scoring')
DOMAIN_WORKBENCH_VIEWS = ('property board',
 'tenant board',
 'lease board',
 'rent charge board',
 'maintenance request board',
 'inspection board',
 'security deposit board')
