...
def wealth_portfolio_management_ui_contract():
    ...
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('WealthPortfolioManagementWorkbench',
 'WealthPortfolioManagementDetail',
 'WealthPortfolioManagementAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('wealth_portfolio_management.read',
...
def wealth_portfolio_management_render_workbench():
    ui = wealth_portfolio_management_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': wealth_portfolio_management_ui_contract()['ok'] and wealth_portfolio_management_render_workbench()['ok'], 'side_effects': ()}
