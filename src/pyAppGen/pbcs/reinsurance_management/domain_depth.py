...
DOMAIN_PURPOSE = 'Treaties, facultative placements, cessions, recoverables, bordereaux, claims recoveries, and exposure'
DOMAIN_OWNED_TABLES = ('reinsurance_management_reinsurance_treaty',
...
DOMAIN_OPERATIONS = ('create_reinsurance_treaty',
 ...
 'review_reinsurance_management_policy_rule',
 'approve_reinsurance_management_runtime_parameter',
 'simulate_reinsurance_management_schema_extension',
 'create_reinsurance_management_control_assertion',
 'record_reinsurance_management_governed_model',
 'operate_reinsurance_management_13',
 'operate_reinsurance_management_14',
 'operate_reinsurance_management_15',
 'operate_reinsurance_management_16',
 'operate_reinsurance_management_17',
 'operate_reinsurance_management_18')
DOMAIN_RULES = ('reinsurance_treaty_policy',
 'facultative_placement_policy',
 'cession_policy',
 'bordereau_policy',
 'recoverable_policy',
...
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('ReinsuranceManagementCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('reinsurance management event sourced operational history',
 'reinsurance management multi tenant policy isolation',
 'reinsurance management schema evolution resilience',
 'reinsurance management autonomous anomaly detection',
 'reinsurance management semantic document instruction understanding',
 'reinsurance management predictive risk scoring')
DOMAIN_WORKBENCH_VIEWS = ('reinsurance treaty board',
 'facultative placement board',
 'cession board',
 'bordereau board',
 'recoverable board',
 'claim recovery board',
 'exposure layer board')
