# Release Evidence - Reinsurance Management

Package directory: `pbcs/reinsurance_management`.
...
- Owned datastore boundary: every owned table starts with `reinsurance_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
