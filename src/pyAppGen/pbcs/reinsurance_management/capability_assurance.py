"""Capability assurance helpers for reinsurance_management."""
...
def validate_table_stakes_capability_coverage():
    ...
    return {
        'ok': not invalid_backends and not invalid_tables and manifest['event_contract'] == 'AppGen-X' and manifest['stream_picker_visible'] is False and manifest['standalone_app']['ok'],
        'missing_standard': (),
        'missing_advanced': (),
        'missing_operations': (),
        'uncovered_features': (),
