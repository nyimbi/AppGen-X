"""World-class domain depth contract for the it_service_management PBC."""
from __future__ import annotations
import hashlib

PBC_KEY = 'it_service_management'
DOMAIN_ENTITY = 'it_incident'
DOMAIN_PURPOSE = 'Incidents, requests, changes, problems, configuration items, service levels, and IT operations controls'
DOMAIN_OWNED_TABLES = ('it_service_management_it_incident',
...
DOMAIN_OPERATIONS = ('create_it_incident',
 'record_service_request',
 'review_change_request',
 'approve_problem_record',
 'simulate_configuration_item',
 'create_sla_clock',
 'record_knowledge_article',
 'review_it_service_management_policy_rule',
 'approve_it_service_management_runtime_parameter',
 'simulate_it_service_management_schema_extension',
 'create_it_service_management_control_assertion',
 'record_it_service_management_governed_model',
 'operate_it_service_management_13',
 'operate_it_service_management_14',
 'operate_it_service_management_15',
 'operate_it_service_management_16',
 'operate_it_service_management_17',
 'operate_it_service_management_18')
DOMAIN_RULES = ('it_incident_policy',
 'service_request_policy',
 'change_request_policy',
 'problem_record_policy',
 'configuration_item_policy',
 'sla_clock_policy')
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('ItServiceManagementCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('it service management event sourced operational history',
 'it service management multi tenant policy isolation',
 'it service management schema evolution resilience',
 'it service management autonomous anomaly detection',
 'it service management semantic document instruction understanding',
 'it service management predictive risk scoring')
DOMAIN_WORKBENCH_VIEWS = ('it incident board',
 'service request board',
 'change request board',
 'problem record board',
 'configuration item board',
 'sla clock board',
 'knowledge article board')
