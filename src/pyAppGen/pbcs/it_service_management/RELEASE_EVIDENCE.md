# Release Evidence - IT Service Management

Package directory: `pbcs/it_service_management`.
...
- Owned datastore boundary: every owned table starts with `it_service_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
