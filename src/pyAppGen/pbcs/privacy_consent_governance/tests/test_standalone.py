"""Standalone app smoke tests for privacy_consent_governance."""

from __future__ import annotations

from ..standalone import PrivacyConsentGovernanceStandaloneApp, smoke_test
from ..ui import privacy_consent_governance_standalone_app_contract


def test_standalone_manifest_and_smoke():
    contract = privacy_consent_governance_standalone_app_contract()
...
def test_standalone_app_can_bootstrap_and_render():
    ...
    assert rendered['shell']['app_id'] == 'privacy_consent_governance_one_pbc_app'
