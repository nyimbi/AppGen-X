from pyAppGen.pbcs.privacy_consent_governance import implementation_contract, package_discovery_plan, package_metadata_manifest, validate_package_metadata
...
from pyAppGen.pbcs.privacy_consent_governance.release_evidence import build_release_evidence, release_readiness_manifest, validate_release_evidence
...
from pyAppGen.pbcs.privacy_consent_governance.services import service_operation_contracts
...
from pyAppGen.pbcs.privacy_consent_governance.agent import agent_skill_manifest, chatbot_interface_contract, document_instruction_plan, datastore_crud_plan
...
def test_event_handlers_are_idempotent_and_retryable():
    ...
    assert dispatch_event({'event_type': ('CustomerUpdated', 'AccessPolicyChanged', 'AuditProofGenerated')[0], 'idempotency_key': 'idem'})['ok'] is True
