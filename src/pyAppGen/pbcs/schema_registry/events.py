...
EVENT_CONTRACT = {
    ...
    "emitted": (
        {"event_type": "SchemaSubjectRegistered", "schema": "schema_registry.schema_subject_registered.emitted.v1", "topic": "pbc.schema_registry.events", "outbox_table": "schema_registry_appgen_outbox_event", "payload_fields": ("event_id", "occurred_at", "pbc", "data")},
        {"event_type": "SchemaAccepted", "schema": "schema_registry.schema_accepted.emitted.v1", "topic": "pbc.schema_registry.events", "outbox_table": "schema_registry_appgen_outbox_event", "payload_fields": ("event_id", "occurred_at", "pbc", "data")},
        {"event_type": "BreakingSchemaBlocked", "schema": "schema_registry.breaking_schema_blocked.emitted.v1", "topic": "pbc.schema_registry.events", "outbox_table": "schema_registry_appgen_outbox_event", "payload_fields": ("event_id", "occurred_at", "pbc", "data")},
        {"event_type": "PayloadValidated", "schema": "schema_registry.payload_validated.emitted.v1", "topic": "pbc.schema_registry.events", "outbox_table": "schema_registry_appgen_outbox_event", "payload_fields": ("event_id", "occurred_at", "pbc", "data")},
        {"event_type": "ContractViolationRecorded", "schema": "schema_registry.contract_violation_recorded.emitted.v1", "topic": "pbc.schema_registry.events", "outbox_table": "schema_registry_appgen_outbox_event", "payload_fields": ("event_id", "occurred_at", "pbc", "data")},
        {"event_type": "ContractProjectionPublished", "schema": "schema_registry.contract_projection_published.emitted.v1", "topic": "pbc.schema_registry.events", "outbox_table": "schema_registry_appgen_outbox_event", "payload_fields": ("event_id", "occurred_at", "pbc", "data")},
    ),
    "consumed": (
        {"event_type": "PbcDeployed", "schema": "schema_registry.pbc_deployed.consumed.v1", "topic": "pbc.schema_registry.inbox", "inbox_table": "schema_registry_appgen_inbox_event", "payload_fields": ("event_id", "occurred_at", "source_pbc", "data")},
        {"event_type": "EventContractProposed", "schema": "schema_registry.event_contract_proposed.consumed.v1", "topic": "pbc.schema_registry.inbox", "inbox_table": "schema_registry_appgen_inbox_event", "payload_fields": ("event_id", "occurred_at", "source_pbc", "data")},
        {"event_type": "RoutePublished", "schema": "schema_registry.route_published.consumed.v1", "topic": "pbc.schema_registry.inbox", "inbox_table": "schema_registry_appgen_inbox_event", "payload_fields": ("event_id", "occurred_at", "source_pbc", "data")},
        {"event_type": "AccessPolicyChanged", "schema": "schema_registry.access_policy_changed.consumed.v1", "topic": "pbc.schema_registry.inbox", "inbox_table": "schema_registry_appgen_inbox_event", "payload_fields": ("event_id", "occurred_at", "source_pbc", "data")},
        {"event_type": "PackageRegistrationRequested", "schema": "schema_registry.package_registration_requested.consumed.v1", "topic": "pbc.schema_registry.inbox", "inbox_table": "schema_registry_appgen_inbox_event", "payload_fields": ("event_id", "occurred_at", "source_pbc", "data")},
    ),
