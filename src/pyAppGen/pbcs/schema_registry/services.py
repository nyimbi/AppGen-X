...
OPERATION_CONTRACTS = ({'operation': 'command_schemas', 'operation_kind': 'command', 'method': 'POST', 'path': '/api/pbc/schema_registry/schemas', 'permission': 'schema_registry.command.1', 'owned_tables': ('schema_registry_schema_subject', 'schema_registry_schema_version', 'schema_registry_compatibility_rule', 'schema_registry_contract_violation'), 'read_tables': (), 'emitted_event': 'SchemaAccepted', 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'}, {'operation': 'command_compatibility_checks', 'operation_kind': 'command', 'method': 'POST', 'path': '/api/pbc/schema_registry/compatibility-checks', 'permission': 'schema_registry.command.2', 'owned_tables': ('schema_registry_schema_subject', 'schema_registry_schema_version', 'schema_registry_compatibility_rule', 'schema_registry_contract_violation'), 'read_tables': (), 'emitted_event': 'BreakingSchemaBlocked', 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'}, {'operation': 'query_subjects', 'operation_kind': 'query', 'method': 'GET', 'path': '/api/pbc/schema_registry/subjects', 'permission': 'schema_registry.query.3', 'owned_tables': (), 'read_tables': ('schema_registry_schema_subject', 'schema_registry_schema_version', 'schema_registry_compatibility_rule', 'schema_registry_contract_violation'), 'emitted_event': None, 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'})
...
class SchemaRegistryService:
    ...
    def query_subjects(self, payload=None):
        return self._query('query_subjects', payload or {})
