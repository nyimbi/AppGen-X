"""Executable runtime capability proofs for the schema_registry PBC."""
...
def test_configuration_rules_parameters_and_ui_are_executable():
    ...
    configured = _call(
        ...
        state,
        {
            ...
            "event_topic": getattr(runtime, "SCHEMA_REGISTRY_REQUIRED_EVENT_TOPIC"),
            "retry_limit": 3,
        },
    )
    parameter = _call("set_parameter", configured["state"], "compatibility_threshold", 0.8)
    ...
    ui_contract = ui.schema_registry_ui_contract()
