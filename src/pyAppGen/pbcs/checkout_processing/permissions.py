"""Executable permission contract for the checkout_processing PBC."""

PBC_KEY = 'checkout_processing'
PERMISSIONS = ('checkout_processing.read', 'checkout_processing.create', 'checkout_processing.update', 'checkout_processing.approve', 'checkout_processing.admin')
ACTION_PERMISSIONS = {
