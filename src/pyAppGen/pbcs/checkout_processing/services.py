...
class CheckoutProcessingService:
    ...
    def command_inventory_confirmations(self, payload=None):
        return self._command('command_inventory_confirmations', payload or {})

    def command_payment_authorizations(self, payload=None):
        return self._command('command_payment_authorizations', payload or {})

    def command_payment_captures(self, payload=None):
        return self._command('command_payment_captures', payload or {})
