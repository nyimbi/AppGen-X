...
HANDLER_CONTRACTS = ({'event_type': 'ProductPublished', 'function': 'handle_product_published', 'idempotency_key': 'checkout_processing:ProductPublished:{event_id}', 'retry_policy': {'name': 'checkout_processing_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'checkout_processing_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'PriceOptimized', 'function': 'handle_price_optimized', 'idempotency_key': 'checkout_processing:PriceOptimized:{event_id}', 'retry_policy': {'name': 'checkout_processing_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'checkout_processing_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'TaxCalculated', 'function': 'handle_tax_calculated', 'idempotency_key': 'checkout_processing:TaxCalculated:{event_id}', 'retry_policy': {'name': 'checkout_processing_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'checkout_processing_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
