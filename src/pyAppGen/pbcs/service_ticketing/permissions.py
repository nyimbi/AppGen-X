"""Executable permission contract for the service_ticketing PBC."""

PBC_KEY = 'service_ticketing'
PERMISSIONS = ('service_ticketing.read', 'service_ticketing.create', 'service_ticketing.update', 'service_ticketing.approve', 'service_ticketing.admin')
ACTION_PERMISSIONS = {
