"""Executable permission contract for the ap_automation PBC."""

PBC_KEY = 'ap_automation'
PERMISSIONS = ('ap_automation.read', 'ap_automation.create', 'ap_automation.update', 'ap_automation.approve', 'ap_automation.admin')
ACTION_PERMISSIONS = {
