...
HANDLER_CONTRACTS = ({'event_type': 'VendorApproved', 'function': 'handle_vendor_approved', 'idempotency_key': 'ap_automation:VendorApproved:{event_id}', 'retry_policy': {'name': 'ap_automation_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'ap_automation_dead_letter', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'PurchaseOrderApproved', 'function': 'handle_purchase_order_approved', 'idempotency_key': 'ap_automation:PurchaseOrderApproved:{event_id}', 'retry_policy': {'name': 'ap_automation_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'ap_automation_dead_letter', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'GoodsReceiptPosted', 'function': 'handle_goods_receipt_posted', 'idempotency_key': 'ap_automation:GoodsReceiptPosted:{event_id}', 'retry_policy': {'name': 'ap_automation_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'ap_automation_dead_letter', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'TaxPolicyChanged', 'function': 'handle_tax_policy_changed', 'idempotency_key': 'ap_automation:TaxPolicyChanged:{event_id}', 'retry_policy': {'name': 'ap_automation_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'ap_automation_dead_letter', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'CashForecastUpdated', 'function': 'handle_cash_forecast_updated', 'idempotency_key': 'ap_automation:CashForecastUpdated:{event_id}', 'retry_policy': {'name': 'ap_automation_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'ap_automation_dead_letter', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'AccessPolicyChanged', 'function': 'handle_access_policy_changed', 'idempotency_key': 'ap_automation:AccessPolicyChanged:{event_id}', 'retry_policy': {'name': 'ap_automation_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'ap_automation_dead_letter', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
