...
HANDLER_CONTRACTS = ({'event_type': 'InventoryAllocated', 'function': 'handle_inventory_allocated', 'idempotency_key': 'dom:InventoryAllocated:{event_id}', 'retry_policy': {'name': 'dom_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'dom_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'TaxCalculated', 'function': 'handle_tax_calculated', 'idempotency_key': 'dom:TaxCalculated:{event_id}', 'retry_policy': {'name': 'dom_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'dom_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'CustomerUpdated', 'function': 'handle_customer_updated', 'idempotency_key': 'dom:CustomerUpdated:{event_id}', 'retry_policy': {'name': 'dom_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'dom_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'PaymentAuthorized', 'function': 'handle_payment_authorized', 'idempotency_key': 'dom:PaymentAuthorized:{event_id}', 'retry_policy': {'name': 'dom_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'dom_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'ShipmentDelivered', 'function': 'handle_shipment_delivered', 'idempotency_key': 'dom:ShipmentDelivered:{event_id}', 'retry_policy': {'name': 'dom_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'dom_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
