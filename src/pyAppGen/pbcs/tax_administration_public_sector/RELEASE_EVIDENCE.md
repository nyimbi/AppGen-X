# Release Evidence - Public Sector Tax Administration

Package directory: `pbcs/tax_administration_public_sector`.
...
- Owned datastore boundary: every owned table starts with `tax_administration_public_sector_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
