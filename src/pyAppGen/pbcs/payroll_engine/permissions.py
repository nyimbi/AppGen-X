"""Executable permission contract for the payroll_engine PBC."""

PBC_KEY = 'payroll_engine'
PERMISSIONS = ('payroll_engine.read', 'payroll_engine.create', 'payroll_engine.update', 'payroll_engine.approve', 'payroll_engine.admin')
ACTION_PERMISSIONS = {
