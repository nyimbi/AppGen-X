"""Idempotent event handlers for the payroll_engine PBC."""

HANDLER_CONTRACTS = ({'event_type': 'LaborHoursApproved', 'function': 'handle_labor_hours_approved', 'idempotency_key': 'payroll_engine:LaborHoursApproved:{event_id}', 'retry_policy': {'name': 'payroll_engine_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'payroll_engine_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'TaxCalculated', 'function': 'handle_tax_calculated', 'idempotency_key': 'payroll_engine:TaxCalculated:{event_id}', 'retry_policy': {'name': 'payroll_engine_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'payroll_engine_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
