...
from .services import PayrollEngineService
...
ROUTES = tuple(_route_to_route(route) for route in payroll_engine_build_api_contract()["routes"])
API_ROUTE_CONTRACTS = tuple(_route_to_contract(route) for route in payroll_engine_build_api_contract()["routes"])
