# Release Evidence - Telecom Subscription Lifecycle

Package directory: `pbcs/telecom_subscription_lifecycle`.
...
- Owned datastore boundary: every owned table starts with `telecom_subscription_lifecycle_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
