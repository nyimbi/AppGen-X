"""AppGen-X event contracts for the expense_management PBC."""
PBC_KEY = 'expense_management'
EMITTED = ('ExpenseApproved', 'ExpenseRejected', 'ReimbursementPrepared', 'ExpenseFraudFlagged')
CONSUMED = ('EmployeeProvisioned', 'PaymentCaptured', 'AccessPolicyChanged')
