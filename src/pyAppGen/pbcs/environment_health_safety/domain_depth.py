...
DOMAIN_PURPOSE = 'EHS incidents, inspections, permits, hazards, corrective actions, training, audits, and compliance evidence'
DOMAIN_OWNED_TABLES = ('environment_health_safety_ehs_incident',
...
DOMAIN_OPERATIONS = ('create_ehs_incident',
 'record_hazard',
 'review_inspection',
 'approve_permit',
 'simulate_corrective_action',
 'create_safety_training',
 'record_audit_finding',
 'review_environment_health_safety_policy_rule',
 'approve_environment_health_safety_runtime_parameter',
 'simulate_environment_health_safety_schema_extension',
 'create_environment_health_safety_control_assertion',
 'record_environment_health_safety_governed_model',
 'operate_environment_health_safety_13',
 'operate_environment_health_safety_14',
 'operate_environment_health_safety_15',
 'operate_environment_health_safety_16',
 'operate_environment_health_safety_17',
 'operate_environment_health_safety_18')
DOMAIN_RULES = ('ehs_incident_policy',
 'hazard_policy',
 'inspection_policy',
 'permit_policy',
 'corrective_action_policy',
 'safety_training_policy')
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('EnvironmentHealthSafetyCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('environment health safety event sourced operational history',
 'environment health safety multi tenant policy isolation',
 'environment health safety schema evolution resilience',
 'environment health safety autonomous anomaly detection',
 'environment health safety semantic document instruction understanding',
 'environment health safety predictive risk scoring')
DOMAIN_WORKBENCH_VIEWS = ('ehs incident board',
 'hazard board',
 'inspection board',
 'permit board',
 'corrective action board',
 'safety training board',
 'audit finding board')
