from .runtime import environment_health_safety_runtime_capabilities
...
def table_stakes_capability_manifest():
    ...
    return {"ok": True, "pbc": runtime["pbc"], "standard_features": runtime["standard_features"], "advanced_capabilities": runtime["capabilities"], "operations": DOMAIN_OPERATIONS, "owned_tables": DOMAIN_OWNED_TABLES, "event_contract": "AppGen-X", "stream_picker_visible": False, "database_backends": runtime["database_backends"], "side_effects": ()}
