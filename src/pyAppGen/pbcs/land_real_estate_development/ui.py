...
def land_real_estate_development_ui_contract():
    surface = domain_capability_surface_contract()
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('LandRealEstateDevelopmentWorkbench',
 'LandRealEstateDevelopmentDetail',
 'LandRealEstateDevelopmentAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('land_real_estate_development.read',
 'land_real_estate_development.create',
 'land_real_estate_development.update',
 'land_real_estate_development.approve',
 'land_real_estate_development.admin'), 'full_capability_surface': {'operation_actions': DOMAIN_OPERATIONS, 'rule_editors': DOMAIN_RULES, 'parameter_editors': DOMAIN_PARAMETERS, 'advanced_panels': DOMAIN_ADVANCED_CAPABILITIES, 'table_browsers': DOMAIN_OWNED_TABLES, 'edge_case_queues': DOMAIN_EDGE_CASES, 'agent_tools': tuple(f'{PBC_KEY}_skills.{op}' for op in DOMAIN_OPERATIONS), 'navigation_sections': ('overview','operations','edge_case_triage','advanced_intelligence','release_evidence'), 'coverage': surface['coverage']}, 'side_effects': ()}

def land_real_estate_development_render_workbench():
    ui = land_real_estate_development_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': land_real_estate_development_ui_contract()['ok'] and land_real_estate_development_render_workbench()['ok'], 'side_effects': ()}
