# Release Evidence - Land and Real Estate Development

Package directory: `pbcs/land_real_estate_development`.
...
- Owned datastore boundary: every owned table starts with `land_real_estate_development_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
