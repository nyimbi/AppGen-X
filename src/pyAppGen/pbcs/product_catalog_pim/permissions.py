"""Executable permission contract for the product_catalog_pim PBC."""

PBC_KEY = 'product_catalog_pim'
PERMISSIONS = ('product_catalog_pim.read', 'product_catalog_pim.create', 'product_catalog_pim.update', 'product_catalog_pim.approve', 'product_catalog_pim.admin')
ACTION_PERMISSIONS = {
