"""Idempotent event handlers for the product_catalog_pim PBC."""

HANDLER_CONTRACTS = ({'event_type': 'TaxCalculated', 'function': 'handle_tax_calculated', 'idempotency_key': 'product_catalog_pim:TaxCalculated:{event_id}', 'retry_policy': {'name': 'product_catalog_pim_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'product_catalog_pim_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'},)
_PROCESSED_KEYS = set()
