...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'ui_contract': medical_device_lifecycle_ui_contract(), 'api_contract': medical_device_lifecycle_build_api_contract(), 'schema_contract': medical_device_lifecycle_build_schema_contract(), 'service_contract': medical_device_lifecycle_build_service_contract(), 'release_evidence_contract': medical_device_lifecycle_build_release_evidence(), 'permissions_contract': medical_device_lifecycle_permissions_contract(), 'owned_tables': MEDICAL_DEVICE_LIFECYCLE_OWNED_TABLES, 'runtime_tables': MEDICAL_DEVICE_LIFECYCLE_RUNTIME_TABLES, 'allowed_database_backends': MEDICAL_DEVICE_LIFECYCLE_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': MEDICAL_DEVICE_LIFECYCLE_REQUIRED_EVENT_TOPIC, 'emits': MEDICAL_DEVICE_LIFECYCLE_EMITTED_EVENT_TYPES, 'consumes': MEDICAL_DEVICE_LIFECYCLE_CONSUMED_EVENT_TYPES, 'boundary_contract': medical_device_lifecycle_verify_owned_table_boundary(MEDICAL_DEVICE_LIFECYCLE_OWNED_TABLES + ('api_dependency',))}
