...
_SUSTAINABILITY_ESG_REPORTING_BASE_BUILD_RELEASE_EVIDENCE = sustainability_esg_reporting_build_release_evidence
_SUSTAINABILITY_ESG_REPORTING_BASE_RUNTIME_CAPABILITIES = sustainability_esg_reporting_runtime_capabilities


def sustainability_esg_reporting_build_release_evidence():
    evidence = dict(_SUSTAINABILITY_ESG_REPORTING_BASE_BUILD_RELEASE_EVIDENCE())
    domain = sustainability_esg_reporting_domain_depth_contract()
...
def sustainability_esg_reporting_runtime_capabilities():
    runtime = dict(_SUSTAINABILITY_ESG_REPORTING_BASE_RUNTIME_CAPABILITIES())
    domain = sustainability_esg_reporting_domain_depth_contract()
    smoke = sustainability_esg_reporting_domain_depth_smoke_test()
    return {
        **runtime,
