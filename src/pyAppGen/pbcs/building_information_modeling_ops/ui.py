...
def building_information_modeling_ops_ui_contract():
    surface = domain_capability_surface_contract()
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('BuildingInformationModelingOpsWorkbench',
 'BuildingInformationModelingOpsDetail',
 'BuildingInformationModelingOpsAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('building_information_modeling_ops.read',
...
def building_information_modeling_ops_render_workbench():
    ui = building_information_modeling_ops_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': building_information_modeling_ops_ui_contract()['ok'] and building_information_modeling_ops_render_workbench()['ok'], 'side_effects': ()}
