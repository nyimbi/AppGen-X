"""Idempotent event handlers for the loyalty_rewards PBC."""

HANDLER_CONTRACTS = ({'event_type': 'PaymentCaptured', 'function': 'handle_payment_captured', 'idempotency_key': 'loyalty_rewards:PaymentCaptured:{event_id}', 'retry_policy': {'name': 'loyalty_rewards_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'loyalty_rewards_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'PromotionApplied', 'function': 'handle_promotion_applied', 'idempotency_key': 'loyalty_rewards:PromotionApplied:{event_id}', 'retry_policy': {'name': 'loyalty_rewards_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'loyalty_rewards_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
