...
def mining_operations_management_ui_contract():
    ...
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('MiningOperationsManagementWorkbench',
 'MiningOperationsManagementDetail',
 'MiningOperationsManagementAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('mining_operations_management.read',
...
def mining_operations_management_render_workbench():
    ui = mining_operations_management_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': mining_operations_management_ui_contract()['ok'] and mining_operations_management_render_workbench()['ok'], 'side_effects': ()}
