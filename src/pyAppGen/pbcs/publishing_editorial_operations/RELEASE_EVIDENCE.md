# Release Evidence - Publishing Editorial Operations

Package directory: `pbcs/publishing_editorial_operations`.
...
- Owned datastore boundary: every owned table starts with `publishing_editorial_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
