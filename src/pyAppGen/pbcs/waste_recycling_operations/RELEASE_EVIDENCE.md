# Release Evidence - Waste and Recycling Operations

Package directory: `pbcs/waste_recycling_operations`.
...
- Owned datastore boundary: every owned table starts with `waste_recycling_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
