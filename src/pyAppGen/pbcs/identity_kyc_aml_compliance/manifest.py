"""Package manifest for the identity_kyc_aml_compliance PBC."""

PBC_MANIFEST = {'advanced_capabilities': ('identity_kyc_aml_compliance_event_sourced_operational_history',
 ...
 'capabilities': ('kyc_profile_management',
                  ...
                  'identity_kyc_aml_compliance_cross_pbc_event_federation',
                  'identity_kyc_aml_compliance_governed_ai_agent_execution'),
 'configuration': ('IDENTITY_KYC_AML_COMPLIANCE_DATABASE_URL',
 ...
 'description': 'Customer onboarding, identity proofing, beneficial ownership, screening, '
                'transaction monitoring, suspicious activity, and compliance cases',
 'docs': ('SPECIFICATION.md', 'RELEASE_EVIDENCE.md'),
 'emits': ('IdentityKycAmlComplianceCreated',
 ...
 'standard_features': ('kyc_profile_management',
                       'identity_kyc_aml_compliance_workflow',
                       'identity_kyc_aml_compliance_analytics',
                       'configuration_schema',
                       'rule_engine',
 ...
 'ui_fragments': ('IdentityKycAmlComplianceWorkbench',
                  'IdentityKycAmlComplianceDetail',
                  'IdentityKycAmlComplianceAssistantPanel'),
 'version': '1.0.0',
 'workflows': ('identity_kyc_aml_compliance_create_kyc_profile_workflow',
               'identity_kyc_aml_compliance_record_identity_document_workflow')}
