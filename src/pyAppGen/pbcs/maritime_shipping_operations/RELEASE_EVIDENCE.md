# Release Evidence - Maritime Shipping Operations

Package directory: `pbcs/maritime_shipping_operations`.
...
- Owned datastore boundary: every owned table starts with `maritime_shipping_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
