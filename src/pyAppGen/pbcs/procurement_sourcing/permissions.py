"""Executable permission contract for the procurement_sourcing PBC."""

PBC_KEY = 'procurement_sourcing'
PERMISSIONS = ('procurement_sourcing.read', 'procurement_sourcing.create', 'procurement_sourcing.update', 'procurement_sourcing.approve', 'procurement_sourcing.admin')
ACTION_PERMISSIONS = {
