# Release Evidence - Provider Revenue Cycle

Package directory: `pbcs/provider_revenue_cycle`.
...
- Owned datastore boundary: every owned table starts with `provider_revenue_cycle_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
