"""Generated release evidence for the wms_core PBC."""
...
from . import ui
from .runtime import wms_core_build_release_evidence as _runtime_build_release_evidence
...
def build_release_evidence() -> dict:
    ...
    ui_manifest = ui.wms_core_ui_contract()
    model_manifest = models.model_manifest()
    repository_manifest = repository.wms_core_repository_contract()
    ...
    return {
        ...
        "runtime_smoke": wms_core_runtime_smoke(),
