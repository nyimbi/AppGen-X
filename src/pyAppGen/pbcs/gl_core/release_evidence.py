"""Generated release evidence for the gl_core PBC."""
...
from . import ui
from .runtime import gl_core_build_release_evidence as _runtime_build_release_evidence
...
def build_release_evidence() -> dict:
    ...
    ui_manifest = ui.gl_core_ui_contract()
    model_manifest = models.model_manifest()
    repository_manifest = repository.gl_core_repository_manifest()
    ...
    gate_results = {
        ...
        and repository_manifest["ok"],
        "pbc_generation_smoke_audit": gl_core_runtime_smoke()["ok"]
    ...
    return {
        "format": "appgen.gl-core-release-evidence.v2",
        ...
        "runtime_smoke": gl_core_runtime_smoke(),
...
def validate_release_evidence() -> dict:
    ...
    boundary_gaps = tuple(
        ...
        for gap, failed in (
            ...
            ("repository_out_of_boundary", any(table not in evidence["schema"].get("owned_tables", ()) for table in evidence["repository"].get("tables", ()))),
            (
