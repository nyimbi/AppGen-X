...
class GlCoreService:
    ...
    def query_trial_balance(self, payload=None):
        return self._query('query_trial_balance', payload or {})

    def query_chart_of_accounts(self, payload=None):
        return self._query('query_chart_of_accounts', payload or {})

    def query_ledger_events(self, payload=None):
        return self._query('query_ledger_events', payload or {})
    ...
    def query_temporal_ledger(self, payload=None):
        return self._query('query_temporal_ledger', payload or {})
