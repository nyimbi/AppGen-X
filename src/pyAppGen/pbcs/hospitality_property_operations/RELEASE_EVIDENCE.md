...
- Owned datastore boundary: every owned table starts with `hospitality_property_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
