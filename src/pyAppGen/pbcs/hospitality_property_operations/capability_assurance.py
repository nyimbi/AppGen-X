from .domain_depth import DOMAIN_OPERATIONS, DOMAIN_OWNED_TABLES, workflow_catalog
from .runtime import hospitality_property_operations_runtime_capabilities
...
def table_stakes_capability_manifest():
    ...
    return {
        ...
        "workflows": tuple(item["workflow"] for item in workflow_catalog()),
