"""Executable permission contract for the personnel_identity PBC."""

PBC_KEY = 'personnel_identity'
PERMISSIONS = ('personnel_identity.read', 'personnel_identity.create', 'personnel_identity.update', 'personnel_identity.approve', 'personnel_identity.admin')
ACTION_PERMISSIONS = {
