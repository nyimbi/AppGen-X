"""Service contract for the travel_management PBC."""


def build_service_contract():
    return {'format': 'appgen.travel-management-service-contract.v1', 'ok': True, 'pbc': 'travel_management', 'command_methods': ('command_travel_request', 'configure_runtime', 'set_parameter', 'register_rule'), 'query_methods': ('query_workbench',), 'shared_table_access': False, 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'}
