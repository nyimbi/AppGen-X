"""AppGen-X event contracts for the travel_management PBC."""
PBC_KEY = 'travel_management'
EMITTED = ('TravelApproved', 'TravelBooked', 'DutyOfCareAlerted', 'TravelExpenseHandedOff')
CONSUMED = ('EmployeeProvisioned', 'ExpenseApproved', 'SupplierQualified')
