# Travel Management Release Evidence

The package directory `pbcs/travel_management` contains the executable PBC implementation, manifest, schema, migrations, models, services, API routes, AppGen-X events, idempotent handlers, UI workbench fragments, permissions, configuration, rules, parameters, seed data, agent skills, chatbot contracts, and tests.

## Evidence

- Owned tables are under the `travel_management_` prefix and foreign datastore mutation is rejected.
