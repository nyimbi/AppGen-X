# Release Evidence - Mining Safety and Permits

Package directory: `pbcs/mining_safety_permits`.
...
- Owned datastore boundary: every owned table starts with `mining_safety_permits_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
