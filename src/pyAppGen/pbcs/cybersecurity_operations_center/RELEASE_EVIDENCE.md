# Release Evidence - Cybersecurity Operations Center

Package directory: `pbcs/cybersecurity_operations_center`.
...
- Owned datastore boundary: every owned table starts with `cybersecurity_operations_center_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
