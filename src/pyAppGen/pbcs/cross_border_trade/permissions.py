"""Executable permission contract for the cross_border_trade PBC."""

PBC_KEY = 'cross_border_trade'
PERMISSIONS = ('cross_border_trade.read', 'cross_border_trade.create', 'cross_border_trade.update', 'cross_border_trade.approve', 'cross_border_trade.admin')
ACTION_PERMISSIONS = {
