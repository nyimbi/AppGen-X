# Release Evidence - Humanitarian Relief Operations

Package directory: `pbcs/humanitarian_relief_operations`.
...
- Owned datastore boundary: every owned table starts with `humanitarian_relief_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
