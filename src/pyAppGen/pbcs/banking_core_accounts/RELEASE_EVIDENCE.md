...
Package directory: `pbcs/banking_core_accounts`.
...
- Owned datastore boundary: every owned table starts with `banking_core_accounts_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
