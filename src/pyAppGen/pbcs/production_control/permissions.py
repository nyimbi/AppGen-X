"""Executable permission contract for the production_control PBC."""

PBC_KEY = 'production_control'
PERMISSIONS = ('production_control.read', 'production_control.create', 'production_control.update', 'production_control.approve', 'production_control.admin')
ACTION_PERMISSIONS = {
