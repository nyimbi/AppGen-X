...
from .services import ProductionControlService, service_operation_contracts
...
API_ROUTE_CONTRACTS = ({'method': 'POST', 'path': '/api/pbc/production_control/production-orders', 'handler': 'command_production_orders', 'permission': 'production_control.command.1', 'operation': 'command_production_orders', 'operation_kind': 'command', 'owned_tables': ('production_control_work_center', 'production_control_production_order', 'production_control_routing_step', 'production_control_downtime_event'), 'read_tables': (), 'emitted_event': 'ProductionCompleted', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'production_control:command_production_orders:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False}, {'method': 'POST', 'path': '/api/pbc/production_control/downtime', 'handler': 'command_downtime', 'permission': 'production_control.command.2', 'operation': 'command_downtime', 'operation_kind': 'command', 'owned_tables': ('production_control_work_center', 'production_control_production_order', 'production_control_routing_step', 'production_control_downtime_event'), 'read_tables': (), 'emitted_event': 'AssetPlacedInService', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'production_control:command_downtime:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False}, {'method': 'GET', 'path': '/api/pbc/production_control/schedule', 'handler': 'query_schedule', 'permission': 'production_control.query.3', 'operation': 'query_schedule', 'operation_kind': 'query', 'owned_tables': (), 'read_tables': ('production_control_work_center', 'production_control_production_order', 'production_control_routing_step', 'production_control_downtime_event'), 'emitted_event': None, 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': False, 'idempotency_key': None, 'shared_table_access': False, 'stream_engine_picker_visible': False})
