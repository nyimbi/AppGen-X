# Release Evidence - Utilities Metering and Billing

Package directory: `pbcs/utilities_metering_billing`.
...
- Owned datastore boundary: every owned table starts with `utilities_metering_billing_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
