...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'ui_contract': utilities_metering_billing_ui_contract(), 'api_contract': utilities_metering_billing_build_api_contract(), 'schema_contract': utilities_metering_billing_build_schema_contract(), 'service_contract': utilities_metering_billing_build_service_contract(), 'release_evidence_contract': utilities_metering_billing_build_release_evidence(), 'permissions_contract': utilities_metering_billing_permissions_contract(), 'owned_tables': UTILITIES_METERING_BILLING_OWNED_TABLES, 'runtime_tables': UTILITIES_METERING_BILLING_RUNTIME_TABLES, 'allowed_database_backends': UTILITIES_METERING_BILLING_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': UTILITIES_METERING_BILLING_REQUIRED_EVENT_TOPIC, 'emits': UTILITIES_METERING_BILLING_EMITTED_EVENT_TYPES, 'consumes': UTILITIES_METERING_BILLING_CONSUMED_EVENT_TYPES, 'boundary_contract': utilities_metering_billing_verify_owned_table_boundary(UTILITIES_METERING_BILLING_OWNED_TABLES + ('api_dependency',)), 'standalone_app_contract': single_pbc_app_contract()}
