from pyAppGen.pbcs.field_service_management import implementation_contract, package_discovery_plan, package_metadata_manifest, validate_package_metadata
from pyAppGen.pbcs.field_service_management.schema_contract import build_schema_contract
from pyAppGen.pbcs.field_service_management.service_contract import build_service_contract
from pyAppGen.pbcs.field_service_management.release_evidence import build_release_evidence, release_readiness_manifest, validate_release_evidence
from pyAppGen.pbcs.field_service_management.events import event_contract_manifest, validate_event_contract
from pyAppGen.pbcs.field_service_management.handlers import dispatch_event, handler_manifest
from pyAppGen.pbcs.field_service_management.services import service_operation_contracts
...
def test_registration_plan_is_side_effect_free():
    assert package_metadata_manifest()['pbc'] == 'field_service_management'
