"""Service contract for the field_service_management PBC."""


def build_service_contract():
    return {'format': 'appgen.field-service-management-service-contract.v1', 'ok': True, 'pbc': 'field_service_management', 'command_methods': ('command_field_work_order', 'configure_runtime', 'set_parameter', 'register_rule'), 'query_methods': ('query_workbench',), 'shared_table_access': False, 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'}
