"""AppGen-X event contracts for the field_service_management PBC."""
PBC_KEY = 'field_service_management'
EMITTED = ('FieldWorkOrderCreated', 'TechnicianDispatched', 'FieldTaskCompleted', 'ServiceSlaBreached')
CONSUMED = ('ServiceTicketOpened', 'InventoryPositionUpdated', 'CustomerUpdated')
