"""Field Service Management PBC implementation package."""
...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'ui_contract': field_service_management_ui_contract(), 'api_contract': field_service_management_build_api_contract(), 'schema_contract': field_service_management_build_schema_contract(), 'service_contract': field_service_management_build_service_contract(), 'release_evidence_contract': field_service_management_build_release_evidence(), 'permissions_contract': field_service_management_permissions_contract(), 'owned_tables': FIELD_SERVICE_MANAGEMENT_OWNED_TABLES, 'runtime_tables': FIELD_SERVICE_MANAGEMENT_RUNTIME_TABLES, 'allowed_database_backends': FIELD_SERVICE_MANAGEMENT_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': FIELD_SERVICE_MANAGEMENT_REQUIRED_EVENT_TOPIC, 'emits': FIELD_SERVICE_MANAGEMENT_EMITTED_EVENT_TYPES, 'consumes': FIELD_SERVICE_MANAGEMENT_CONSUMED_EVENT_TYPES, 'boundary_contract': field_service_management_verify_owned_table_boundary(FIELD_SERVICE_MANAGEMENT_OWNED_TABLES + ('api_dependency',))}
...
def smoke_test() -> dict:
    ...
    runtime = field_service_management_runtime_smoke()
