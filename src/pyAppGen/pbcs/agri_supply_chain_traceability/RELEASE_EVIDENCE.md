# Release Evidence - Agriculture Supply Chain Traceability

Package directory: `pbcs/agri_supply_chain_traceability`.
...
- Owned datastore boundary: every owned table starts with `agri_supply_chain_traceability_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
