from pyAppGen.pbcs.agri_supply_chain_traceability import implementation_contract, package_discovery_plan, package_metadata_manifest, validate_package_metadata
...
from pyAppGen.pbcs.agri_supply_chain_traceability.release_evidence import build_release_evidence, release_readiness_manifest, validate_release_evidence
from pyAppGen.pbcs.agri_supply_chain_traceability.events import event_contract_manifest, validate_event_contract
from pyAppGen.pbcs.agri_supply_chain_traceability.handlers import dispatch_event, handler_manifest
from pyAppGen.pbcs.agri_supply_chain_traceability.services import service_operation_contracts
from pyAppGen.pbcs.agri_supply_chain_traceability.routes import api_route_contracts, validate_api_route_contracts
from pyAppGen.pbcs.agri_supply_chain_traceability.config import governance_smoke_test
from pyAppGen.pbcs.agri_supply_chain_traceability.agent import agent_skill_manifest, chatbot_interface_contract, document_instruction_plan, datastore_crud_plan
...
def test_manifest_and_event_contract():
    assert implementation_contract()['pbc'] == 'agri_supply_chain_traceability'
