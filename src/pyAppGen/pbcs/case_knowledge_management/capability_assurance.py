"""Package-local capability assurance for the case_knowledge_management PBC."""
from .manifest import PBC_MANIFEST
from .runtime import CASE_KNOWLEDGE_MANAGEMENT_ALLOWED_DATABASE_BACKENDS, case_knowledge_management_runtime_capabilities

PBC_KEY = 'case_knowledge_management'
STANDARD_FEATURE_OPERATION_COVERAGE = {'support_case_management': ('command_support_case',),
 'case_knowledge_management_workflow': ('command_support_case',),
 'case_knowledge_management_analytics': ('command_support_case',),
 'configuration_schema': ('command_support_case',),
 'rule_engine': ('command_support_case',),
 'parameter_engine': ('command_support_case',),
 'owned_schema_migrations_models': ('command_support_case',),
 'appgen_x_outbox_inbox_eventing': ('command_support_case',),
 'idempotent_handlers': ('command_support_case',),
 'retry_dead_letter_evidence': ('command_support_case',),
 'permissions': ('command_support_case',),
 'seed_data': ('command_support_case',),
 'workbench': ('command_support_case',),
 'agentic_document_instruction_intake': ('command_support_case',),
 'governed_datastore_crud': ('command_support_case',)}
ADVANCED_CAPABILITY_OPERATION_COVERAGE = {'case_knowledge_management_event_sourced_operational_history': ('run_advanced_assessment',),
 'case_knowledge_management_multi_tenant_policy_isolation': ('run_advanced_assessment',),
 'case_knowledge_management_schema_evolution_resilience': ('run_advanced_assessment',),
 'case_knowledge_management_autonomous_anomaly_detection': ('run_advanced_assessment',),
 'case_knowledge_management_semantic_document_instruction_understanding': ('run_advanced_assessment',),
 'case_knowledge_management_predictive_risk_scoring': ('run_advanced_assessment',),
 'case_knowledge_management_counterfactual_scenario_simulation': ('run_advanced_assessment',),
 'case_knowledge_management_cryptographic_audit_proofs': ('run_advanced_assessment',),
 'case_knowledge_management_continuous_control_testing': ('run_advanced_assessment',),
 'case_knowledge_management_carbon_and_sustainability_awareness': ('run_advanced_assessment',),
 'case_knowledge_management_cross_pbc_event_federation': ('run_advanced_assessment',),
 'case_knowledge_management_governed_ai_agent_execution': ('run_advanced_assessment',)}
