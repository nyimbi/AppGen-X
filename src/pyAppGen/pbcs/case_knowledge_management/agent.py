...
def agent_skill_manifest():
    skills = tuple({'name': name, 'scope': PBC_KEY, 'description': f'{name} for {PBC_KEY}', 'requires_confirmation_for_mutation': True, 'uses_appgen_event_contract': True, 'stream_engine_picker_visible': False} for name in ('case_knowledge_management_guide_user', 'case_knowledge_management_read_records', 'case_knowledge_management_create_record', 'case_knowledge_management_update_record'))
