"""AppGen-X event contracts for the case_knowledge_management PBC."""
PBC_KEY = 'case_knowledge_management'
EMITTED = ('KnowledgeArticlePublished', 'CaseDeflected', 'AgentAssistRecommended', 'ContentFreshnessFlagged')
