"""Package manifest for the aviation_maintenance_repair PBC."""

PBC_MANIFEST = {'advanced_capabilities': ('aviation_maintenance_repair_event_sourced_operational_history',
 ...
 'analytics': ('aviation_maintenance_repair_risk_score',
               'aviation_maintenance_repair_workbench_metric'),
 'apis': ('POST /aircrafts',
          'POST /components',
          'POST /work-cards',
 ...
 'capabilities': ('aircraft_management',
                  ...
                  'aviation_maintenance_repair_cross_pbc_event_federation',
                  'aviation_maintenance_repair_governed_ai_agent_execution'),
 'configuration': ('AVIATION_MAINTENANCE_REPAIR_DATABASE_URL',
 ...
 'description': 'Aircraft maintenance, components, work cards, compliance, airworthiness, deferred '
                'defects, and MRO operations',
 'docs': ('SPECIFICATION.md', 'RELEASE_EVIDENCE.md'),
 'emits': ('AviationMaintenanceRepairCreated',
 ...
 'standard_features': ('aircraft_management',
                       'aviation_maintenance_repair_workflow',
                       'aviation_maintenance_repair_analytics',
                       'configuration_schema',
                       'rule_engine',
 ...
 'ui_fragments': ('AviationMaintenanceRepairWorkbench',
                  'AviationMaintenanceRepairDetail',
                  'AviationMaintenanceRepairAssistantPanel'),
 'version': '1.0.0',
 'workflows': ('aviation_maintenance_repair_create_aircraft_workflow',
               'aviation_maintenance_repair_record_component_workflow')}
