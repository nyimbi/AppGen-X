...
def library_archives_management_runtime_capabilities() -> dict:
    runtime = dict(_appgen_release_runtime_module.library_archives_management_runtime_capabilities())
    ...
    runtime['implementation_directory'] = f'src/pyAppGen/pbcs/library_archives_management'
    runtime['pbc'] = 'library_archives_management'
    return runtime
