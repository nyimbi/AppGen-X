# Release Evidence - Library and Archives Management

Package directory: `pbcs/library_archives_management`.
...
- Owned datastore boundary: every owned table starts with `library_archives_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
