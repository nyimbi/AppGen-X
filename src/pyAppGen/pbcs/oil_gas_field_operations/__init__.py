...
from .runtime import *
from .ui import oil_gas_field_operations_ui_contract, oil_gas_field_operations_render_workbench
...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'ui_contract': oil_gas_field_operations_ui_contract(), 'api_contract': oil_gas_field_operations_build_api_contract(), 'schema_contract': oil_gas_field_operations_build_schema_contract(), 'service_contract': oil_gas_field_operations_build_service_contract(), 'release_evidence_contract': oil_gas_field_operations_build_release_evidence(), 'permissions_contract': oil_gas_field_operations_permissions_contract(), 'owned_tables': OIL_GAS_FIELD_OPERATIONS_OWNED_TABLES, 'runtime_tables': OIL_GAS_FIELD_OPERATIONS_RUNTIME_TABLES, 'allowed_database_backends': OIL_GAS_FIELD_OPERATIONS_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': OIL_GAS_FIELD_OPERATIONS_REQUIRED_EVENT_TOPIC, 'emits': OIL_GAS_FIELD_OPERATIONS_EMITTED_EVENT_TYPES, 'consumes': OIL_GAS_FIELD_OPERATIONS_CONSUMED_EVENT_TYPES, 'boundary_contract': oil_gas_field_operations_verify_owned_table_boundary(OIL_GAS_FIELD_OPERATIONS_OWNED_TABLES + ('api_dependency',))}
