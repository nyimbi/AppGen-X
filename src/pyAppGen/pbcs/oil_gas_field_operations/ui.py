...
def oil_gas_field_operations_ui_contract():
    ...
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('OilGasFieldOperationsWorkbench',
 'OilGasFieldOperationsDetail',
 'OilGasFieldOperationsAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('oil_gas_field_operations.read',
...
def oil_gas_field_operations_render_workbench():
    ui = oil_gas_field_operations_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': oil_gas_field_operations_ui_contract()['ok'] and oil_gas_field_operations_render_workbench()['ok'], 'side_effects': ()}
