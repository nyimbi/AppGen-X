...
# Improve1 field operations release evidence extension.
...
def build_release_evidence():
    ...
    evidence["field_operations_control"] = control
    evidence["traceability"] = tuple(dict.fromkeys(tuple(evidence.get("traceability", ())) + ("improve1_field_operations_control", "tests/test_domain_behavior.py")))
...
def release_readiness_manifest():
    ...
    manifest["field_operations_control"] = control
...
def validate_release_evidence():
    ...
    validation["field_operations_control"] = control
