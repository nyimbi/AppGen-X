...
def food_safety_quality_compliance_runtime_capabilities() -> dict:
    runtime = dict(_appgen_release_runtime_module.food_safety_quality_compliance_runtime_capabilities())
    ...
    runtime['implementation_directory'] = f'src/pyAppGen/pbcs/food_safety_quality_compliance'
    runtime['pbc'] = 'food_safety_quality_compliance'
    return runtime
