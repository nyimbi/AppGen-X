...
DOMAIN_ENTITY = 'haccp_plan'
DOMAIN_PURPOSE = 'HACCP plans, inspections, nonconformance, recalls, supplier audits, food quality, and regulatory evidence'
DOMAIN_OWNED_TABLES = ('food_safety_quality_compliance_haccp_plan',
...
DOMAIN_OPERATIONS = ('create_haccp_plan',
 'record_critical_control_point',
 'review_inspection',
 'approve_nonconformance',
 'simulate_recall_event',
 'create_supplier_audit',
 'record_quality_hold',
 'review_food_safety_quality_compliance_policy_rule',
 'approve_food_safety_quality_compliance_runtime_parameter',
 'simulate_food_safety_quality_compliance_schema_extension',
 'create_food_safety_quality_compliance_control_assertion',
 'record_food_safety_quality_compliance_governed_model',
 'operate_food_safety_quality_compliance_13',
 'operate_food_safety_quality_compliance_14',
 'operate_food_safety_quality_compliance_15',
 'operate_food_safety_quality_compliance_16',
 'operate_food_safety_quality_compliance_17',
 'operate_food_safety_quality_compliance_18')
DOMAIN_RULES = ('haccp_plan_policy',
...
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('FoodSafetyQualityComplianceCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('food safety quality compliance event sourced operational history',
 'food safety quality compliance multi tenant policy isolation',
 'food safety quality compliance schema evolution resilience',
 'food safety quality compliance autonomous anomaly detection',
 'food safety quality compliance semantic document instruction understanding',
 'food safety quality compliance predictive risk scoring')
DOMAIN_WORKBENCH_VIEWS = ('haccp plan board',
 'critical control point board',
 'inspection board',
 'nonconformance board',
 'recall event board',
 'supplier audit board',
 'quality hold board')
