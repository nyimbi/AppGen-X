...
# Audit trace key: 'defense_readiness_logistics'

PBC_MANIFEST = {'advanced_capabilities': ('defense_readiness_logistics_event_sourced_operational_history',
 ...
 'analytics': ('defense_readiness_logistics_risk_score',
               'defense_readiness_logistics_workbench_metric'),
 'apis': ('POST /unit-readinesss',
          'POST /mission-assets',
          'POST /supply-requests',
          'POST /maintenance-statuss',
          'POST /deployment-plans',
          'GET /defense-readiness-logistics-workbench'),
 'capabilities': ('unit_readiness_management',
                  ...
                  'defense_readiness_logistics_cross_pbc_event_federation',
                  'defense_readiness_logistics_governed_ai_agent_execution'),
 'configuration': ('DEFENSE_READINESS_LOGISTICS_DATABASE_URL',
 ...
 'description': 'Units, readiness, assets, maintenance, supply, mission planning, deployment, and '
                'defense logistics',
 'docs': ('SPECIFICATION.md', 'RELEASE_EVIDENCE.md', 'README.md', 'implementation-plan.md', 'implementation-status.md'),
 'emits': ('DefenseReadinessLogisticsCreated',
 ...
 'standard_features': ('unit_readiness_management',
                       'defense_readiness_logistics_workflow',
                       'defense_readiness_logistics_analytics',
                       'configuration_schema',
                       'rule_engine',
 ...
 'template': 'logistics',
 'tests': ('tests/test_contract.py', 'tests/test_defense_app.py'),
 'ui_fragments': ('DefenseReadinessLogisticsWorkbench',
                  'DefenseReadinessLogisticsDetail',
                  'DefenseReadinessLogisticsAssistantPanel'),
 'version': '1.0.0',
 'workflows': ('defense_readiness_logistics_create_unit_readiness_workflow',
