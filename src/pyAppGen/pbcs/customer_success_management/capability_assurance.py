...
from .runtime import CUSTOMER_SUCCESS_MANAGEMENT_ALLOWED_DATABASE_BACKENDS, customer_success_management_runtime_capabilities

PBC_KEY = 'customer_success_management'
STANDARD_FEATURE_OPERATION_COVERAGE = {'customer_success_account_management': ('command_customer_success_account',),
 'customer_success_management_workflow': ('command_customer_success_account',),
 'customer_success_management_analytics': ('command_customer_success_account',),
 'configuration_schema': ('command_customer_success_account',),
 'rule_engine': ('command_customer_success_account',),
 'parameter_engine': ('command_customer_success_account',),
 'owned_schema_migrations_models': ('command_customer_success_account',),
 'appgen_x_outbox_inbox_eventing': ('command_customer_success_account',),
 'idempotent_handlers': ('command_customer_success_account',),
 'retry_dead_letter_evidence': ('command_customer_success_account',),
 'permissions': ('command_customer_success_account',),
 'seed_data': ('command_customer_success_account',),
 'workbench': ('command_customer_success_account',),
 'agentic_document_instruction_intake': ('command_customer_success_account',),
 'governed_datastore_crud': ('command_customer_success_account',)}
ADVANCED_CAPABILITY_OPERATION_COVERAGE = {'customer_success_management_event_sourced_operational_history': ('run_advanced_assessment',),
 'customer_success_management_multi_tenant_policy_isolation': ('run_advanced_assessment',),
 'customer_success_management_schema_evolution_resilience': ('run_advanced_assessment',),
 'customer_success_management_autonomous_anomaly_detection': ('run_advanced_assessment',),
 'customer_success_management_semantic_document_instruction_understanding': ('run_advanced_assessment',),
 'customer_success_management_predictive_risk_scoring': ('run_advanced_assessment',),
 'customer_success_management_counterfactual_scenario_simulation': ('run_advanced_assessment',),
 'customer_success_management_cryptographic_audit_proofs': ('run_advanced_assessment',),
 'customer_success_management_continuous_control_testing': ('run_advanced_assessment',),
 'customer_success_management_carbon_and_sustainability_awareness': ('run_advanced_assessment',),
 'customer_success_management_cross_pbc_event_federation': ('run_advanced_assessment',),
 'customer_success_management_governed_ai_agent_execution': ('run_advanced_assessment',)}
