"""World-class domain depth contract for the renewables_asset_operations PBC."""
from __future__ import annotations
import hashlib

PBC_KEY = 'renewables_asset_operations'
DOMAIN_ENTITY = 'renewable_asset'
DOMAIN_PURPOSE = 'Solar and wind assets, generation, curtailment, maintenance, PPAs, availability, and renewable performance'
DOMAIN_OWNED_TABLES = ('renewables_asset_operations_renewable_asset',
 'renewables_asset_operations_generation_reading',
 'renewables_asset_operations_curtailment_event',
 'renewables_asset_operations_availability_record',
 'renewables_asset_operations_ppa_obligation',
 'renewables_asset_operations_maintenance_work',
 'renewables_asset_operations_performance_ratio',
 'renewables_asset_operations_renewables_asset_operations_policy_rule',
 'renewables_asset_operations_renewables_asset_operations_runtime_parameter',
 'renewables_asset_operations_renewables_asset_operations_schema_extension',
 'renewables_asset_operations_renewables_asset_operations_control_assertion',
 'renewables_asset_operations_renewables_asset_operations_governed_model',
 'renewables_asset_operations_appgen_outbox_event',
 'renewables_asset_operations_appgen_inbox_event',
 'renewables_asset_operations_appgen_dead_letter_event')
DOMAIN_OPERATIONS = ('create_renewable_asset',
 'record_generation_reading',
 'review_curtailment_event',
 'approve_availability_record',
 'simulate_ppa_obligation',
 'create_maintenance_work',
 'record_performance_ratio',
 'review_renewables_asset_operations_policy_rule',
 'approve_renewables_asset_operations_runtime_parameter',
 'simulate_renewables_asset_operations_schema_extension',
 'create_renewables_asset_operations_control_assertion',
 'record_renewables_asset_operations_governed_model',
 'operate_renewables_asset_operations_13',
 'operate_renewables_asset_operations_14',
 'operate_renewables_asset_operations_15',
 'operate_renewables_asset_operations_16',
 'operate_renewables_asset_operations_17',
 'operate_renewables_asset_operations_18')
DOMAIN_RULES = ('renewable_asset_policy',
 'generation_reading_policy',
 'curtailment_event_policy',
 'availability_record_policy',
 'ppa_obligation_policy',
 'maintenance_work_policy')
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('RenewablesAssetOperationsCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('renewables asset operations event sourced operational history',
 'renewables asset operations multi tenant policy isolation',
 'renewables asset operations schema evolution resilience',
 'renewables asset operations autonomous anomaly detection',
 'renewables asset operations semantic document instruction understanding',
 'renewables asset operations predictive risk scoring')
DOMAIN_WORKBENCH_VIEWS = ('renewable asset board',
 'generation reading board',
 'curtailment event board',
 'availability record board',
 'ppa obligation board',
 'maintenance work board',
 'performance ratio board')
