# Release Evidence - Renewables Asset Operations

Package directory: `pbcs/renewables_asset_operations`.
...
- Owned datastore boundary: every owned table starts with `renewables_asset_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
