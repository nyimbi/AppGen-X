# Release Evidence - Pharmacy Benefits Management

Package directory: `pbcs/pharmacy_benefits_management`.
...
- Owned datastore boundary: every owned table starts with `pharmacy_benefits_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
