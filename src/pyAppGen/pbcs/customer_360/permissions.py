"""Executable permission contract for the customer_360 PBC."""

PBC_KEY = 'customer_360'
PERMISSIONS = ('customer_360.read', 'customer_360.create', 'customer_360.update', 'customer_360.approve', 'customer_360.admin')
ACTION_PERMISSIONS = {
