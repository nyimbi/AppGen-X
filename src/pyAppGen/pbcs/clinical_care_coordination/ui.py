...
def clinical_care_coordination_ui_contract():
 ...
 'ClinicalCareCoordinationAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('clinical_care_coordination.read',
