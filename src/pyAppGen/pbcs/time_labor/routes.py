...
ROUTES = tuple(_route_to_route(route) for route in time_labor_build_api_contract()["routes"])
API_ROUTE_CONTRACTS = tuple(_route_to_contract(route) for route in time_labor_build_api_contract()["routes"])
