"""Idempotent event handlers for the lead_opportunity PBC."""

HANDLER_CONTRACTS = ({'event_type': 'CustomerSegmentUpdated', 'function': 'handle_customer_segment_updated', 'idempotency_key': 'lead_opportunity:CustomerSegmentUpdated:{event_id}', 'retry_policy': {'name': 'lead_opportunity_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'lead_opportunity_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'},)
_PROCESSED_KEYS = set()
