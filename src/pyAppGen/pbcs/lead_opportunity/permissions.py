"""Executable permission contract for the lead_opportunity PBC."""

PBC_KEY = 'lead_opportunity'
PERMISSIONS = ('lead_opportunity.read', 'lead_opportunity.create', 'lead_opportunity.update', 'lead_opportunity.approve', 'lead_opportunity.admin')
ACTION_PERMISSIONS = {
