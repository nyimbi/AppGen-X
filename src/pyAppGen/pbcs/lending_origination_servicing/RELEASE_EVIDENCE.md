# Release Evidence - Lending Origination and Servicing

Package directory: `pbcs/lending_origination_servicing`.
...
- Owned datastore boundary: every owned table starts with `lending_origination_servicing_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
