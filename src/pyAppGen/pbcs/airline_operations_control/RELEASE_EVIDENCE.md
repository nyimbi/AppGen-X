...
Package directory: `pbcs/airline_operations_control`.
...
- Owned datastore boundary: every owned table starts with `airline_operations_control_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
