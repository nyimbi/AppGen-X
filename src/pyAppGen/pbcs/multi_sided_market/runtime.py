...
def multi_sided_market_runtime_capabilities():
    operations = (
        ...
        'command_market_escrow_release_policies',
        'release_escrow',
        'command_market_escrow_releases',
        'prepare_settlement',
        'command_market_settlements',
        'record_reputation_signal',
        'command_market_reputation_signals',
        'open_dispute',
        'command_market_disputes',
        'resolve_dispute',
        'command_market_dispute_resolutions',
        'publish_market_clearing_projection',
        'command_market_clearing_projections',
        'score_reputation',
        'optimize_exchange_match',
        'query_exchange_match',
        'simulate_counterfactual_terms',
        'query_counterfactual_terms',
        'parse_market_instruction',
        'detect_collusion_anomaly',
        'query_collusion_anomaly',
        'generate_reputation_proof',
        'query_reputation_proof',
        'select_carbon_fulfillment',
        'query_carbon_fulfillment',
        'register_rule',
        'set_parameter',
        'configure_runtime',
        'receive_event',
