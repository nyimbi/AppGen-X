...
def education_student_lifecycle_ui_contract():
    ...
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('EducationStudentLifecycleWorkbench',
 'EducationStudentLifecycleDetail',
 'EducationStudentLifecycleAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('education_student_lifecycle.read',
...
def education_student_lifecycle_render_workbench():
    ui = education_student_lifecycle_ui_contract(); full = ui['full_capability_surface']
