"""Executable permission contract for the treasury_cash PBC."""

PBC_KEY = 'treasury_cash'
PERMISSIONS = ('treasury_cash.read', 'treasury_cash.create', 'treasury_cash.update', 'treasury_cash.approve', 'treasury_cash.admin')
ACTION_PERMISSIONS = {
