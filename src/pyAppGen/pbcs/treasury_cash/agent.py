"""AI agent and chatbot skill contract for the treasury_cash PBC."""
...
from .ui import treasury_cash_single_pbc_app_contract


PBC_KEY = "treasury_cash"
AGENT_NAME = "TreasuryCashAgent"
...
_SKILL_NAMES = (
    ...
    f"{PBC_KEY}.liquidity_planning",
    f"{PBC_KEY}.bank_statement_triage",
    f"{PBC_KEY}.counterparty_risk_review",
    f"{PBC_KEY}.capital_actions_assistant",
)
...
def agent_skill_manifest():
    ...
    single_app = treasury_cash_single_pbc_app_contract()
    return {
        ...
        "skills": tuple(
            {
                ...
                "execution_operations": _EXECUTION_OPERATIONS,
        ...
        "execution_operations": _EXECUTION_OPERATIONS,
        "single_pbc_app": {
            "assistant_panel": single_app["assistant_panel"],
            "workbench_route": single_app["workbench_route"],
        },
        "side_effects": (),
    }
...
def chatbot_interface_contract():
    ...
    return {
        ...
        "capabilities": (
            ...
            "liquidity_planning",
            "bank_statement_triage",
            "capital_actions_assistance",
        ),
