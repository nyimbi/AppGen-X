"""AppGen-X event contracts for the legal_matter_management PBC."""
PBC_KEY = 'legal_matter_management'
EMITTED = ('LegalMatterOpened', 'LegalHoldIssued', 'MatterBudgetApproved', 'CounselInvoiceReviewed')
CONSUMED = ('ContractApproved', 'InvoiceApproved', 'RiskAssessed')
