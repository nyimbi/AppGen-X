"""Agent and chatbot assistance for the legal_matter_management PBC."""
...
def agent_skill_manifest():
    skills = tuple({'name': name, 'scope': PBC_KEY, 'description': f'{name} for {PBC_KEY}', 'requires_confirmation_for_mutation': True, 'uses_appgen_event_contract': True, 'stream_engine_picker_visible': False} for name in ('legal_matter_management_guide_user', 'legal_matter_management_read_records', 'legal_matter_management_create_record', 'legal_matter_management_update_record'))
