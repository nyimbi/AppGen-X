...
from .domain_depth import domain_depth_contract as legal_matter_management_domain_depth_contract
from .domain_depth import domain_depth_smoke_test as legal_matter_management_domain_depth_smoke_test
from .domain_depth import execute_domain_operation as legal_matter_management_execute_domain_operation

_LEGAL_MATTER_MANAGEMENT_BASE_BUILD_RELEASE_EVIDENCE = legal_matter_management_build_release_evidence
_LEGAL_MATTER_MANAGEMENT_BASE_RUNTIME_CAPABILITIES = legal_matter_management_runtime_capabilities


def legal_matter_management_build_release_evidence():
    evidence = dict(_LEGAL_MATTER_MANAGEMENT_BASE_BUILD_RELEASE_EVIDENCE())
    domain = legal_matter_management_domain_depth_contract()
...
def legal_matter_management_runtime_capabilities():
    runtime = dict(_LEGAL_MATTER_MANAGEMENT_BASE_RUNTIME_CAPABILITIES())
    domain = legal_matter_management_domain_depth_contract()
    smoke = legal_matter_management_domain_depth_smoke_test()
    return {
        **runtime,
