"""Executable runtime contract for the airport_operations_management PBC."""
...
AIRPORT_OPERATIONS_MANAGEMENT_OWNED_TABLES = ('airport_operations_management_gate_assignment',
...
AIRPORT_OPERATIONS_MANAGEMENT_RUNTIME_TABLES = AIRPORT_OPERATIONS_MANAGEMENT_OWNED_TABLES
AIRPORT_OPERATIONS_MANAGEMENT_ALLOWED_DATABASE_BACKENDS = ('postgresql','mysql','mariadb')
AIRPORT_OPERATIONS_MANAGEMENT_REQUIRED_EVENT_TOPIC = 'pbc.airport_operations_management.events'
AIRPORT_OPERATIONS_MANAGEMENT_EMITTED_EVENT_TYPES = ('AirportOperationsManagementCreated',
 'AirportOperationsManagementUpdated',
 'AirportOperationsManagementApproved',
 'AirportOperationsManagementExceptionOpened')
AIRPORT_OPERATIONS_MANAGEMENT_CONSUMED_EVENT_TYPES = ('PolicyChanged', 'AuditEventSealed', 'OperationalKpiChanged')
AIRPORT_OPERATIONS_MANAGEMENT_STANDARD_FEATURE_KEYS = ('gate_assignment_management',
...
AIRPORT_OPERATIONS_MANAGEMENT_RUNTIME_CAPABILITY_KEYS = ('airport_operations_management_event_sourced_operational_history',
...
AIRPORT_OPERATIONS_MANAGEMENT_UI_FRAGMENT_KEYS = ('AirportOperationsManagementWorkbench',
 'AirportOperationsManagementDetail',
 'AirportOperationsManagementAssistantPanel')
AIRPORT_OPERATIONS_MANAGEMENT_BUSINESS_TABLES = ('airport_operations_management_gate_assignment',
 'airport_operations_management_stand_allocation',
 'airport_operations_management_slot',
 'airport_operations_management_turndown_task',
 'airport_operations_management_baggage_belt',
...
def airport_operations_management_empty_state():
...
def _event(state, event_type, payload):
    state['outbox'].append({'event_type': event_type, 'topic': AIRPORT_OPERATIONS_MANAGEMENT_REQUIRED_EVENT_TOPIC, 'payload': dict(payload), 'idempotency_key': _digest((event_type, payload))})

def airport_operations_management_configure_runtime(state, config):
    next_state = _copy(state)
    ok = config.get('database_backend') in AIRPORT_OPERATIONS_MANAGEMENT_ALLOWED_DATABASE_BACKENDS and config.get('event_topic', AIRPORT_OPERATIONS_MANAGEMENT_REQUIRED_EVENT_TOPIC) == AIRPORT_OPERATIONS_MANAGEMENT_REQUIRED_EVENT_TOPIC
    next_state['configuration'] = {'ok': ok, **dict(config), 'event_contract': 'AppGen-X', 'stream_engine_picker_visible': False}
    return {'ok': ok, 'state': next_state, 'configuration': next_state['configuration'], 'side_effects': ()}

def airport_operations_management_set_parameter(state, name, value):
...
def airport_operations_management_register_rule(state, rule):
...
def airport_operations_management_register_schema_extension(state, table, fields):
    next_state = _copy(state); owned_name = table if str(table).startswith(f'{PBC_KEY}_') else f'{PBC_KEY}_{table}'
    if owned_name not in AIRPORT_OPERATIONS_MANAGEMENT_OWNED_TABLES:
        return {'ok': False, 'state': next_state, 'reason': 'unknown_owned_table', 'side_effects': ()}
    next_state['schema_extensions'][owned_name] = dict(fields)
    return {'ok': True, 'state': next_state, 'table': owned_name, 'fields': dict(fields), 'side_effects': ()}

def airport_operations_management_receive_event(state, event):
    next_state = _copy(state); idem = event.get('idempotency_key') or event.get('event_id') or _digest(event)
    if idem in next_state['idempotency_keys']:
        return {'ok': True, 'duplicate': True, 'state': next_state, 'side_effects': ()}
    next_state['idempotency_keys'].add(idem)
    if event.get('event_type') not in AIRPORT_OPERATIONS_MANAGEMENT_CONSUMED_EVENT_TYPES:
...
def airport_operations_management_build_schema_contract():
    table_contracts = (
        {'table': 'airport_operations_management_gate_assignment', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_stand_allocation', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_slot', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_turndown_task', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_baggage_belt', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_passenger_flow', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_airport_disruption', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_airport_operations_management_policy_rule', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_airport_operations_management_runtime_parameter', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_airport_operations_management_schema_extension', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_airport_operations_management_control_assertion', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_airport_operations_management_governed_model', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_appgen_outbox_event', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_appgen_inbox_event', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
        {'table': 'airport_operations_management_appgen_dead_letter_event', 'fields': ('id','tenant','code','status','version','payload','created_at','updated_at'), 'primary_key': ('id',), 'owned_by': PBC_KEY},
    )
...
def airport_operations_management_verify_owned_table_boundary(references=()):
    ...
    return {'ok': not invalid, 'pbc': PBC_KEY, 'invalid_references': invalid, 'allowed_tables': AIRPORT_OPERATIONS_MANAGEMENT_OWNED_TABLES, 'shared_table_access': False}

def airport_operations_management_runtime_capabilities():
    domain = domain_depth_contract()
    smoke = airport_operations_management_runtime_smoke()
    operations = (
        'configure_runtime',
        'set_parameter',
        'register_rule',
    ...
    return {
        'format': 'appgen.airport-operations-management-runtime-capabilities.v1',
        'ok': smoke['ok'] and domain['ok'],
        'pbc': PBC_KEY,
        'implementation_directory': f'src/pyAppGen/pbcs/{PBC_KEY}',
        'owned_tables': AIRPORT_OPERATIONS_MANAGEMENT_OWNED_TABLES,
        'allowed_database_backends': AIRPORT_OPERATIONS_MANAGEMENT_ALLOWED_DATABASE_BACKENDS,
        'standard_features': AIRPORT_OPERATIONS_MANAGEMENT_STANDARD_FEATURE_KEYS,
        'capabilities': AIRPORT_OPERATIONS_MANAGEMENT_RUNTIME_CAPABILITY_KEYS,
        'operations': operations,
        'smoke': smoke,
        'world_class_domain_depth': domain,
        'database_backends': AIRPORT_OPERATIONS_MANAGEMENT_ALLOWED_DATABASE_BACKENDS,
        'event_contract': 'AppGen-X',
        'stream_engine_picker_visible': False,
        'side_effects': (),
    }

def airport_operations_management_runtime_smoke():
    state = airport_operations_management_empty_state()
    cfg = airport_operations_management_configure_runtime(state, {
        'database_backend': 'postgresql',
        'event_topic': AIRPORT_OPERATIONS_MANAGEMENT_REQUIRED_EVENT_TOPIC,
    })
    param = airport_operations_management_set_parameter(cfg['state'], 'workbench_limit', 50)
    rule = airport_operations_management_register_rule(param['state'], {'rule_id': 'smoke', 'scope': 'domain'})
    event = {'event_type': AIRPORT_OPERATIONS_MANAGEMENT_CONSUMED_EVENT_TYPES[0], 'idempotency_key': 'smoke'}
    received = airport_operations_management_receive_event(rule['state'], event)
    ...
    workbench = airport_operations_management_build_workbench_view()
    boundary = airport_operations_management_verify_owned_table_boundary(AIRPORT_OPERATIONS_MANAGEMENT_OWNED_TABLES + ('foreign_table',))
    domain = domain_depth_contract()
    checks = (
        ...
        {'id': 'command_gate_assignment', 'ok': command['ok']},
    ...
    return {
        'format': 'appgen.airport-operations-management-runtime-smoke.v1',
...
airport_operations_management_execute_domain_operation = execute_domain_operation
