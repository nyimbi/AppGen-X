# Release Evidence - Airport Operations Management

Package directory: `pbcs/airport_operations_management`.
...
- Owned datastore boundary: every owned table starts with `airport_operations_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
