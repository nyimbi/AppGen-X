...
- PBCs with runtime semantic improve1 tests: 147
- PBCs remaining runtime semantic improve1 tests: 0
...
## Runtime Semantic improve1 Tests
...
## Remaining Runtime Semantic Tests
...
- `1176dab5` added executable improve1 capability registries for all 147 PBCs.
- Current working batch adds runtime semantic tests for all 147 PBCs. Validation: `/Volumes/Media/src/pjs/appgen/.venv/bin/pytest` over all improve1 traceability, capability, and runtime semantic tests collected 877 tests and passed.

## Remaining Goal Work

- Matrix presence, path integrity, executable side-effect-free improve1 capability registries, and runtime semantic surface checks are complete for all PBCs.
- Remaining audit frontier: feature-by-feature business behavior depth beyond smoke surfaces, especially proving specialized domain commands and UI controls for each of the 7,350 improve1 features.
