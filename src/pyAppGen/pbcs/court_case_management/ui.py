...
def court_case_management_ui_contract():
    ...
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('CourtCaseManagementWorkbench', 'CourtCaseManagementDetail', 'CourtCaseManagementAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('court_case_management.read',
