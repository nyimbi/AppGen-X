...
PBC_MANIFEST = {'advanced_capabilities': ('court_case_management_event_sourced_operational_history',
 ...
 'apis': ('POST /court-cases',
          'POST /filings',
          'POST /hearings',
          'POST /docket-entrys',
          'POST /partys',
          'GET /court-case-management-workbench'),
 'capabilities': ('court_case_management',
                  ...
                  'court_case_management_cross_pbc_event_federation',
                  'court_case_management_governed_ai_agent_execution'),
 'configuration': ('COURT_CASE_MANAGEMENT_DATABASE_URL',
 ...
 'description': 'Filings, hearings, dockets, parties, judgments, orders, calendars, and court '
                'operations',
 'docs': ('SPECIFICATION.md', 'RELEASE_EVIDENCE.md'),
 'emits': ('CourtCaseManagementCreated',
 ...
 'ui_fragments': ('CourtCaseManagementWorkbench',
                  'CourtCaseManagementDetail',
                  'CourtCaseManagementAssistantPanel'),
 'version': '1.0.0',
 'workflows': ('court_case_management_create_court_case_workflow',
