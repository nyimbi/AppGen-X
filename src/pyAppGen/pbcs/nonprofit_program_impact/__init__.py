...
from .runtime import *
from .ui import nonprofit_program_impact_ui_contract, nonprofit_program_impact_render_workbench
...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'ui_contract': nonprofit_program_impact_ui_contract(), 'api_contract': nonprofit_program_impact_build_api_contract(), 'schema_contract': nonprofit_program_impact_build_schema_contract(), 'service_contract': nonprofit_program_impact_build_service_contract(), 'release_evidence_contract': nonprofit_program_impact_build_release_evidence(), 'permissions_contract': nonprofit_program_impact_permissions_contract(), 'owned_tables': NONPROFIT_PROGRAM_IMPACT_OWNED_TABLES, 'runtime_tables': NONPROFIT_PROGRAM_IMPACT_RUNTIME_TABLES, 'allowed_database_backends': NONPROFIT_PROGRAM_IMPACT_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': NONPROFIT_PROGRAM_IMPACT_REQUIRED_EVENT_TOPIC, 'emits': NONPROFIT_PROGRAM_IMPACT_EMITTED_EVENT_TYPES, 'consumes': NONPROFIT_PROGRAM_IMPACT_CONSUMED_EVENT_TYPES, 'boundary_contract': nonprofit_program_impact_verify_owned_table_boundary(NONPROFIT_PROGRAM_IMPACT_OWNED_TABLES + ('api_dependency',))}
