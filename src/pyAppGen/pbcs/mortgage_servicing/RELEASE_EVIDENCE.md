# Release Evidence - Mortgage Servicing

Package directory: `pbcs/mortgage_servicing`.
...
- Owned datastore boundary: every owned table starts with `mortgage_servicing_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
