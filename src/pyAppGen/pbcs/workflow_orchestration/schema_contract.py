...
SCHEMA_CONTRACT = {
    ...
    "migrations": (migration_path_for("workflow_definition"),),
    ...
    "declared_dependencies": {
        ...
        "events": ("InvoiceApproved", "OrderVerified", "ShipmentDelivered", "PaymentCaptured", "SchemaAccepted", "AccessPolicyChanged", "RoutePublished"),
        "shared_tables": (),
    },
}
