...
PERMISSIONS = ('workflow_orchestration.read', 'workflow_orchestration.create', 'workflow_orchestration.update', 'workflow_orchestration.approve', 'workflow_orchestration.admin')
ACTION_PERMISSIONS = {
