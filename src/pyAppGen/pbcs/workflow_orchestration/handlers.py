"""Idempotent event handlers for the workflow_orchestration PBC."""

HANDLER_CONTRACTS = ({'event_type': 'InvoiceApproved', 'function': 'handle_invoice_approved', 'idempotency_key': 'workflow_orchestration:InvoiceApproved:{event_id}', 'retry_policy': {'name': 'workflow_orchestration_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'workflow_orchestration_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'OrderVerified', 'function': 'handle_order_verified', 'idempotency_key': 'workflow_orchestration:OrderVerified:{event_id}', 'retry_policy': {'name': 'workflow_orchestration_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'workflow_orchestration_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'ShipmentDelivered', 'function': 'handle_shipment_delivered', 'idempotency_key': 'workflow_orchestration:ShipmentDelivered:{event_id}', 'retry_policy': {'name': 'workflow_orchestration_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'workflow_orchestration_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
