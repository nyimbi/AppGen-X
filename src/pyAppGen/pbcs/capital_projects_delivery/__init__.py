...
from .runtime import *
from .ui import capital_projects_delivery_ui_contract, capital_projects_delivery_render_workbench
...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'ui_contract': capital_projects_delivery_ui_contract(), 'api_contract': capital_projects_delivery_build_api_contract(), 'schema_contract': capital_projects_delivery_build_schema_contract(), 'service_contract': capital_projects_delivery_build_service_contract(), 'release_evidence_contract': capital_projects_delivery_build_release_evidence(), 'permissions_contract': capital_projects_delivery_permissions_contract(), 'owned_tables': CAPITAL_PROJECTS_DELIVERY_OWNED_TABLES, 'runtime_tables': CAPITAL_PROJECTS_DELIVERY_RUNTIME_TABLES, 'allowed_database_backends': CAPITAL_PROJECTS_DELIVERY_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': CAPITAL_PROJECTS_DELIVERY_REQUIRED_EVENT_TOPIC, 'emits': CAPITAL_PROJECTS_DELIVERY_EMITTED_EVENT_TYPES, 'consumes': CAPITAL_PROJECTS_DELIVERY_CONSUMED_EVENT_TYPES, 'boundary_contract': capital_projects_delivery_verify_owned_table_boundary(CAPITAL_PROJECTS_DELIVERY_OWNED_TABLES + ('api_dependency',))}
