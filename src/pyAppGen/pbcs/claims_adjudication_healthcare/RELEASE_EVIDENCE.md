...
Package directory: `pbcs/claims_adjudication_healthcare`.
...
- Owned datastore boundary: every owned table starts with `claims_adjudication_healthcare_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
