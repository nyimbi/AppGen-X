...
PBC_MANIFEST = {'advanced_capabilities': ('laboratory_information_management_event_sourced_operational_history',
 ...
 'analytics': ('laboratory_information_management_risk_score',
               'laboratory_information_management_workbench_metric'),
 'apis': ('POST /lab-samples',
          'POST /test-orders',
          'POST /instrument-runs',
          'POST /results',
          'POST /quality-controls',
          'GET /laboratory-information-management-workbench'),
 'capabilities': ('lab_sample_management',
                  ...
                  'laboratory_information_management_cross_pbc_event_federation',
                  'laboratory_information_management_governed_ai_agent_execution'),
 'configuration': ('LABORATORY_INFORMATION_MANAGEMENT_DATABASE_URL',
 ...
 'description': 'Samples, tests, instruments, results, quality control, chain of custody, and '
                'laboratory workflows',
 'docs': ('SPECIFICATION.md', 'RELEASE_EVIDENCE.md'),
 'emits': ('LaboratoryInformationManagementCreated',
 ...
 'permissions': ('laboratory_information_management.read',
 ...
 'ui_fragments': ('LaboratoryInformationManagementWorkbench',
                  'LaboratoryInformationManagementDetail',
                  'LaboratoryInformationManagementAssistantPanel'),
 'version': '1.0.0',
 'workflows': ('laboratory_information_management_create_lab_sample_workflow',
