...
ROUTES = (
    ...
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/price-agreements', 'handler': 'command_price_agreements', 'permission': 'price_promotion_engine.price.write'},
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/trade-promotion-plans', 'handler': 'command_trade_promotion_plans', 'permission': 'price_promotion_engine.promotion.write'},
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/price-exceptions', 'handler': 'command_price_exceptions', 'permission': 'price_promotion_engine.exception.write'},
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/promotion-accruals', 'handler': 'command_promotion_accruals', 'permission': 'price_promotion_engine.promotion.settle'},
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/promotion-settlements', 'handler': 'command_promotion_settlements', 'permission': 'price_promotion_engine.promotion.settle'},
...
API_ROUTE_CONTRACTS = API_ROUTE_CONTRACTS + (
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/price-agreements', 'handler': 'command_price_agreements', 'permission': 'price_promotion_engine.price.write', 'operation': 'command_price_agreements', 'operation_kind': 'command', 'owned_tables': ('price_promotion_engine_price_agreement', 'price_promotion_engine_price_audit_trace'), 'read_tables': (), 'emitted_event': 'PriceOptimized', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'price_promotion_engine:command_price_agreements:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False},
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/trade-promotion-plans', 'handler': 'command_trade_promotion_plans', 'permission': 'price_promotion_engine.promotion.write', 'operation': 'command_trade_promotion_plans', 'operation_kind': 'command', 'owned_tables': ('price_promotion_engine_trade_promotion_plan', 'price_promotion_engine_promotion', 'price_promotion_engine_campaign_budget', 'price_promotion_engine_price_audit_trace'), 'read_tables': (), 'emitted_event': 'TradePromotionPlanned', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'price_promotion_engine:command_trade_promotion_plans:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False},
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/price-exceptions', 'handler': 'command_price_exceptions', 'permission': 'price_promotion_engine.exception.write', 'operation': 'command_price_exceptions', 'operation_kind': 'command', 'owned_tables': ('price_promotion_engine_price_exception_case', 'price_promotion_engine_price_audit_trace', 'price_promotion_engine_price_performance_telemetry'), 'read_tables': (), 'emitted_event': 'PriceExceptionOpened', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'price_promotion_engine:command_price_exceptions:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False},
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/promotion-accruals', 'handler': 'command_promotion_accruals', 'permission': 'price_promotion_engine.promotion.settle', 'operation': 'command_promotion_accruals', 'operation_kind': 'command', 'owned_tables': ('price_promotion_engine_promotion_accrual', 'price_promotion_engine_promotion', 'price_promotion_engine_price_decision', 'price_promotion_engine_price_audit_trace'), 'read_tables': (), 'emitted_event': 'PromotionApplied', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'price_promotion_engine:command_promotion_accruals:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False},
    {'method': 'POST', 'path': '/api/pbc/price_promotion_engine/promotion-settlements', 'handler': 'command_promotion_settlements', 'permission': 'price_promotion_engine.promotion.settle', 'operation': 'command_promotion_settlements', 'operation_kind': 'command', 'owned_tables': ('price_promotion_engine_promotion_settlement', 'price_promotion_engine_promotion_accrual', 'price_promotion_engine_price_audit_trace'), 'read_tables': (), 'emitted_event': 'PromotionSettlementPosted', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'price_promotion_engine:command_promotion_settlements:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False},
)
