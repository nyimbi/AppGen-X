"""Executable permission contract for the price_promotion_engine PBC."""

PBC_KEY = 'price_promotion_engine'
PERMISSIONS = ('price_promotion_engine.read', 'price_promotion_engine.create', 'price_promotion_engine.update', 'price_promotion_engine.approve', 'price_promotion_engine.admin')
ACTION_PERMISSIONS = {
