# Release Evidence - Restaurant Operations

Package directory: `pbcs/restaurant_operations`.
...
- Owned datastore boundary: every owned table starts with `restaurant_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
