# Release Evidence - Music Royalties and Rights

Package directory: `pbcs/music_royalties_rights`.
...
- Owned datastore boundary: every owned table starts with `music_royalties_rights_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
