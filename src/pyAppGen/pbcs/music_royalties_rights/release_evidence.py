"""Release evidence for music_royalties_rights."""
from .controls import control_catalog
from .forms import form_catalog
from .runtime import music_royalties_rights_build_release_evidence
from .standalone import single_pbc_app_contract, standalone_smoke_test
from .wizards import wizard_catalog

def build_release_evidence():
    e=music_royalties_rights_build_release_evidence(); return {**e,"standalone_app":single_pbc_app_contract(),"forms":form_catalog(),"wizards":wizard_catalog(),"controls":control_catalog(),"traceability":("work_identity","contributors_chain_of_title","split_versioning","recording_linkage","license_terms","usage_ingestion","statement_traceability","recoupment_withholding","disputes","agent_preview"),"blocking_gaps":()}
...
# Improve1 music royalties release evidence extension.
...
def build_release_evidence():
    ...
    evidence["royalties_rights_control"] = control
    evidence["traceability"] = tuple(dict.fromkeys(tuple(evidence.get("traceability", ())) + ("improve1_royalties_rights_control", "tests/test_domain_behavior.py")))
...
def release_readiness_manifest():
    ...
    manifest["royalties_rights_control"] = control
...
def validate_release_evidence():
    ...
    validation["royalties_rights_control"] = control
