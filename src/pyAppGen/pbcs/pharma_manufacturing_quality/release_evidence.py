...
# Improve1 pharma quality release evidence extension.
...
def build_release_evidence():
    ...
    evidence["quality_control"] = control
    evidence["traceability"] = tuple(dict.fromkeys(tuple(evidence.get("traceability", ())) + ("improve1_quality_control", "tests/test_domain_behavior.py")))
...
def release_readiness_manifest():
    ...
    manifest["quality_control"] = control
...
def validate_release_evidence():
    ...
    validation["quality_control"] = control
