...
# Audit anchor: 'public_safety_dispatch'
...
PBC_MANIFEST = {
    ...
    "analytics": (
        "public_safety_dispatch_risk_score",
        "public_safety_dispatch_workbench_metric",
        "public_safety_dispatch_sla_watch",
        "public_safety_dispatch_mutual_aid_coverage_gap",
    ),
    "apis": (
        ...
        "POST /mutual-aids",
        "POST /response-milestones",
        "POST /case-dispositions",
        "POST /assistant/document-plan",
        "POST /assistant/crud-plan",
        "GET /public-safety-dispatch-workbench",
    ),
    "capabilities": (
        "emergency_call_management",
    ...
    "configuration": (
        "PUBLIC_SAFETY_DISPATCH_DATABASE_URL",
    ...
    "permissions": (
        "public_safety_dispatch.read",
        "public_safety_dispatch.create",
        "public_safety_dispatch.update",
        "public_safety_dispatch.approve",
        "public_safety_dispatch.admin",
        "public_safety_dispatch.operate",
        "public_safety_dispatch.dispatch",
        "public_safety_dispatch.audit",
    ),
