"""Idempotent event handlers for the predictive_demand PBC."""

HANDLER_CONTRACTS = ({'event_type': 'OperationalKpiChanged', 'function': 'handle_operational_kpi_changed', 'idempotency_key': 'predictive_demand:OperationalKpiChanged:{event_id}', 'retry_policy': {'name': 'predictive_demand_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'predictive_demand_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'OrderShipped', 'function': 'handle_order_shipped', 'idempotency_key': 'predictive_demand:OrderShipped:{event_id}', 'retry_policy': {'name': 'predictive_demand_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'predictive_demand_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'InventoryPoolChanged', 'function': 'handle_inventory_pool_changed', 'idempotency_key': 'predictive_demand:InventoryPoolChanged:{event_id}', 'retry_policy': {'name': 'predictive_demand_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'predictive_demand_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
