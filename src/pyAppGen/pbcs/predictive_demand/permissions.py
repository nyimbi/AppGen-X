"""Executable permission contract for the predictive_demand PBC."""

PBC_KEY = 'predictive_demand'
PERMISSIONS = ('predictive_demand.read', 'predictive_demand.create', 'predictive_demand.update', 'predictive_demand.approve', 'predictive_demand.admin')
ACTION_PERMISSIONS = {
