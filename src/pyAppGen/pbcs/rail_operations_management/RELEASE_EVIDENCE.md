# Release Evidence - Rail Operations Management

Package directory: `pbcs/rail_operations_management`.
...
- Owned datastore boundary: every owned table starts with `rail_operations_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
