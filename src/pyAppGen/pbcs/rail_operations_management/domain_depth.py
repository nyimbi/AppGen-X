...
DOMAIN_ENTITY = 'train_plan'
DOMAIN_PURPOSE = 'Train plans, consists, track windows, yards, crews, incidents, and rail service performance'
DOMAIN_OWNED_TABLES = ('rail_operations_management_train_plan',
...
DOMAIN_OPERATIONS = ('create_train_plan',
 'record_consist',
 'review_track_window',
 'approve_yard_move',
 'simulate_crew_assignment',
 'create_rail_incident',
 'record_service_performance',
 'review_rail_operations_management_policy_rule',
 'approve_rail_operations_management_runtime_parameter',
 'simulate_rail_operations_management_schema_extension',
 'create_rail_operations_management_control_assertion',
 'record_rail_operations_management_governed_model',
 'operate_rail_operations_management_13',
 'operate_rail_operations_management_14',
 'operate_rail_operations_management_15',
 'operate_rail_operations_management_16',
 'operate_rail_operations_management_17',
 'operate_rail_operations_management_18')
DOMAIN_RULES = ('train_plan_policy',
 'consist_policy',
 'track_window_policy',
 'yard_move_policy',
 'crew_assignment_policy',
 'rail_incident_policy')
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('RailOperationsManagementCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('rail operations management event sourced operational history',
 'rail operations management multi tenant policy isolation',
 'rail operations management schema evolution resilience',
 'rail operations management autonomous anomaly detection',
 'rail operations management semantic document instruction understanding',
 'rail operations management predictive risk scoring')
DOMAIN_WORKBENCH_VIEWS = ('train plan board',
 'consist board',
 'track window board',
 'yard move board',
