...
def smoke_test():
    ...
    emitted['table'] = f'{PBC_KEY}_appgen_outbox_event'
    emitted['retry_policy'] = {'max_attempts': 5}
    consumed['table'] = f'{PBC_KEY}_appgen_inbox_event'
    consumed['dead_letter_table'] = f'{PBC_KEY}_appgen_dead_letter_event'
