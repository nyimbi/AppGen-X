"""API route contracts for the rail_operations_management PBC."""

from __future__ import annotations

from .services import RailOperationsManagementService, service_operation_contracts
...
def validate_api_route_contracts() -> dict:
    ...
    invalid_table_scope = tuple(
        ...
        if not table.startswith('rail_operations_management_')
    )
    return {
...
def dispatch_route(method: str, path: str, payload: dict | None = None, *, service: RailOperationsManagementService | None = None) -> dict:
    ...
    service = service or RailOperationsManagementService()
...
def smoke_test() -> dict:
    ...
    dispatch_route(
        'POST',
        '/api/pbc/rail_operations_management/runtime/configuration',
        {'configuration': {'database_backend': 'postgresql', 'event_topic': 'pbc.rail_operations_management.events'}},
        service=service,
    )
    dispatched = dispatch_route(
        ...
        '/api/pbc/rail_operations_management/train-plans',
        {
            ...
            'train_id': 'ROM-101',
            'code': 'ROM-101',
            'published_departure_at': '2026-05-29T08:00:00+00:00',
            'working_departure_at': '2026-05-29T08:05:00+00:00',
            'control_departure_at': '2026-05-29T08:08:00+00:00',
            'line_id': 'mainline',
        },
        service=service,
    )
