"""Executable permission contract for the audit_ledger PBC."""

PBC_KEY = 'audit_ledger'
PERMISSIONS = ('audit_ledger.read', 'audit_ledger.create', 'audit_ledger.update', 'audit_ledger.approve', 'audit_ledger.admin')
ACTION_PERMISSIONS = {
