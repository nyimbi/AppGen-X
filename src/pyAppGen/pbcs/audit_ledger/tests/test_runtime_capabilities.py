"""Executable runtime capability proofs for the audit_ledger PBC."""
...
def test_configuration_rules_parameters_and_ui_are_executable():
    ...
    configured = _call(
        ...
        state,
        {
            ...
            "event_topic": getattr(runtime, "AUDIT_LEDGER_REQUIRED_EVENT_TOPIC"),
            "retry_limit": 3,
        },
    )
    parameter = _call("set_parameter", configured["state"], "retention_days", 2555)
