"""Generated contract smoke tests for audit_ledger."""
...
def test_manifest_and_event_contract():
    ...
    assert EVENT_CONTRACT['outbox_table'].startswith('audit_ledger_')
    assert EVENT_CONTRACT['inbox_table'].startswith('audit_ledger_')
...
def test_registration_plan_is_side_effect_free():
    ...
    assert register_pbc()['pbc'] == 'audit_ledger'
...
def test_event_handlers_are_idempotent_and_retryable():
    ...
    assert smoke['first_result']['dead_letter_table'].startswith('audit_ledger_')
