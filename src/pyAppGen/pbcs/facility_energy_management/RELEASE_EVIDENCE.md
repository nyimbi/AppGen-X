# Release Evidence - Facility Energy Management

Package directory: `pbcs/facility_energy_management`.
...
- Owned datastore boundary: every owned table starts with `facility_energy_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
