# Release Evidence - Telecom Network Operations

Package directory: `pbcs/telecom_network_operations`.
...
- Owned datastore boundary: every owned table starts with `telecom_network_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
