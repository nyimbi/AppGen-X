...
Package directory: `pbcs/advertising_campaign_operations`.
...
- Owned datastore boundary: every owned table starts with `advertising_campaign_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
