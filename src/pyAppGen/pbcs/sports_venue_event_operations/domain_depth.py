...
DOMAIN_ENTITY = 'venue_event'
DOMAIN_PURPOSE = 'Venue events, seating, concessions, security, staffing, fan experience, and event operations'
DOMAIN_OWNED_TABLES = ('sports_venue_event_operations_venue_event',
 'sports_venue_event_operations_seating_manifest',
 'sports_venue_event_operations_concession_plan',
 'sports_venue_event_operations_security_post',
 'sports_venue_event_operations_event_staff',
 'sports_venue_event_operations_fan_issue',
 'sports_venue_event_operations_event_settlement',
...
DOMAIN_OPERATIONS = ('create_venue_event',
 'record_seating_manifest',
 'review_concession_plan',
 'approve_security_post',
 'simulate_event_staff',
 'create_fan_issue',
 'record_event_settlement',
 'review_sports_venue_event_operations_policy_rule',
 'approve_sports_venue_event_operations_runtime_parameter',
 'simulate_sports_venue_event_operations_schema_extension',
 'create_sports_venue_event_operations_control_assertion',
 'record_sports_venue_event_operations_governed_model',
 'operate_sports_venue_event_operations_13',
 'operate_sports_venue_event_operations_14',
 'operate_sports_venue_event_operations_15',
 'operate_sports_venue_event_operations_16',
 'operate_sports_venue_event_operations_17',
 'operate_sports_venue_event_operations_18')
DOMAIN_RULES = ('venue_event_policy',
 'seating_manifest_policy',
 'concession_plan_policy',
 'security_post_policy',
 'event_staff_policy',
 'fan_issue_policy')
DOMAIN_PARAMETERS = ('quality_score_floor',
 ...
 'workbench_limit')
DOMAIN_EVENTS = ('SportsVenueEventOperationsCreated',
...
DOMAIN_ADVANCED_CAPABILITIES = ('sports venue event operations event sourced operational history',
...
DOMAIN_WORKBENCH_VIEWS = ('venue event board',
 'seating manifest board',
 'concession plan board',
 'security post board',
 'event staff board',
 'fan issue board',
 'event settlement board')
