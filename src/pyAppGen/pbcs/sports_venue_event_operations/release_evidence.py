...
# Improve1 sports venue event operations control release extension.
...
_SPORTS_CONTROL_BASE_BUILD_RELEASE_EVIDENCE = build_release_evidence
_SPORTS_CONTROL_BASE_VALIDATE_RELEASE_EVIDENCE = validate_release_evidence
...
def validate_release_evidence() -> dict:
    validation = dict(_SPORTS_CONTROL_BASE_VALIDATE_RELEASE_EVIDENCE())
    control = _improve1_sports_venue_event_operations_control_contract()
    validation["ok"] = validation.get("ok") is True and control["ok"]
    validation["sports_venue_event_operations_control"] = control
