...
def sports_venue_event_operations_ui_contract():
    ...
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('SportsVenueEventOperationsWorkbench',
 'SportsVenueEventOperationsDetail',
 'SportsVenueEventOperationsAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('sports_venue_event_operations.read',
...
def sports_venue_event_operations_render_workbench():
    ui = sports_venue_event_operations_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': sports_venue_event_operations_ui_contract()['ok'] and sports_venue_event_operations_render_workbench()['ok'], 'side_effects': ()}
