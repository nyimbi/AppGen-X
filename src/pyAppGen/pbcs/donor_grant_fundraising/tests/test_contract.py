from pyAppGen.pbcs.donor_grant_fundraising import implementation_contract, package_discovery_plan, package_metadata_manifest, validate_package_metadata
...
from pyAppGen.pbcs.donor_grant_fundraising.routes import api_route_contracts, validate_api_route_contracts
from pyAppGen.pbcs.donor_grant_fundraising.config import governance_smoke_test
from pyAppGen.pbcs.donor_grant_fundraising.agent import agent_skill_manifest, chatbot_interface_contract, document_instruction_plan, datastore_crud_plan
...
def test_manifest_and_event_contract():
    assert implementation_contract()['pbc'] == 'donor_grant_fundraising'
