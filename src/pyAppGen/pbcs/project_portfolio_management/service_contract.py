"""Service contract for the project_portfolio_management PBC."""


def build_service_contract():
    return {'format': 'appgen.project-portfolio-management-service-contract.v1', 'ok': True, 'pbc': 'project_portfolio_management', 'command_methods': ('command_portfolio', 'configure_runtime', 'set_parameter', 'register_rule'), 'query_methods': ('query_workbench',), 'shared_table_access': False, 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'}
