from pyAppGen.pbcs.gaming_casino_operations import implementation_contract, package_discovery_plan, package_metadata_manifest, validate_package_metadata
...
from pyAppGen.pbcs.gaming_casino_operations.routes import api_route_contracts, validate_api_route_contracts
...
def test_manifest_and_event_contract():
    assert implementation_contract()['pbc'] == 'gaming_casino_operations'
