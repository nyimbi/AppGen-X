"""Executable permission contract for the talent_onboarding PBC."""

PBC_KEY = 'talent_onboarding'
PERMISSIONS = ('talent_onboarding.read', 'talent_onboarding.create', 'talent_onboarding.update', 'talent_onboarding.approve', 'talent_onboarding.admin')
ACTION_PERMISSIONS = {
