...
Package directory: `pbcs/student_financial_aid`.
...
- Owned datastore boundary: every owned table starts with `student_financial_aid_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
