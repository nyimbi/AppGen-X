"""AppGen-X event contracts for the professional_services_automation PBC."""
PBC_KEY = 'professional_services_automation'
EMITTED = ('EngagementOpened', 'BillingMilestoneReady', 'UtilizationMeasured', 'EngagementMarginUpdated')
CONSUMED = ('ContractApproved', 'TimeSubmitted', 'InvoiceIssued')
