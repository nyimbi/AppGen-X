"""Agent and chatbot assistance for the professional_services_automation PBC."""
...
def agent_skill_manifest():
    skills = tuple({'name': name, 'scope': PBC_KEY, 'description': f'{name} for {PBC_KEY}', 'requires_confirmation_for_mutation': True, 'uses_appgen_event_contract': True, 'stream_engine_picker_visible': False} for name in ('professional_services_automation_guide_user', 'professional_services_automation_read_records', 'professional_services_automation_create_record', 'professional_services_automation_update_record'))
