"""Service layer for the professional_services_automation PBC."""
...
def service_operation_manifest():
    return {'ok': True, 'pbc': PBC_KEY, 'service_class': 'ProfessionalServicesAutomationService', 'command_operations': COMMAND_OPERATIONS, 'query_operations': QUERY_OPERATIONS, 'event_contract': EVENT_CONTRACT, 'side_effects': ()}
...
def smoke_test():
    service = ProfessionalServicesAutomationService()
...
_BaseProfessionalServicesAutomationService = ProfessionalServicesAutomationService

class ProfessionalServicesAutomationService(_BaseProfessionalServicesAutomationService):
    def __getattr__(self, name):
