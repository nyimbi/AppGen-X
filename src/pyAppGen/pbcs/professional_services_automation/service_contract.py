"""Service contract for the professional_services_automation PBC."""


def build_service_contract():
    return {'format': 'appgen.professional-services-automation-service-contract.v1', 'ok': True, 'pbc': 'professional_services_automation', 'command_methods': ('command_client_engagement', 'configure_runtime', 'set_parameter', 'register_rule'), 'query_methods': ('query_workbench',), 'shared_table_access': False, 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'}
