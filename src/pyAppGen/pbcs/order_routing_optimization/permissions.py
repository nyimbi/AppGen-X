"""Executable permission contract for the order_routing_optimization PBC."""

PBC_KEY = 'order_routing_optimization'
PERMISSIONS = ('order_routing_optimization.read', 'order_routing_optimization.create', 'order_routing_optimization.update', 'order_routing_optimization.approve', 'order_routing_optimization.admin')
ACTION_PERMISSIONS = {
