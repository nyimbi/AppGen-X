"""Executable runtime capability proofs for the order_routing_optimization PBC."""
...
def _configuration():
    return {
        ...
        "event_topic": getattr(runtime, "ORDER_ROUTING_OPTIMIZATION_REQUIRED_EVENT_TOPIC"),
        "retry_limit": 3,
        ...
        "topology_systems": ("dom", "inventory", "wms"),
        "workbench_limit": 50,
    }
...
def test_configuration_rules_parameters_and_ui_are_executable():
    ...
    parameter = _call("set_parameter", configured["state"], "cost_weight", 0.2)
