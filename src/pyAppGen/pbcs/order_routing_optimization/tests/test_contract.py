"""Generated contract smoke tests for order_routing_optimization."""
...
def test_generated_schema_service_and_release_evidence():
    ...
    assert SCHEMA_CONTRACT['pbc'] == 'order_routing_optimization'
    ...
    assert SERVICE_CONTRACT['pbc'] == 'order_routing_optimization'
    assert SERVICE_CONTRACT['ok'] is True
    assert SERVICE_CONTRACT.get('shared_table_access') is False
    assert RELEASE_EVIDENCE['pbc'] == 'order_routing_optimization'
...
def test_manifest_and_event_contract():
    ...
    assert PBC_MANIFEST['pbc'] == 'order_routing_optimization'
    ...
    assert EVENT_CONTRACT['outbox_table'].startswith('order_routing_optimization_')
    assert EVENT_CONTRACT['inbox_table'].startswith('order_routing_optimization_')
...
def test_registration_plan_is_side_effect_free():
    ...
    assert register_pbc()['pbc'] == 'order_routing_optimization'
...
def test_event_handlers_are_idempotent_and_retryable():
    ...
    assert smoke['first_result']['dead_letter_table'].startswith('order_routing_optimization_')
