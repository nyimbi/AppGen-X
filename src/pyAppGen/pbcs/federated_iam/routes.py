...
from .services import FederatedIamService, service_operation_contracts
...
API_ROUTE_CONTRACTS = ({'method': 'POST', 'path': '/api/pbc/federated_iam/tokens', 'handler': 'command_tokens', 'permission': 'federated_iam.command.1', 'operation': 'command_tokens', 'operation_kind': 'command', 'owned_tables': ('federated_iam_tenant', 'federated_iam_principal', 'federated_iam_access_policy', 'federated_iam_token_grant'), 'read_tables': (), 'emitted_event': 'AccessPolicyChanged', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'federated_iam:command_tokens:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False}, {'method': 'GET', 'path': '/api/pbc/federated_iam/principals', 'handler': 'query_principals', 'permission': 'federated_iam.query.2', 'operation': 'query_principals', 'operation_kind': 'query', 'owned_tables': (), 'read_tables': ('federated_iam_tenant', 'federated_iam_principal', 'federated_iam_access_policy', 'federated_iam_token_grant'), 'emitted_event': None, 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': False, 'idempotency_key': None, 'shared_table_access': False, 'stream_engine_picker_visible': False}, {'method': 'POST', 'path': '/api/pbc/federated_iam/policy-decisions', 'handler': 'command_policy_decisions', 'permission': 'federated_iam.command.3', 'operation': 'command_policy_decisions', 'operation_kind': 'command', 'owned_tables': ('federated_iam_tenant', 'federated_iam_principal', 'federated_iam_access_policy', 'federated_iam_token_grant'), 'read_tables': (), 'emitted_event': 'AccessPolicyChanged', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'federated_iam:command_policy_decisions:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False})
