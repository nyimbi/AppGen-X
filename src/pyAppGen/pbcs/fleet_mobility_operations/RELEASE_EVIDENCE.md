# Release Evidence - Fleet and Mobility Operations

Package directory: `pbcs/fleet_mobility_operations`.
...
- Owned datastore boundary: every owned table starts with `fleet_mobility_operations_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
