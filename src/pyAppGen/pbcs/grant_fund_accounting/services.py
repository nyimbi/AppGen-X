"""Service layer for the grant_fund_accounting PBC."""
...
def service_operation_manifest():
    return {'ok': True, 'pbc': PBC_KEY, 'service_class': 'GrantFundAccountingService', 'command_operations': COMMAND_OPERATIONS, 'query_operations': QUERY_OPERATIONS, 'event_contract': EVENT_CONTRACT, 'side_effects': ()}
...
def smoke_test():
    service = GrantFundAccountingService()
...
_BaseGrantFundAccountingService = GrantFundAccountingService

class GrantFundAccountingService(_BaseGrantFundAccountingService):
    def __getattr__(self, name):
