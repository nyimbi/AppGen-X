"""AppGen-X event contracts for the grant_fund_accounting PBC."""
PBC_KEY = 'grant_fund_accounting'
EMITTED = ('GrantAwarded', 'ReimbursementClaimPrepared', 'FundRestrictionApplied', 'GrantComplianceReported')
