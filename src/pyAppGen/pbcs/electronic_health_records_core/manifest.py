...
PBC_MANIFEST = {'advanced_capabilities': ('electronic_health_records_core_event_sourced_operational_history',
 ...
 'capabilities': ('patient_chart_management',
                  ...
                  'electronic_health_records_core_cross_pbc_event_federation',
                  'electronic_health_records_core_governed_ai_agent_execution'),
 'configuration': ('ELECTRONIC_HEALTH_RECORDS_CORE_DATABASE_URL',
 ...
 'description': 'Clinical encounters, orders, observations, allergies, medication lists, care '
                'notes, and patient summaries',
 'docs': ('SPECIFICATION.md', 'RELEASE_EVIDENCE.md'),
 'emits': ('ElectronicHealthRecordsCoreCreated',
 ...
 'standard_features': ('patient_chart_management',
                       'electronic_health_records_core_workflow',
                       'electronic_health_records_core_analytics',
                       'configuration_schema',
                       'rule_engine',
 ...
 'ui_fragments': ('ElectronicHealthRecordsCoreWorkbench',
                  'ElectronicHealthRecordsCoreDetail',
                  'ElectronicHealthRecordsCoreAssistantPanel'),
 'version': '1.0.0',
 'workflows': ('electronic_health_records_core_create_patient_chart_workflow',
               'electronic_health_records_core_record_clinical_encounter_workflow')}
