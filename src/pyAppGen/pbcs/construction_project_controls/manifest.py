...
PBC_MANIFEST = {'advanced_capabilities': ('construction_project_controls_event_sourced_operational_history',
 ...
 'analytics': ('construction_project_controls_risk_score',
               'construction_project_controls_workbench_metric'),
 'apis': ('POST /construction-projects',
          'POST /work-packages',
          'POST /rfis',
          'POST /submittals',
          'POST /site-progresss',
          'GET /construction-project-controls-workbench'),
 'capabilities': ('construction_project_management',
                  ...
                  'construction_project_controls_cross_pbc_event_federation',
                  'construction_project_controls_governed_ai_agent_execution'),
 'configuration': ('CONSTRUCTION_PROJECT_CONTROLS_DATABASE_URL',
 ...
 'description': 'Construction budgets, schedules, RFIs, submittals, change events, field progress, '
                'and site risk controls',
 'docs': ('SPECIFICATION.md', 'RELEASE_EVIDENCE.md'),
 'emits': ('ConstructionProjectControlsCreated',
 ...
 'permissions': ('construction_project_controls.read',
 ...
 'ui_fragments': ('ConstructionProjectControlsWorkbench',
                  'ConstructionProjectControlsDetail',
                  'ConstructionProjectControlsAssistantPanel'),
 'version': '1.0.0',
 'workflows': ('construction_project_controls_create_construction_project_workflow',
