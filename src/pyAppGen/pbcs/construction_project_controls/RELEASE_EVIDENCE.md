...
Package directory: `pbcs/construction_project_controls`.
...
- Owned datastore boundary: every owned table starts with `construction_project_controls_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
