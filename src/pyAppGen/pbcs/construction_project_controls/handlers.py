"""Event handlers for construction project controls."""
...
def dispatch_event(event, projection_state=None):
    ...
    next_state = deepcopy(projection_state or {})
    effect_map = {
    ...
    next_state["handled_effect"] = effect
    next_state["source_event_type"] = event["event_type"]
    return {
        "ok": True,
        "duplicate": False,
        "idempotency_key": idem,
