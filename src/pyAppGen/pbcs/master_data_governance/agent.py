"""Agent and chatbot assistance for the master_data_governance PBC."""
...
def agent_skill_manifest():
    skills = tuple({'name': name, 'scope': PBC_KEY, 'description': f'{name} for {PBC_KEY}', 'requires_confirmation_for_mutation': True, 'uses_appgen_event_contract': True, 'stream_engine_picker_visible': False} for name in ('master_data_governance_guide_user', 'master_data_governance_read_records', 'master_data_governance_create_record', 'master_data_governance_update_record'))
