"""AppGen-X event contracts for the master_data_governance PBC."""
PBC_KEY = 'master_data_governance'
EMITTED = ('GoldenRecordPublished', 'MergeDecisionApproved', 'StewardshipTaskOpened', 'MasterDataSynced')
CONSUMED = ('CustomerUpdated', 'SupplierQualified', 'ProductPublished')
