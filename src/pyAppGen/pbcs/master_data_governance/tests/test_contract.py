from pyAppGen.pbcs.master_data_governance import implementation_contract, package_discovery_plan, package_metadata_manifest, validate_package_metadata
...
from pyAppGen.pbcs.master_data_governance.release_evidence import build_release_evidence, release_readiness_manifest, validate_release_evidence
from pyAppGen.pbcs.master_data_governance.events import event_contract_manifest, validate_event_contract
from pyAppGen.pbcs.master_data_governance.handlers import dispatch_event, handler_manifest
from pyAppGen.pbcs.master_data_governance.services import service_operation_contracts
from pyAppGen.pbcs.master_data_governance.routes import api_route_contracts, validate_api_route_contracts
from pyAppGen.pbcs.master_data_governance.config import governance_smoke_test
from pyAppGen.pbcs.master_data_governance.agent import agent_skill_manifest, chatbot_interface_contract, document_instruction_plan, datastore_crud_plan
...
def test_event_handlers_are_idempotent_and_retryable():
    ...
    assert dispatch_event({'event_type': ('CustomerUpdated', 'SupplierQualified', 'ProductPublished')[0], 'idempotency_key': 'idem'})['ok'] is True
