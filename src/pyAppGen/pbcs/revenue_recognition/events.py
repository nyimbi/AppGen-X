"""AppGen-X event contracts for the revenue_recognition PBC."""
PBC_KEY = 'revenue_recognition'
EMITTED = ('RevenueRecognized', 'RevenueScheduleCreated', 'RecognitionPolicyChanged', 'ContractModificationAssessed')
CONSUMED = ('ContractApproved', 'InvoiceIssued', 'PaymentCaptured')
