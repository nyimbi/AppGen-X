"""Service contract for the revenue_recognition PBC."""


def build_service_contract():
    return {'format': 'appgen.revenue-recognition-service-contract.v1', 'ok': True, 'pbc': 'revenue_recognition', 'command_methods': ('command_revenue_contract', 'configure_runtime', 'set_parameter', 'register_rule'), 'query_methods': ('query_workbench',), 'shared_table_access': False, 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'}
