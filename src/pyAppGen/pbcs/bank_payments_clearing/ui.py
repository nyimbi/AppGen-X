...
def smoke_test():
    return {'ok': bank_payments_clearing_ui_contract()['ok'] and bank_payments_clearing_render_workbench()['ok'], 'side_effects': ()}
