...
Package directory: `pbcs/bank_payments_clearing`.
...
- Owned datastore boundary: every owned table starts with `bank_payments_clearing_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
