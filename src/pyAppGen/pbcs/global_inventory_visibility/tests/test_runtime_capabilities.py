"""Executable runtime capability proofs for the global_inventory_visibility PBC."""
...
def _configuration():
    return {
        ...
        "event_topic": getattr(runtime, "GLOBAL_INVENTORY_VISIBILITY_REQUIRED_EVENT_TOPIC"),
        "retry_limit": 3,
    }
