"""Idempotent event handlers for the global_inventory_visibility PBC."""

HANDLER_CONTRACTS = ({'event_type': 'GoodsReceiptPosted', 'function': 'handle_goods_receipt_posted', 'idempotency_key': 'global_inventory_visibility:GoodsReceiptPosted:{event_id}', 'retry_policy': {'name': 'global_inventory_visibility_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'global_inventory_visibility_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'ShipmentDelivered', 'function': 'handle_shipment_delivered', 'idempotency_key': 'global_inventory_visibility:ShipmentDelivered:{event_id}', 'retry_policy': {'name': 'global_inventory_visibility_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'global_inventory_visibility_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'InventoryAllocated', 'function': 'handle_inventory_allocated', 'idempotency_key': 'global_inventory_visibility:InventoryAllocated:{event_id}', 'retry_policy': {'name': 'global_inventory_visibility_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'global_inventory_visibility_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
