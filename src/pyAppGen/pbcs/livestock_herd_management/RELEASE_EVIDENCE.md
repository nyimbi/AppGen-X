# Release Evidence - Livestock Herd Management

Package directory: `pbcs/livestock_herd_management`.
...
- Owned datastore boundary: every owned table starts with `livestock_herd_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
