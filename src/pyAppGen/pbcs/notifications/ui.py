...
def notifications_ui_contract() -> dict:
    ...
    return {
        ...
        "panels": (
            ...
            {
                "key": "transactional",
                "fragment": "TransactionalNotificationConsole",
                "binds_to": ("transactional_notification", "message_delivery"),
                "commands": ("create_transactional_notification", "review_transactional_history"),
            },
            {
                "key": "simulation",
                "fragment": "ProviderRoutingConsole",
                "binds_to": ("delivery_channel", "provider_route", "throttle_window"),
                "commands": (
            ...
            {
                "key": "audit",
                "fragment": "NotificationAuditTrail",
                "binds_to": ("notification_audit_log",),
