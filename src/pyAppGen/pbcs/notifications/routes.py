...
from .services import NotificationsService, service_operation_contracts
...
API_ROUTE_CONTRACTS = ({'method': 'POST', 'path': '/api/pbc/notifications/messages', 'handler': 'command_messages', 'permission': 'notifications.command.1', 'operation': 'command_messages', 'operation_kind': 'command', 'owned_tables': ('notifications_notification_template', 'notifications_delivery_channel', 'notifications_message_delivery', 'notifications_preference_snapshot'), 'read_tables': (), 'emitted_event': 'MessageDelivered', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'notifications:command_messages:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False}, {'method': 'POST', 'path': '/api/pbc/notifications/templates', 'handler': 'command_templates', 'permission': 'notifications.command.2', 'operation': 'command_templates', 'operation_kind': 'command', 'owned_tables': ('notifications_notification_template', 'notifications_delivery_channel', 'notifications_message_delivery', 'notifications_preference_snapshot'), 'read_tables': (), 'emitted_event': 'MessageFailed', 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': True, 'idempotency_key': 'notifications:command_templates:idempotency_key', 'shared_table_access': False, 'stream_engine_picker_visible': False}, {'method': 'GET', 'path': '/api/pbc/notifications/delivery-status', 'handler': 'query_delivery_status', 'permission': 'notifications.query.3', 'operation': 'query_delivery_status', 'operation_kind': 'query', 'owned_tables': (), 'read_tables': ('notifications_notification_template', 'notifications_delivery_channel', 'notifications_message_delivery', 'notifications_preference_snapshot'), 'emitted_event': None, 'event_contract': 'AppGen-X', 'transaction_boundary': 'owned_datastore_plus_outbox', 'idempotency_required': False, 'idempotency_key': None, 'shared_table_access': False, 'stream_engine_picker_visible': False})
