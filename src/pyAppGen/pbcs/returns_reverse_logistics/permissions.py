"""Executable permission contract for the returns_reverse_logistics PBC."""

PBC_KEY = 'returns_reverse_logistics'
PERMISSIONS = ('returns_reverse_logistics.read', 'returns_reverse_logistics.create', 'returns_reverse_logistics.update', 'returns_reverse_logistics.approve', 'returns_reverse_logistics.admin')
ACTION_PERMISSIONS = {
