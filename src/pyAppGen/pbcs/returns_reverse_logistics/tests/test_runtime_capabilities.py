"""Executable runtime capability proofs for the returns_reverse_logistics PBC."""
...
def _configuration():
    return {
        ...
        "event_topic": getattr(runtime, "RETURNS_REVERSE_LOGISTICS_REQUIRED_EVENT_TOPIC"),
        "retry_limit": 3,
        "default_currency": "USD",
        "supported_carriers": ("parcel_green",),
        "supported_dispositions": ("resell", "repair", "recycle", "dispose"),
    }
