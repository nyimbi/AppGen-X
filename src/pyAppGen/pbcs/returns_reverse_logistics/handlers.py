"""Idempotent event handlers for the returns_reverse_logistics PBC."""

HANDLER_CONTRACTS = ({'event_type': 'OrderShipped', 'function': 'handle_order_shipped', 'idempotency_key': 'returns_reverse_logistics:OrderShipped:{event_id}', 'retry_policy': {'name': 'returns_reverse_logistics_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'returns_reverse_logistics_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'}, {'event_type': 'PaymentCaptured', 'function': 'handle_payment_captured', 'idempotency_key': 'returns_reverse_logistics:PaymentCaptured:{event_id}', 'retry_policy': {'name': 'returns_reverse_logistics_default_retry', 'max_attempts': 5, 'backoff': 'exponential'}, 'dead_letter_table': 'returns_reverse_logistics_appgen_dead_letter_event', 'side_effect_boundary': 'owned_tables_or_declared_api_calls'})
_PROCESSED_KEYS = set()
