"""Agent and chatbot assistance for the facilities_space_management PBC."""
...
def agent_skill_manifest():
    skills = tuple({'name': name, 'scope': PBC_KEY, 'description': f'{name} for {PBC_KEY}', 'requires_confirmation_for_mutation': True, 'uses_appgen_event_contract': True, 'stream_engine_picker_visible': False} for name in ('facilities_space_management_guide_user', 'facilities_space_management_read_records', 'facilities_space_management_create_record', 'facilities_space_management_update_record'))
