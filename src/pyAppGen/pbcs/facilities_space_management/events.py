"""AppGen-X event contracts for the facilities_space_management PBC."""
PBC_KEY = 'facilities_space_management'
EMITTED = ('SpaceReserved', 'OccupancyMeasured', 'SpacePlanApproved', 'FacilityMaintenanceLinked')
CONSUMED = ('EmployeeProvisioned', 'MaintenanceCompleted', 'LeaseContractApproved')
