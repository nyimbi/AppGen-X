"""Service contract for the facilities_space_management PBC."""


def build_service_contract():
    return {'format': 'appgen.facilities-space-management-service-contract.v1', 'ok': True, 'pbc': 'facilities_space_management', 'command_methods': ('command_facility_site', 'configure_runtime', 'set_parameter', 'register_rule'), 'query_methods': ('query_workbench',), 'shared_table_access': False, 'transaction_boundary': 'owned_datastore_plus_outbox', 'event_contract': 'AppGen-X'}
