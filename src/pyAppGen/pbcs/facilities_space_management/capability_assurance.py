"""Package-local capability assurance for the facilities_space_management PBC."""
from .manifest import PBC_MANIFEST
from .runtime import FACILITIES_SPACE_MANAGEMENT_ALLOWED_DATABASE_BACKENDS, facilities_space_management_runtime_capabilities

PBC_KEY = 'facilities_space_management'
STANDARD_FEATURE_OPERATION_COVERAGE = {'facility_site_management': ('command_facility_site',),
 'facilities_space_management_workflow': ('command_facility_site',),
 'facilities_space_management_analytics': ('command_facility_site',),
 'configuration_schema': ('command_facility_site',),
 'rule_engine': ('command_facility_site',),
 'parameter_engine': ('command_facility_site',),
 'owned_schema_migrations_models': ('command_facility_site',),
 'appgen_x_outbox_inbox_eventing': ('command_facility_site',),
 'idempotent_handlers': ('command_facility_site',),
 'retry_dead_letter_evidence': ('command_facility_site',),
 'permissions': ('command_facility_site',),
 'seed_data': ('command_facility_site',),
 'workbench': ('command_facility_site',),
 'agentic_document_instruction_intake': ('command_facility_site',),
 'governed_datastore_crud': ('command_facility_site',)}
ADVANCED_CAPABILITY_OPERATION_COVERAGE = {'facilities_space_management_event_sourced_operational_history': ('run_advanced_assessment',),
 'facilities_space_management_multi_tenant_policy_isolation': ('run_advanced_assessment',),
 'facilities_space_management_schema_evolution_resilience': ('run_advanced_assessment',),
 'facilities_space_management_autonomous_anomaly_detection': ('run_advanced_assessment',),
 'facilities_space_management_semantic_document_instruction_understanding': ('run_advanced_assessment',),
 'facilities_space_management_predictive_risk_scoring': ('run_advanced_assessment',),
 'facilities_space_management_counterfactual_scenario_simulation': ('run_advanced_assessment',),
 'facilities_space_management_cryptographic_audit_proofs': ('run_advanced_assessment',),
 'facilities_space_management_continuous_control_testing': ('run_advanced_assessment',),
 'facilities_space_management_carbon_and_sustainability_awareness': ('run_advanced_assessment',),
 'facilities_space_management_cross_pbc_event_federation': ('run_advanced_assessment',),
 'facilities_space_management_governed_ai_agent_execution': ('run_advanced_assessment',)}
