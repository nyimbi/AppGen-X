...
def construction_contracts_commercials_ui_contract():
    ...
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('ConstructionContractsCommercialsWorkbench',
 'ConstructionContractsCommercialsDetail',
 'ConstructionContractsCommercialsAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('construction_contracts_commercials.read',
...
def construction_contracts_commercials_render_workbench():
    ui = construction_contracts_commercials_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': construction_contracts_commercials_ui_contract()['ok'] and construction_contracts_commercials_render_workbench()['ok'], 'side_effects': ()}
