...
Package directory: `pbcs/construction_contracts_commercials`.
...
- Owned datastore boundary: every owned table starts with `construction_contracts_commercials_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
