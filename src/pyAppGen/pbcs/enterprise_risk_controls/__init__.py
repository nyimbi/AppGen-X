...
from .runtime import *
from .ui import enterprise_risk_controls_ui_contract, enterprise_risk_controls_render_workbench
...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'ui_contract': enterprise_risk_controls_ui_contract(), 'api_contract': enterprise_risk_controls_build_api_contract(), 'schema_contract': enterprise_risk_controls_build_schema_contract(), 'service_contract': enterprise_risk_controls_build_service_contract(), 'release_evidence_contract': enterprise_risk_controls_build_release_evidence(), 'permissions_contract': enterprise_risk_controls_permissions_contract(), 'owned_tables': ENTERPRISE_RISK_CONTROLS_OWNED_TABLES, 'runtime_tables': ENTERPRISE_RISK_CONTROLS_RUNTIME_TABLES, 'allowed_database_backends': ENTERPRISE_RISK_CONTROLS_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': ENTERPRISE_RISK_CONTROLS_REQUIRED_EVENT_TOPIC, 'emits': ENTERPRISE_RISK_CONTROLS_EMITTED_EVENT_TYPES, 'consumes': ENTERPRISE_RISK_CONTROLS_CONSUMED_EVENT_TYPES, 'boundary_contract': enterprise_risk_controls_verify_owned_table_boundary(ENTERPRISE_RISK_CONTROLS_OWNED_TABLES + ('api_dependency',))}
