...
Package directory: `pbcs/insurance_underwriting`.
...
- Owned datastore boundary: every owned table starts with `insurance_underwriting_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
