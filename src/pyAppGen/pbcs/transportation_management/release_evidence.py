"""Generated release evidence for the transportation_management PBC."""
...
from . import ui
from .runtime import transportation_management_build_release_evidence as _runtime_build_release_evidence
...
def build_release_evidence() -> dict:
    ...
    ui_manifest = ui.transportation_management_ui_contract()
    model_manifest = models.model_manifest()
    repository_manifest = repository.transportation_management_repository_contract()
    ...
    return {
        ...
        "runtime_smoke": transportation_management_runtime_smoke(),
...
def release_readiness_manifest() -> dict:
    ...
    sections = tuple(name for name in ("schema", "service", "api", "permissions", "events", "ui", "agent", "models", "repository") if isinstance(evidence.get(name), dict))
    return {
