"""Executable permission contract for the transportation_management PBC."""

PBC_KEY = 'transportation_management'
PERMISSIONS = ('transportation_management.read', 'transportation_management.create', 'transportation_management.update', 'transportation_management.approve', 'transportation_management.admin')
ACTION_PERMISSIONS = {
