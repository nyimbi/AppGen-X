# Release Evidence - Lease Lending and Equipment Finance

Package directory: `pbcs/lease_lending_equipment_finance`.
...
- Owned datastore boundary: every owned table starts with `lease_lending_equipment_finance_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
