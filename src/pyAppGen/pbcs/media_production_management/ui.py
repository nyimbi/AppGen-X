...
def media_production_management_ui_contract():
    ...
    return {'ok': True, 'pbc': PBC_KEY, 'fragments': ('MediaProductionManagementWorkbench',
 'MediaProductionManagementDetail',
 'MediaProductionManagementAssistantPanel'), 'configuration_editor': True, 'stream_engine_picker_visible': False, 'action_permissions': ('media_production_management.read',
...
def media_production_management_render_workbench():
    ui = media_production_management_ui_contract(); full = ui['full_capability_surface']
...
def smoke_test():
    return {'ok': media_production_management_ui_contract()['ok'] and media_production_management_render_workbench()['ok'], 'side_effects': ()}
