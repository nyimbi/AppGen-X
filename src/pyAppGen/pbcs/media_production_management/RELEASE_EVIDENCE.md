# Release Evidence - Media Production Management

Package directory: `pbcs/media_production_management`.
...
- Owned datastore boundary: every owned table starts with `media_production_management_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
