"""Generated contract smoke tests for fraud_anomaly_detection."""
...
def test_registration_plan_is_side_effect_free():
    ...
    assert register_pbc()['pbc'] == 'fraud_anomaly_detection'
...
def test_event_handlers_are_idempotent_and_retryable():
    ...
    assert smoke['first_result']['dead_letter_table'].startswith('fraud_anomaly_detection_')
