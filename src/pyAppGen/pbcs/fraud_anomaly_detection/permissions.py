"""Executable permission contract for the fraud_anomaly_detection PBC."""

PBC_KEY = 'fraud_anomaly_detection'
PERMISSIONS = ('fraud_anomaly_detection.read', 'fraud_anomaly_detection.create', 'fraud_anomaly_detection.update', 'fraud_anomaly_detection.approve', 'fraud_anomaly_detection.admin')
ACTION_PERMISSIONS = {
