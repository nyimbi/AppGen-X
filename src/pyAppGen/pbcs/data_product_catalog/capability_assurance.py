...
from .runtime import DATA_PRODUCT_CATALOG_ALLOWED_DATABASE_BACKENDS, data_product_catalog_runtime_capabilities

PBC_KEY = 'data_product_catalog'
STANDARD_FEATURE_OPERATION_COVERAGE = {'data_product_management': ('command_data_product',),
 'data_product_catalog_workflow': ('command_data_product',),
 'data_product_catalog_analytics': ('command_data_product',),
 'configuration_schema': ('command_data_product',),
 'rule_engine': ('command_data_product',),
 'parameter_engine': ('command_data_product',),
 'owned_schema_migrations_models': ('command_data_product',),
 'appgen_x_outbox_inbox_eventing': ('command_data_product',),
 'idempotent_handlers': ('command_data_product',),
 'retry_dead_letter_evidence': ('command_data_product',),
 'permissions': ('command_data_product',),
 'seed_data': ('command_data_product',),
 'workbench': ('command_data_product',),
 'agentic_document_instruction_intake': ('command_data_product',),
 'governed_datastore_crud': ('command_data_product',)}
ADVANCED_CAPABILITY_OPERATION_COVERAGE = {'data_product_catalog_event_sourced_operational_history': ('run_advanced_assessment',),
 'data_product_catalog_multi_tenant_policy_isolation': ('run_advanced_assessment',),
 'data_product_catalog_schema_evolution_resilience': ('run_advanced_assessment',),
 'data_product_catalog_autonomous_anomaly_detection': ('run_advanced_assessment',),
 'data_product_catalog_semantic_document_instruction_understanding': ('run_advanced_assessment',),
 'data_product_catalog_predictive_risk_scoring': ('run_advanced_assessment',),
 'data_product_catalog_counterfactual_scenario_simulation': ('run_advanced_assessment',),
 'data_product_catalog_cryptographic_audit_proofs': ('run_advanced_assessment',),
 'data_product_catalog_continuous_control_testing': ('run_advanced_assessment',),
 'data_product_catalog_carbon_and_sustainability_awareness': ('run_advanced_assessment',),
 'data_product_catalog_cross_pbc_event_federation': ('run_advanced_assessment',),
 'data_product_catalog_governed_ai_agent_execution': ('run_advanced_assessment',)}
