...
DOMAIN_ENTITY = "trade_position"
DOMAIN_PURPOSE = "Energy trade capture, nomination governance, market curve quality, exposure buckets, and settlement risk review"
DOMAIN_OWNED_TABLES = (
...
DOMAIN_OPERATIONS = (
    ...
    "run_mark_to_market",
    "calculate_net_exposure_buckets",
    "evaluate_limit_breaches",
    "review_curve_staleness",
    "classify_nomination_exception",
    "prepare_release_evidence",
)
DOMAIN_RULES = (
    "trade_capture_policy",
    "nomination_cutoff_policy",
    "price_curve_policy",
    "exposure_limit_policy",
    "settlement_policy",
    "assistant_mutation_policy",
)
DOMAIN_PARAMETERS = (
    "risk_threshold",
    "materiality_threshold",
    "curve_max_age_hours",
    "nomination_cutoff_hour_utc",
    "nomination_tolerance_mwh",
    "workbench_limit",
)
DOMAIN_EVENTS = (
...
DOMAIN_ADVANCED_CAPABILITIES = (
    "energy trading risk event sourced operational history",
...
DOMAIN_WORKBENCH_VIEWS = (
    "trade capture board",
    "risk bucket board",
    "nomination exception queue",
    "curve quality board",
    "settlement close board",
...
DOMAIN_EDGE_CASES = tuple(f"{operation}_edge_case" for operation in DOMAIN_OPERATIONS) + (
    "duplicate_trade_capture",
    "stale_market_curve",
    "limit_breach",
    "post_cutoff_nomination",
    "schedule_volume_conflict",
