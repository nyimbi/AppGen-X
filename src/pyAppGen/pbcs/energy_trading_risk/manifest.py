...
PBC_MANIFEST = {
    ...
    "configuration": (
        "ENERGY_TRADING_RISK_DATABASE_URL",
    ...
    "description": "Energy contracts, trade capture safety case, nominations, schedules, settlement, mark-to-market, exposure buckets, and risk limits",
    ...
    "template": "reporting",
    "tests": ("tests/test_contract.py", "tests/test_single_pbc_app.py"),
    "ui_fragments": (
    ...
    "version": "1.1.0",
    "workflows": (
        "energy_trading_risk_trade_capture_release_workflow",
        "energy_trading_risk_nomination_exception_recovery_workflow",
    ),
}
