"""Executable permission contract for the subscription_billing PBC."""

PBC_KEY = 'subscription_billing'
PERMISSIONS = ('subscription_billing.read', 'subscription_billing.create', 'subscription_billing.update', 'subscription_billing.approve', 'subscription_billing.admin')
ACTION_PERMISSIONS = {
