"""Executable permission contract for the tax_localization PBC."""

PBC_KEY = 'tax_localization'
PERMISSIONS = ('tax_localization.read', 'tax_localization.create', 'tax_localization.update', 'tax_localization.approve', 'tax_localization.admin')
ACTION_PERMISSIONS = {
