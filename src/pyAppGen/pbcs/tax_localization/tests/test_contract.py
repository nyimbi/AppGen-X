"""Contract and surface smoke tests for tax_localization."""
...
def test_generated_schema_service_and_release_evidence():
    ...
    assert {"schema", "service", "assistant", "single_pbc_app", "documentation"} <= set(release_manifest["sections"])
...
def test_registration_plan_is_side_effect_free():
    ...
    assert register_pbc()["pbc"] == "tax_localization"
...
def test_configuration_permissions_and_seed_hooks_are_executable():
    ...
    manager = permissions.role_permissions("tax_manager")
    ...
    assert not manager["side_effects"]
    assert not seed_smoke["side_effects"]



def test_ui_forms_wizards_controls_agent_and_repository_are_executable():
    from .. import agent, controls, forms, repository, ui, wizards
    ...
    assert repository_check["ok"] is True
    ...
    assert ui_smoke["contract"]["single_pbc_app"]["single_pbc_app"] is True
    ...
    assert not repository_check["side_effects"]
...
def test_event_handlers_are_idempotent_and_retryable():
    ...
    assert smoke["first_result"]["dead_letter_table"].startswith("tax_localization_")
...
def test_table_stakes_and_advanced_capability_assurance_is_executable():
    ...
    assert manifest["single_pbc_app"]["ok"] is True
