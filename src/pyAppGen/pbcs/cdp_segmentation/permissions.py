"""Executable permission contract for the cdp_segmentation PBC."""

PBC_KEY = 'cdp_segmentation'
PERMISSIONS = ('cdp_segmentation.read', 'cdp_segmentation.create', 'cdp_segmentation.update', 'cdp_segmentation.approve', 'cdp_segmentation.admin')
ACTION_PERMISSIONS = {
