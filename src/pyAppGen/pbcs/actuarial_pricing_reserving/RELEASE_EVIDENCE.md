# Release Evidence - Actuarial Pricing and Reserving

Package directory: `pbcs/actuarial_pricing_reserving`.
...
- Owned datastore boundary: every owned table starts with `actuarial_pricing_reserving_` and cross-PBC collaboration uses AppGen-X events or declared APIs.
