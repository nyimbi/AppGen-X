...
def smoke_test():
    routes = api_route_contracts(); return {'ok': routes['ok'] and validate_api_route_contracts()['ok'] and dispatch_route(ROUTES[0])['ok'] and 'GET /actuarial-pricing-reserving/app' in routes['routes'], 'side_effects': ()}
