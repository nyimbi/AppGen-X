...
OWNED_TABLES = ('actuarial_pricing_reserving_rating_model',
...
def document_instruction_plan(document, instruction):
    from .standalone import agent_document_instruction_plan
    return agent_document_instruction_plan(document, instruction)
