...
def implementation_contract() -> dict:
    ...
    return {**contract, 'standard_features': runtime['standard_features'], 'advanced_runtime': runtime, 'single_pbc_app': single_pbc_app_contract(), 'standalone_app_smoke': standalone_smoke_test(), 'ui_contract': actuarial_pricing_reserving_ui_contract(), 'api_contract': actuarial_pricing_reserving_build_api_contract(), 'schema_contract': actuarial_pricing_reserving_build_schema_contract(), 'service_contract': actuarial_pricing_reserving_build_service_contract(), 'release_evidence_contract': actuarial_pricing_reserving_build_release_evidence(), 'permissions_contract': actuarial_pricing_reserving_permissions_contract(), 'owned_tables': ACTUARIAL_PRICING_RESERVING_OWNED_TABLES, 'runtime_tables': ACTUARIAL_PRICING_RESERVING_RUNTIME_TABLES, 'allowed_database_backends': ACTUARIAL_PRICING_RESERVING_ALLOWED_DATABASE_BACKENDS, 'required_event_topic': ACTUARIAL_PRICING_RESERVING_REQUIRED_EVENT_TOPIC, 'emits': ACTUARIAL_PRICING_RESERVING_EMITTED_EVENT_TYPES, 'consumes': ACTUARIAL_PRICING_RESERVING_CONSUMED_EVENT_TYPES, 'boundary_contract': actuarial_pricing_reserving_verify_owned_table_boundary(ACTUARIAL_PRICING_RESERVING_OWNED_TABLES + ('api_dependency',))}
