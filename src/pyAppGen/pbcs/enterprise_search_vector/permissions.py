...
PERMISSIONS = ('enterprise_search_vector.read', 'enterprise_search_vector.create', 'enterprise_search_vector.update', 'enterprise_search_vector.approve', 'enterprise_search_vector.admin')
ACTION_PERMISSIONS = {
