...
DEFAULT_CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("ui.form-designer", "RAD-style drag-and-drop form designer", "implemented", "generated component palette categories, per-table form workbench, field-to-component mapping matrix, snapped canvas bounds, property inspector metadata, placement suggestions, drop proposal application, overlap guardrails, route surface, and form designer release/workbench gates"),
    ...
    Capability("ui.branding", "Customizable branding and theming", "implemented", "generated theme CSS, branding contract, splash-screen contract, editable menu catalog, guarded menu edit plans, right-click context-menu contracts, UI customization workbench, design-system report, layout recipes, viewport contracts, component state matrices, visual regression plans, typography scale, density modes, quality report, responsive evidence, branding workbench route, and preview cockpit"),
    ...
    Capability("ops.configuration", "Runtime configuration management", "implemented", "generated config.py setup editor, editable config schema, production readiness checks, setup checklist, safe assignment rewrites, .env export, configuration workbench route, route coverage, and release gates"),
    Capability("ops.lifecycle", "Environment, release, feedback, and lifecycle management", "implemented", "generated environment readiness, custom-domain plans, release controls, promotion plans, maintenance windows, update plans, feedback items, user-testing sessions, issue reports, lifecycle workbench route, route coverage, and release gates"),
    Capability("ops.backup", "Backup and disaster recovery", "implemented", "generated JSON backup exports, payload validation, SHA-256 integrity manifests, autobackup schedules, retention plans, recovery runbooks, disaster recovery plans, restore helpers, backup workbench route, route coverage, and release gates"),
    Capability("scale.multi-tenancy", "Multi-tenancy and scaling", "implemented", "generated tenant-scope registry, tenant context extraction, filter helpers, tenant requirement checks, multi-tenancy workbench route, route coverage, and release gates"),
    Capability("integration.enterprise", "Enterprise service integrations", "implemented", "generated REST, webhook, Salesforce, SAP, Entando, Invenio, payment gateway, SMS gateway, transactional email registry, signed webhook plans, idempotency keys, outbox envelopes, delivery audit events, enterprise integration workbench route, route coverage, and release gates"),
    Capability("integration.productivity", "Microsoft 365 and Google Workspace productivity integrations", "implemented", "generated Microsoft 365 and Google Workspace provider catalogs, schema-derived document, spreadsheet, calendar, and task-sync payload contracts, productivity workbench route, route coverage, and release gates"),
    Capability("integration.emerging", "IoT and blockchain integration contracts", "implemented", "generated IoT device catalogs, telemetry validation, command payloads, blockchain audit anchors, smart-contract adapter plans, edge/offline sync guidance, emerging workbench route, route coverage, and release gates"),
    Capability("ai.assistance", "AI and machine-learning assistance", "implemented", "generated assistant catalog, prompt context, chatbot questions, prediction features, recommendations, human-review tasks, assistant workbench route, route coverage, and release gates"),
    Capability("ai.intelligence", "AI analytics, computer vision, NLP, recommendation, and UX optimization", "implemented", "generated feature preprocessing, anomaly detection, image/video analysis plans, OCR/classification/object-detection contracts, NLP helpers, A/B testing, predictive maintenance, intelligence workbench route, route coverage, and release gates"),
