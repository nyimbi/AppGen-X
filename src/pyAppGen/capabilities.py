...
DEFAULT_CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("platform.competitive-benchmark", "JHipster-plus capability benchmark", "partial", "generated roadmap source report, overlap, AppGen-only benchmark rows, and superset scorecard gates for visual builders, database IDE, native targets, agentic systems, NL evolution, ERP templates, studio operations, and schema import"),
