...
DEFAULT_CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("ui.form-designer", "visual drag-and-drop form designer", "implemented", "generated component palette categories, per-table form workbench, field-to-component mapping matrix, snapped canvas bounds, property inspector metadata, placement suggestions, drop proposal application, overlap guardrails, route surface, and form designer release/workbench gates"),
