...
DEFAULT_CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("ui.visual-modeling", "Visual data, form, and workflow modeling", "partial", "generated designer graph, edit proposals, and DSL regeneration helpers"),
    ...
    Capability("platform.jhipster", "JHipster JDL export", "partial", "generated JHipster JDL and import contract"),
    ...
    Capability("data.access", "Low-code query and mutation contracts", "partial", "generated table read/write contracts with filters, sorting, paging, projections, and mutation plans"),
    ...
    Capability("data.visualization", "Charts, graphs, and KPI visualization", "partial", "generated dashboard and chart data contracts"),
    ...
    Capability("deployment.cloud", "Cloud and on-prem deployment", "partial", "generated Docker, Compose, Kubernetes, and Terraform scaffolds"),
    ...
    Capability("devops.studio", "In-app developer studio", "partial", "generated code-edit plans, debug sessions, dependency update plans, app cloning, and component sharing"),
    ...
    Capability("quality.api-testing", "Automated API testing and synthetic monitoring", "partial", "generated API request catalog, response expectations, contract coverage, and monitor probes"),
