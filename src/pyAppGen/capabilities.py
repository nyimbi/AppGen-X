...
DEFAULT_CAPABILITIES: tuple[Capability, ...] = (
    Capability("schema.import", "DBML, SQL, PonyORM, and database import", "implemented", "canonical schema adapters with DBML/live unique indexes, SQL enum/ALTER TABLE support, static PonyORM enum/type normalization, and generated import provenance, source fidelity, validation, and review cockpit"),
    ...
    Capability("platform.competitive-benchmark", "JHipster-plus capability benchmark", "partial", "generated roadmap source report, overlap, AppGen-only benchmark rows, artifact evidence, and superset scorecard gates for visual builders, database IDE, native targets, agentic systems, NL evolution, ERP templates, studio operations, runtime assurance, and schema import"),
    Capability("platform.jhipster-superiority", "Measurable JHipster-superiority release gate", "partial", "generated superiority tiers preserving JHipster parity, requiring at least ten AppGen-only advantages, and proving generated IDE/workbench routes before superiority claims are allowed"),
