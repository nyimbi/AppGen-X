...
DEFAULT_CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("devops.studio", "In-app developer studio", "partial", "generated project tree, searchable command palette, DSL editor sessions, database table proposals, generation jobs, diagnostics, code-edit plans, debug sessions, dependency update plans, app cloning, and component sharing"),
