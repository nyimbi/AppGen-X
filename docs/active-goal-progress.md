...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened diagnostic catalog coverage reporting. The diagnostic catalog now publishes covered fixture codes and the default `appgen diagnostics` text output reports covered, required, fixture, and missing counts so registry coverage is visible without parsing JSON. | Pending focused verification. |
