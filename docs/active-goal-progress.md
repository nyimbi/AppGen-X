...
| --- | --- | --- | --- |
| 2026-05-25 | `current` | Made the form-designer component parity gate expose required and passing component names, renderer targets, property/event/validation surfaces, preview and behavior coverage, generated component module/test coverage, IDE catalog readiness, analog groups, and component readiness phases/checks. | Pending verification. |
