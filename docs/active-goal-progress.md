...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Expanded doctor text coverage for embedded readiness report formats. `appgen doctor` now has executable text-mode proof for CLI alias, semantic symbol, designer sync, and extension audit report formats in addition to parser, completion, and module-boundary evidence. | Pending focused verification. |
