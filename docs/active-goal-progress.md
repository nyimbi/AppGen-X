...
| --- | --- | --- | --- |
| 2026-05-25 | `current` | Made the form-designer inspector gate expose required and passing property pipeline stages/guards, event signature stages/guards, component editor history verbs/steps/rollback steps, dependency recalculation stages, diagnostic severities/quick fixes, shared action names/context, cross-handler policy/route steps, state keys/scopes, and round-trip components. | Pending verification. |
