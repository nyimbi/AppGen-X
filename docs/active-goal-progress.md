...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened diagnostic catalog shape evidence. `appgen.diagnostic-catalog.v1` now publishes required runtime diagnostic fields, catalog registry fields, catalog shape gaps, and the fixture audit contract that enforces runtime JSON shape. | Pending focused verification. |
