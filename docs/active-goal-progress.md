...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Tightened generated platform parity smoke so the generated workbench must prove every parity requirement check, not just lifecycle and requirement-audit presence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
