...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made native data tooling requirement evidence depend on generated data module and deep data tooling module/test manifests. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
