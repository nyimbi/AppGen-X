...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made generated binding runtime smoke expose required and passing check IDs for binding graphs, operations, runtime wiring, propagation, designer transactions, inspector bridge, modules/tests, and runtime replay evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
