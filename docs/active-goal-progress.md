...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Extended missing-required-option audit to component publication. `appgen.missing-required-option-exit-audit.v1` now covers `appgen component-publish` without `--component`, keeping the new component publication lane inside the CLI configuration-error contract. | Pending focused verification. |
