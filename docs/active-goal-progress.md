...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened CLI alias evidence. `appgen.cli-help-surface-audit.v1` now embeds `appgen.cli-alias-contract.v1`, proving `appgen` and `apg` share `pyAppGen.__main__:main` and that the module entrypoint dispatches into the tooling CLI. | Pending focused verification. |
