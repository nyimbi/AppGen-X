...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Tightened the component baseline lifecycle phase so it records and depends on passing component readiness and usability checks for analog coverage, icons, behavior, generated modules/tests, package files, and smoke evidence in source and generated audits. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
