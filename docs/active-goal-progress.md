...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made generated runtime-operation smoke expose required and passing check IDs for operation presence/callability, runtime replay, design edit replay, and generated operation modules/tests. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
