...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Added diagnostic text coverage for explain tooling. `appgen explain --diagnostic ...` now has executable text-mode audit coverage proving code, title, summary, and docs anchor output, matching the human-readable default promised by `docs/tooling.md`. | Pending focused verification. |
