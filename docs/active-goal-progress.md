...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made generated package-manager runtime smoke expose required and passing check IDs for install review, workbench readiness, lifecycle replay/execution, rollback, modules/tests, and runtime replay evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
