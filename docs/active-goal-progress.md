...
| --- | --- | --- | --- |
| 2026-05-30 | `PENDING` | Added priority-order release evidence. `appgen.tooling-audit.v1` now includes `priority_order_contracts`, proving the ten documented Priority Order items remain in order and each maps to executable tooling evidence before downstream tooling is counted complete. | Pending verification. |
