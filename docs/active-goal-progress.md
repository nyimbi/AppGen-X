...
| --- | --- | --- | --- |
| 2026-05-30 | PENDING | Split formatter, parser-golden, semantic-drift, and doctor evidence into first-class tooling gates. `appgen.tooling-audit.v1` now includes `formatter_write_organize_contracts`, `parser_golden_fixture_contracts`, `semantic_drift_surface_contracts`, and `doctor_cli_text_contracts`, with phase exits requiring formatter write/organize behavior plus parser fixture, drift surface, and doctor CLI/text evidence. | Pending verification. |
