...
| --- | --- | --- | --- |
| 2026-05-30 | PENDING | Split component and PBC publication evidence into first-class tooling gates. `appgen.tooling-audit.v1` now includes `component_publish_catalog_contracts` and `pbc_publish_side_effect_contracts`, and phase exits require component catalog patch behavior plus side-effect-free PBC publish CLI/text evidence. | Pending verification. |
