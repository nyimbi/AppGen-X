...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made generated visual-runtime asset smoke expose required and passing check IDs for style bundles, timeline bundles, effect bundles, scene/assets, and target package evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
