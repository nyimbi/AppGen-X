...
| --- | --- | --- | --- |
| 2026-05-30 | `PENDING` | Added contributor task breakdown coverage evidence. `appgen.tooling-audit.v1` now includes `contributor_task_breakdown_contracts`, proving all 22 good-first, intermediate, and advanced contributor tasks map to executable tooling evidence instead of remaining prose-only onboarding advice. | Pending verification. |
