...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened validate failure text coverage. `appgen validate` now has executable text-mode proof that target compatibility failures include requested targets, app-declared targets, semantic-model format, missing-target details, and AGX0802 diagnostics. | Pending focused verification. |
