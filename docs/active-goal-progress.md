...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made the source component parity gate expose required and passing palette categories plus the component count threshold used for release evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
