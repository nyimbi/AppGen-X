...
| --- | --- | --- | --- |
| 2026-05-25 | `pending` | Added generated property-editor family modules so Object Inspector parity now has one generated module and one generated smoke-test file for string, number, boolean, choice, collection, binding, color, and resource property editors, with inspector workbench, requirement, runtime, and generation-smoke gates requiring those families. | Py compile, focused package form-designer parity smoke, and generated DSL app smoke passed; scoped diff check and restricted-name scan pending. |
