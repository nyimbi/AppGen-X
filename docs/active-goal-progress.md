...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made device API component coverage depend on generated per-API component module and test manifests in native and generated parity audits. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
