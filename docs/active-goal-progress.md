...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made cross-target visual depth depend on generated visual component modules, component tests, design-surface modules, and design-surface test manifests in native and generated parity audits. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
