...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made generated component parity runtime smoke expose required and passing check IDs for requested groups, analogs, behavior replay, generated modules/packages/tests, and runtime replay evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
