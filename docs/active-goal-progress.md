...
| --- | --- | --- | --- |
| 2026-05-30 | `PENDING` | Added full major-section coverage evidence for `docs/tooling.md`. `appgen.tooling-audit.v1` now includes `tooling_section_coverage_contracts`, proving all 18 major `##` sections map to top-level executable audit gates and stale gate mappings fail release evidence. | Pending verification. |
