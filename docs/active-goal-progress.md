...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made generated visual-depth runtime smoke expose required and passing check IDs for style, timeline, effects, scene, visual component modules/tests, runtime package, and replay evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
