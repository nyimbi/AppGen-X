...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened LSP rename text coverage. The LSP rename CLI audit now has explicit executable proof that blocked rename text exposes failed rename status, blocked state, blocker count, and migration approval requirement. | Pending focused verification. |
