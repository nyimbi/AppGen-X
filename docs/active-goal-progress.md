...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made generated native form/runtime smoke expose required and passing check IDs for streaming, compiler pipeline, module/test, design edit, and runtime load evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
