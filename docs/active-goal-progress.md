...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Added diagnostic catalog CLI proof to the test-strategy audit. The test-strategy gate now exercises the diagnostic catalog registry separately from fixture-audit mode and proves required diagnostic codes match covered fixture codes. | Pending focused verification. |
