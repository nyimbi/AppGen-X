...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Enriched formatter default text summaries. `appgen format` now reports organize mode, write-requested state, write completion, and write path when present, keeping text output aligned with `appgen.format-result.v1` mutation evidence. | Pending focused verification. |
