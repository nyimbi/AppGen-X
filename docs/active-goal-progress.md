...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made the source form-designer native data tooling parity gate expose required and passing data workbench checks used for parity release evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
