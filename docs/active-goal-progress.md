...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Surfaced release evidence bundle format in package and verify text output. `appgen verify` and `appgen package` now print `appgen.release-evidence-bundle.v1` and artifact counts so release logs prove the same evidence bundle contract carried by JSON output. | Pending focused verification. |
