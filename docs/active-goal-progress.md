...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Implemented component catalog publication CLI. `appgen component-publish` now emits side-effect-free `appgen.component-publish-report.v1` and `appgen.component-catalog-patch.v1` evidence, and the help-surface audit treats the command as a first-class documented subcommand. | Pending focused verification. |
