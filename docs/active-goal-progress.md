...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Added unknown code-action text coverage for LSP quick fixes. `appgen lsp --apply-code-action missing_action` now has executable text-mode proof for failed status, available action ids, and diagnostic output, matching the `docs/tooling.md` agent-facing failure contract. | Pending focused verification. |
