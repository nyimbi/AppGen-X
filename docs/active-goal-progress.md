...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Tightened platform lifecycle replay so each phase records and depends on passing subsystem workbench checks across runtime, inspector/binding, data publishing, package installation, device APIs, and visual-depth validation in source and generated audits. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
