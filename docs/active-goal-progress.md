...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened Studio semantic-service browser-smoke coverage. The Studio semantic-service audit now embeds browser-smoke evidence that the frontend includes the semantic-service bridge scenario and panel contract, tying the web IDE bridge directly to `appgen.studio-semantic-service-audit.v1`. | Pending focused verification. |
