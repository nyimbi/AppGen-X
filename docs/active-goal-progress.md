...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Added live CLI text coverage for `appgen tooling-audit` release-log evidence. The tooling-audit command now has executable proof for documented source, section, and embedded report-format markers instead of relying only on synthetic emitter coverage. | Pending focused verification. |
