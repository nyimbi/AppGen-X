...
| --- | --- | --- | --- |
| 2026-05-30 | `PENDING` | Split LSP quick-fix evidence into first-class coverage, CLI parity, and text-log gates. `appgen.tooling-audit.v1` now exposes separate `lsp_quick_fix_coverage_contracts`, `lsp_quick_fix_cli_contracts`, and `lsp_quick_fix_text_contracts`, and phase 4 requires quick-fix family coverage plus CLI/text contracts rather than relying on the broad application aggregate. | Pending verification. |
