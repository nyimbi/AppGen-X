...
| --- | --- | --- | --- |
| 2026-05-30 | `PENDING` | Promoted CLI help and alias evidence into a first-class tooling gate. `appgen.tooling-audit.v1` now includes `cli_help_alias_contracts`, and phase 3 requires help discoverability, subcommand option coverage, module dispatch, and `apg` alias evidence independently of generic usage-failure handling. | Pending verification. |
