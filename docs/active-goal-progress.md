...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Deepened VS Code extension surface auditing. `appgen.vscode-extension-audit.v1` now checks diagnostics collection, CLI-backed command argument contracts, and graph/artifact/PBC webview renderers in addition to language metadata, command contributions, grammar, and LSP providers. | Pending focused verification and commit. |
