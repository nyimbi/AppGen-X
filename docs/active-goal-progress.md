...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened diagnostics CLI text coverage. `appgen diagnostics` and `appgen diagnostics --audit-fixtures` now have executable text-mode proof for registry counts, fixture counts, covered diagnostic counts, required diagnostic counts, and zero missing fixture/code lines. | Pending focused verification. |
