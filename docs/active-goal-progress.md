...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Added aggregate deep-check coverage evidence so every platform parity requirement must prove its declared deep checks through passing nested workbench/readiness checks in source and generated audits. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
