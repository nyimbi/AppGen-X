...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Added default text summaries for designer synchronization. `appgen designer-sync` now reports semantic-model format, synchronized IDE surfaces, visual edit acceptance/round-trip status, changed surfaces, DSL diff size, visual-edit matrix coverage, and sync checks without requiring JSON mode. | Pending focused verification. |
