...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Surfaced graph-suite kind and format names in text output. `appgen graph-suite` now prints required graph kinds and supported output formats, and `appgen.graph-suite-cli-audit.v1` verifies those text-mode release-log signals. | Pending focused verification. |
