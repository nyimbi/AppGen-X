...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Added explicit implementation-phase tooling evidence. `appgen.tooling-audit.v1` now embeds `appgen.tooling-implementation-phase-audit.v1`, mapping docs/tooling.md phases 0 through 6 to concrete exit-criteria evidence instead of prose-only status. | Pending focused verification. |
