...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made the source design-time package installation gate expose required and passing lifecycle phases and readiness checks used for release evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
