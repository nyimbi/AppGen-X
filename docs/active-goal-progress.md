...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened component publication CLI coverage. `appgen component-publish` now has executable proof for catalog source, registration state, side-effect-free patch metadata, before/after catalog counts, and write-free text output. | Pending focused verification. |
