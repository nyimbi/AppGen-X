...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened native package manifest readiness evidence. `appgen.package-manifest.v1` for mobile and desktop targets now carries explicit package metadata and smoke-launch verifier booleans in addition to the handoff entrypoint names. | Pending focused verification. |
