...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made the platform requirement audit expose required and passing requirement IDs, and made the release audit assert that every parity requirement passed. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
