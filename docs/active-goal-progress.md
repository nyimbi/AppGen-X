...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Strengthened graph CLI example coverage. The graph CLI audit now has explicit executable proof that documented JSON, Mermaid, and DOT graph commands emit the expected payload or renderer prefixes for workflow and PBC graph examples. | Pending focused verification. |
