...
| --- | --- | --- | --- |
| 2026-05-25 | `current` | Made the package form-designer placement-suggestions gate expose required and passing suggested drop coordinates plus validation evidence for generated field placement. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
