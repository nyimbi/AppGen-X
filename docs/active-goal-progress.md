...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Made the package form-designer overlap-guardrail gate expose required and passing checks, detected overlap pairs, and valid-drop validation evidence. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
