...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Surfaced implementation-phase evidence in tooling-audit text output. `appgen tooling-audit` now reports audited phase count, missing phase count, and the `appgen.tooling-implementation-phase-audit.v1` marker without requiring JSON parsing. | Pending focused verification. |
