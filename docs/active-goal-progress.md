...
| --- | --- | --- | --- |
| 2026-05-25 | `current` | Made the form-designer native data tooling gate expose required and passing actionable operation names, generated data module tests, deep data module tests, readiness checks, design/runtime replay phases, relationship lookup lifecycle checks, and module smoke coverage. | Pending verification. |
