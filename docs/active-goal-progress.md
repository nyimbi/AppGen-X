...
| --- | --- | --- | --- |
| 2026-05-24 | `current` | Tightened the package-level form-designer generation-smoke release gate so it requires the generated smoke format, approved decision, no blocking gaps, and explicit passing runtime checks. | Py compile, focused generated form-designer parity smoke, scoped diff check, and scoped restricted-name scan passed. |
