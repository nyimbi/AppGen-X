...
| --- | --- | --- | --- |
| 2026-05-29 | `pending` | Surfaced parser-golden fixture split and missing construct counts in text output. `appgen parser-golden` now prints valid/invalid fixture counts and missing construct totals so grammar release logs preserve the same coverage posture as `appgen.parser-golden-audit.v1`. | Pending focused verification. |
